...
values
    ...
    ("LOC_BELIEF_TITHE_DL_DESCRIPTION",                       "+2 [ICON_Gold] Gold for every  three followers of this Religion."),
    ("LOC_BELIEF_RELIGIOUS_UNITY_DL_DESCRIPTION",             "+1 [ICON_Faith] Faith for every 3 followers of this Religion."),
    ...
    ("LOC_BELIEF_TO_THE_GLORY_OF_GOD_DL_DESCRIPTION",         "-25% [ICON_faith] faith when you patronage great person. Each time you recruit a great person , add 50 [ICON_FAVOR] Diplomatic Favor. 33% chance getting a [ICON_GreatWork_Relic] relic when a great person is fully activated or retired."),
    ...
    ("LOC_BELIEF_CATHEDRAL_DL_DESCRIPTION",                   "Allows construction of Cathedrals (+2 [ICON_Faith] Faith, 1 slot for Religious Art or Sculpture; +3 [ICON_FAITH] Faith and +100% [ICON_Tourism] Tourism for innner Great Work). "),
    ("LOC_BELIEF_DAR_E_MEHR_DL_DESCRIPTION",                  "Allows construction of Dar-e Mehrs (+2 [ICON_Faith] Faith, +1 additional [ICON_FAITH] Faith for each era since constructed or last repaired; Gain a Missionary unit after finishing construction).");
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_TITHE_DL_DESCRIPTION",                       "该宗教每有3个信徒则+2 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_BELIEF_RELIGIOUS_UNITY_DL_DESCRIPTION",             "该宗教每有3个信徒则+1 [ICON_Faith] 信仰。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_TO_THE_GLORY_OF_GOD_DL_DESCRIPTION",         "招募伟人-25% [ICON_faith] 信仰值花费。 每次招募伟人时，获得50 [ICON_FAVOR] 外交支持。每当一位伟人完全激活或隐退后，有33%的几率获得一个 [ICON_GreatWork_Relic] 遗物。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_CATHEDRAL_DL_DESCRIPTION",                   "允许建造大教堂（+2 [ICON_Faith] 信仰值，可放置1个宗教艺术巨作或者雕塑；存放的雕塑和艺术巨作+3 [ICON_FAITH] 信仰值，且产出的 [ICON_TOURISM] 旅游业绩+100%）。"),
    ("zh_Hans_CN",  "LOC_BELIEF_DAR_E_MEHR_DL_DESCRIPTION",                  "允许建造拜火神庙（+2 [ICON_Faith] 信仰值；建造或上次修复后的每个时代均额外+1 [ICON_FAITH] 信仰值；完成后，获得一个传教士）。 ");
