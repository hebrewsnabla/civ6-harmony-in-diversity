...
values
	...
	('MODIFIER_PLAYER_CITIES_ADJUST_MILITARY_UNIT_PRODUCTION',					'KIND_MODIFIER'),
	('MODIFIER_ALL_CITIES_ADJUST_BUILDING_PRODUCTION_CHANGE',					'KIND_MODIFIER'),
	('MODIFIER_ALL_CITIES_ADJUST_DISTRICT_PRODUCTION_CHANGE',					'KIND_MODIFIER'),
	('MODIFIER_ALL_CITIES_ADJUST_UNIT_PRODUCTION_CHANGE',						'KIND_MODIFIER'),
	('MODIFIER_ALL_CITIES_RELIGION_PRESSURE',									'KIND_MODIFIER'),
	('MODIFIER_CITY_TRAINED_UNITS_ATTACH_MODIFIER',								'KIND_MODIFIER'),
	('MODIFIER_ALL_PLAYERS_ADJUST_PLAYER_VALID_UNIT_BUILD',						'KIND_MODIFIER'),
	('MODIFIER_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',						'KIND_MODIFIER'),
	('MODIFIER_SINGLE_CITY_ADD_POPULATION',										'KIND_MODIFIER'),
	('MODIFIER_CAPITAL_CITY_GRANT_UNIT_IN_CITY',								'KIND_MODIFIER'),
	('MODIFIER_CAPITAL_CITY_ADJUST_FREE_RESOURCE_EXTRACTION',					'KIND_MODIFIER'),
	('MODIFIER_SINGLE_CITY_ADJUST_WATER_HOUSING',								'KIND_MODIFIER'),
	('MODIFIER_PLAYER_CITIES_ADJUST_TRADE_ROUTE_YIELD_FOR_INTERNATIONAL',		'KIND_MODIFIER'),
	('MODIFIER_PLAYER_ATTACH_MODIFIER',											'KIND_MODIFIER');
...
values
	...
	('MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_CHANGE',							'COLLECTION_OWNER_CITY',			'EFFECT_ADJUST_CITY_YIELD_CHANGE'),
	('MODIFIER_PLAYER_CITIES_ADJUST_MILITARY_UNIT_PRODUCTION',					'COLLECTION_PLAYER_CITIES',			'EFFECT_ADJUST_CITY_ALL_MILITARY_UNITS_PRODUCTION'),
	('MODIFIER_ALL_CITIES_ADJUST_BUILDING_PRODUCTION_CHANGE',					'COLLECTION_ALL_CITIES',			'EFFECT_ADJUST_CITY_PRODUCTION_BUILDING'),
	('MODIFIER_ALL_CITIES_ADJUST_DISTRICT_PRODUCTION_CHANGE',					'COLLECTION_ALL_CITIES',			'EFFECT_ADJUST_CITY_PRODUCTION_DISTRICT'),
	('MODIFIER_ALL_CITIES_ADJUST_UNIT_PRODUCTION_CHANGE',						'COLLECTION_ALL_CITIES',			'EFFECT_ADJUST_CITY_PRODUCTION_UNIT'),
	('MODIFIER_ALL_CITIES_RELIGION_PRESSURE',									'COLLECTION_PLAYER_CITIES',			'EFFECT_ADJUST_CITY_RELIGION_PRESSURE'),
	('MODIFIER_CITY_TRAINED_UNITS_ATTACH_MODIFIER',								'COLLECTION_CITY_TRAINED_UNITS',	'EFFECT_ATTACH_MODIFIER'),
	('MODIFIER_ALL_PLAYERS_ADJUST_PLAYER_VALID_UNIT_BUILD',						'COLLECTION_ALL_PLAYERS',			'EFFECT_ADJUST_PLAYER_VALID_UNIT_BUILD'),
	('MODIFIER_PLAYER_DISTRICTS_ADJUST_BASE_YIELD_CHANGE',						'COLLECTION_PLAYER_DISTRICTS',		'EFFECT_ADJUST_DISTRICT_BASE_YIELD_CHANGE'),
	('MODIFIER_SINGLE_CITY_ADD_POPULATION',										'COLLECTION_OWNER_CITY',			'EFFECT_ADJUST_CITY_POPULATION'),
	('MODIFIER_CAPITAL_CITY_GRANT_UNIT_IN_CITY',								'COLLECTION_PLAYER_CAPITAL_CITY',	'EFFECT_GRANT_UNIT_IN_CITY'),
	('MODIFIER_CAPITAL_CITY_ADJUST_FREE_RESOURCE_EXTRACTION',					'COLLECTION_PLAYER_CAPITAL_CITY',	'EFFECT_GRANT_FREE_RESOURCE_EXTRACTED'),
	('MODIFIER_SINGLE_CITY_ADJUST_WATER_HOUSING',								'COLLECTION_OWNER_CITY',			'EFFECT_ADJUST_WATER_HOUSING'),
	('MODIFIER_PLAYER_CITIES_ADJUST_TRADE_ROUTE_YIELD_FOR_INTERNATIONAL',		'COLLECTION_PLAYER_CITIES',			'EFFECT_ADJUST_CITY_TRADE_ROUTE_YIELD_FOR_INTERNATIONAL'),
	('MODIFIER_PLAYER_ATTACH_MODIFIER',											'COLLECTION_OWNER',					'EFFECT_ATTACH_MODIFIER');
