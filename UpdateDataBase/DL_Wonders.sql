...
-- 	(ModifierId, 								ModifierType, 								SubjectRequirementSetId) 
-- values
-- 	('MACHU_COMMERCIAL_DISTRICT_PRODUCTION',	)
-- 	('MACHU_THEATER_DISTRICT_PRODUCTION',
-- 	('MACHU_INDUSTRIAL_DISTRICT_PRODUCTION',	)
-- 	('MACHU_COMMERCIAL_BUILDING_PRODUCTION',	)
-- 	('MACHU_THEATER_BUILDING_PRODUCTION',		)
-- 	('MACHU_INDUSTRIAL_BUILDING_PRODUCTION',	)
