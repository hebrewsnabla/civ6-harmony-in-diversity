...
insert or ignore into RequirementSets
	(RequirementSetId,										RequirementSetType)
values
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_CULTURE',		'REQUIREMENTSET_TEST_ALL'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_CULTURE_EX',	'REQUIREMENTSET_TEST_ALL'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_GOLD',			'REQUIREMENTSET_TEST_ALL'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_GOLD_EX',		'REQUIREMENTSET_TEST_ALL');
insert or ignore into RequirementSetRequirements
	(RequirementSetId,										RequirementId)
values
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_CULTURE',		'REQUIRES_OBJECT_WITHIN_1_TILE'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_CULTURE',		'REQUIRES_DISTRICT_IS_NOT_CITY_CENTER'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_CULTURE',		'REQUIRES_PLOT_DOES_NOT_HAVE_INCOMPLETE_WONDER'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_CULTURE_EX',	'REQUIRES_OBJECT_WITHIN_1_TILE'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_CULTURE_EX',	'REQUIRES_DISTRICT_IS_NOT_CITY_CENTER'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_CULTURE_EX',	'REQUIRES_PLOT_DOES_NOT_HAVE_INCOMPLETE_WONDER'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_CULTURE_EX',	'REQUIRES_PLAYER_HAS_CIVIC_HUMANISM'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_GOLD',			'REQUIRES_OBJECT_WITHIN_4_TILES'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_GOLD',			'REQUIRES_DISTRICT_IS_NOT_CITY_CENTER'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_GOLD',			'REQUIRES_PLOT_DOES_NOT_HAVE_INCOMPLETE_WONDER'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_GOLD_EX',		'REQUIRES_OBJECT_WITHIN_4_TILES'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_GOLD_EX',		'REQUIRES_DISTRICT_IS_NOT_CITY_CENTER'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_GOLD_EX',		'REQUIRES_PLOT_DOES_NOT_HAVE_INCOMPLETE_WONDER'),
	('ST_BASILS_THERTER_MODIFIER_REQUIREMENT_GOLD_EX',		'REQUIRES_PLAYER_HAS_CIVIC_HUMANISM');
