...
update GreatPersonIndividuals set ActionCharges = 1, ActionRequiresUnownedTile = 0, ActionRequiresOwnedTile = 1, ActionRequiresCompletedDistrictType = 'DISTRICT_COMMERCIAL_HUB'
	where GreatPersonIndividualType = 'GREAT_PERSON_INDIVIDUAL_MARCUS_LICINIUS_CRASSUS';
update ModifierArguments set Value = 600 where ModifierId = 'GREATPERSON_GOLD_TINY' and Name = 'Amount';
...
values
	...
	('GREAT_PERSON_INDIVIDUAL_MARCUS_LICINIUS_CRASSUS',	'MARCUS_LICINIUS_CRASSUS_SWORDSMAN',		'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_DISTRICT_IN_TILE'),
	('GREAT_PERSON_INDIVIDUAL_MARCUS_LICINIUS_CRASSUS',	'MARCUS_LICINIUS_CRASSUS_IRON',				'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_DISTRICT_IN_TILE'),
	...
	('GREAT_PERSON_INDIVIDUAL_HD_CROESUS',				'CROESUS_AMENITIY',							'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_DISTRICT_IN_TILE'),
	('GREAT_PERSON_INDIVIDUAL_HD_CROESUS',				'CROESUS_DELIGHTED_GOLD',					'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_DISTRICT_IN_TILE'),
	('GREAT_PERSON_INDIVIDUAL_HD_CROESUS',				'CROESUS_HAPPY_GOLD',						'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_DISTRICT_IN_TILE'),
	('GREAT_PERSON_INDIVIDUAL_HD_CROESUS',				'CROESUS_JOYFUL_GOLD',						'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_DISTRICT_IN_TILE'),
	('GREAT_PERSON_INDIVIDUAL_HD_CROESUS',				'CROESUS_ECSTATIC_GOLD',					'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_DISTRICT_IN_TILE'),
...
as (values
	...
	('GREAT_PERSON_INDIVIDUAL_HD_SANG_HONGYANG',		'SANG_HONGYANG_GOLD',						'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_DISTRICT_IN_TILE'),
	('GREAT_PERSON_INDIVIDUAL_HD_SANG_HONGYANG',		'SANG_HONGYANG_CULTURE',					'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_DISTRICT_IN_TILE'),
	('GREAT_PERSON_INDIVIDUAL_HD_SANG_HONGYANG',		'SANG_HONGYANG_GOLD_MAGNUS_ATTACH',			'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_DISTRICT_IN_TILE'),
...
insert or replace into GreatPersonIndividualActionModifiers
	(GreatPersonIndividualType,							ModifierId,									AttachmentTargetType)
select
	'GREAT_PERSON_INDIVIDUAL_HD_SANG_HONGYANG',			'SANG_HONGYANG_MINT_CULTURE',				'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_DISTRICT_IN_TILE'
where exists (select BuildingType from Buildings where BuildingType = 'BUILDING_JNR_MINT');
...
values
	...
	('COLAEUS_SETTLER_MOVEMENT_ATTACH',			'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',							0,			1,			'CITY_HAS_DISTRICT_COMMERCIAL_HUB_REQUIREMENTS'),
	('COLAEUS_SETTLER_MOVEMENT',				'MODIFIER_HD_CITY_TRAINED_UNITS_ADJUST_MOVEMENT',					0,			0,			'UNIT_IS_UNIT_SETTLER_REQUIREMENTS'),
	('MARCUS_LICINIUS_CRASSUS_SWORDSMAN',		'MODIFIER_SINGLE_CITY_GRANT_UNIT_IN_CITY',							1,			1,			null),
	...
	('CROESUS_AMENITIY',						'MODIFIER_PLAYER_CITIES_ADJUST_CITY_AMENITIES_FROM_GREAT_PEOPLE',	0,			1,			'CITY_HAS_DISTRICT_COMMERCIAL_HUB_TIER_1_BUILDING_REQUIREMENTS'),
	('CROESUS_DELIGHTED_GOLD',					'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_YIELD',					0,			1,			null),
	('CROESUS_HAPPY_GOLD',						'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_YIELD',					0,			1,			null),
	('CROESUS_JOYFUL_GOLD',						'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_YIELD',					0,			1,			null),
	('CROESUS_ECSTATIC_GOLD',					'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_YIELD',					0,			1,			null),
	('SANG_HONGYANG_MINT',						'MODIFIER_SINGLE_CITY_GRANT_BUILDING_IN_CITY_IGNORE',				1,			1,			null),
	('SANG_HONGYANG_GOLD',						'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE',					0,			1,			null),
	('SANG_HONGYANG_CULTURE',					'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE',					0,			1,			null),
	('SANG_HONGYANG_GOLD_MAGNUS_ATTACH',		'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',							0,			1,			null),
	('SANG_HONGYANG_CULTURE_MAGNUS_ATTACH',		'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',							0,			1,			null),
	('SANG_HONGYANG_GOLD_MAGNUS',				'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE',					0,			0,			'CITY_HAS_VERTICAL_INTEGRATION_REQUIREMENTS'),
...
update Modifiers set SubjectRequirementSetId = 'CITY_CAN_RECIEVE_BUILDING_JNR_MINT_REGIONAL_BONUS_REQUIREMENTS'
	where (ModifierId = 'SANG_HONGYANG_GOLD' or ModifierId = 'SANG_HONGYANG_CULTURE') and exists (select BuildingType from Buildings where BuildingType = 'BUILDING_JNR_MINT');
update Modifiers set SubjectRequirementSetId = 'CITY_CAN_GIVE_BUILDING_JNR_MINT_REGIONAL_BONUS_TO_MAGNUS_REQUIREMENTS'
	where (ModifierId = 'SANG_HONGYANG_GOLD_MAGNUS_ATTACH' or ModifierId = 'SANG_HONGYANG_CULTURE_MAGNUS_ATTACH') and exists (select BuildingType from Buildings where BuildingType = 'BUILDING_JNR_MINT');
...
insert or replace into ModifierArguments
	(ModifierId,								Name,				Value)
values
	('COLAEUS_SETTLER_PRODUCTION',				'Amount',			50),
	...
	('MARCUS_LICINIUS_CRASSUS_SWORDSMAN',		'Amount',			2),
	...
	('CROESUS_AMENITIY',						'Amount',			1),
	('CROESUS_DELIGHTED_GOLD',					'HappinessType',	'HAPPINESS_DELIGHTED'),
	('CROESUS_DELIGHTED_GOLD',					'YieldType',		'YIELD_GOLD'),
	('CROESUS_DELIGHTED_GOLD',					'Amount',			2),
	('CROESUS_HAPPY_GOLD',						'HappinessType',	'HAPPINESS_HAPPY'),
	('CROESUS_HAPPY_GOLD',						'YieldType',		'YIELD_GOLD'),
	('CROESUS_HAPPY_GOLD',						'Amount',			4),
	('CROESUS_JOYFUL_GOLD',						'HappinessType',	'HAPPINESS_JOYFUL'),
	('CROESUS_JOYFUL_GOLD',						'YieldType',		'YIELD_GOLD'),
	('CROESUS_JOYFUL_GOLD',						'Amount',			6),
	('CROESUS_ECSTATIC_GOLD',					'HappinessType',	'HAPPINESS_ECSTATIC'),
	('CROESUS_ECSTATIC_GOLD',					'YieldType',		'YIELD_GOLD'),
	('CROESUS_ECSTATIC_GOLD',					'Amount',			8),
	('SANG_HONGYANG_MINT',						'BuildingType',		'BUILDING_JNR_MINT'),
	('SANG_HONGYANG_GOLD',						'YieldType',		'YIELD_GOLD'),
	('SANG_HONGYANG_GOLD',						'Amount',			4),
	('SANG_HONGYANG_CULTURE',					'YieldType',		'YIELD_CULTURE'),
	('SANG_HONGYANG_CULTURE',					'Amount',			1),
	('SANG_HONGYANG_GOLD_MAGNUS_ATTACH',		'ModifierId',		'SANG_HONGYANG_GOLD_MAGNUS'),
	('SANG_HONGYANG_CULTURE_MAGNUS_ATTACH',		'ModifierId',		'SANG_HONGYANG_CULTURE_MAGNUS'),
	('SANG_HONGYANG_GOLD_MAGNUS',				'YieldType',		'YIELD_GOLD'),
	('SANG_HONGYANG_GOLD_MAGNUS',				'Amount',			4),
