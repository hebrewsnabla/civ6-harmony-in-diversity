...
values
    ...
    ("LOC_BELIEF_GODDESS_OF_THE_HUNT_DL_DESCRIPTION",             "+1 [ICON_Food] Food and +1 [ICON_Production] Production from Camps over Luxury and Bonus resources."),
    ...
    ("LOC_BELIEF_STONE_CIRCLES_DL_DESCRIPTION",                   "+1 [ICON_Faith] Faith and +1 [ICON_Production] Production from Quarries. +2 [ICON_GreatProphet] Great Prophet point per turn if a city owns a Quarry."),
    ...
    ("LOC_BELIEF_GODDESS_OF_FESTIVALS_DL_DESCRIPTION",            "+1 [ICON_Food] Food from Plantations. Holy Site districts get +2 [ICON_Faith] Faith from each adjacent Plantation. Holy Site provides +1 [ICON_Faith] Faith to adjacent Plantations. +2 [ICON_GreatProphet] Great Prophet point per turn if a city owns a Plantation."),
    ...
    ("LOC_BELIEF_GODDESS_OF_THE_HARVEST_DL_DESCRIPTION",          "+1 [ICON_Food] Food and +1 [ICON_Production] Production from Farms over Luxury and Bonus resources."),
    ...
    ("LOC_BELIEF_HD_WOLF_GOD_DL_DESCRIPTION",                     "+1 [ICON_CULTURE] Culture from Camps over Luxury and Bonus resources. Holy Site provides +1 [ICON_Faith] Faith to all Camps in this city. +2 [ICON_GreatProphet] Great Prophet point per turn if a city owns Camps over Luxury or Bonus resources."),
    ("LOC_BELIEF_HD_SUN_GOD_NAME",                                "Apollo"),
    ("LOC_BELIEF_HD_SUN_GOD_DL_DESCRIPTION",                      "+1 [ICON_FOOD] Food from Farms over resources and Plantations. +2 [ICON_GreatProphet] Great Prophet point per turn if a city owns a Farm over resource or a Plantation. Holy Site provides +1 [ICON_FAITH] Faith to all Farms in this city.");
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_GODDESS_OF_FESTIVALS_DL_DESCRIPTION",            "种植园 +1 [ICON_Food] 食物。圣地区域从每个相邻的种植园获得+2 [ICON_Faith] 信仰值，给相邻的种植园 +1 [ICON_Faith] 信仰值。如城市中有种植园，则每回合+2 [ICON_GreatProphet] 大预言家点数。"),
