...
values
    ...
    ("LOC_GAMEMODE_AITEST_NAME",                            "Testing Dev Mode"),
    ("LOC_GAMEMODE_AITEST_DESCRIPTION",                     "[COLOR_Red]Inner Testing Usage Only, please do not enable[ENDCOLOR]. Mode for Testing, current testing mode contains the Dev adjustments."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_GAMEMODE_AITEST_NAME",                             "测试开发模式"),
    ("zh_Hans_CN",  "LOC_GAMEMODE_AITEST_DESCRIPTION",                      "[COLOR_Red]内部测试专用，请勿开启[ENDCOLOR]。用于测试的模式，当前测试模式包含了开发中内容。"),
