...
values
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_LA_VENTA_EXPANSION2_DESCRIPTION",  "建造者现在能够建造巨神头像改良设施。[NEWLINE][NEWLINE]+2 [ICON_Faith] 信仰值。与每2个雨林相邻+1信仰值，而解锁“人文主义”市政后与每1个雨林相邻便能+1信仰值。与每2个树林相邻+1信仰值，而解锁“人文主义”市政后与每1个树林相邻便能+1信仰值。研究“飞行”科技后可通过 [ICON_FAITH] 信仰值获得 [ICON_TOURISM] 旅游业绩。可建造在森林或雨林上。无法建在雪地或雪地丘陵上。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_LA_VENTA_BONUS_XP2",               "建造者现在能够建造巨神头像改良设施。[NEWLINE][NEWLINE]+2 [ICON_Faith] 信仰值。与每2个雨林相邻+1信仰值，而解锁“人文主义”市政后与每1个雨林相邻便能+1信仰值。与每2个树林相邻+1信仰值，而解锁“人文主义”市政后与每1个树林相邻便能+1信仰值。研究“飞行”科技后可通过 [ICON_FAITH] 信仰值获得 [ICON_TOURISM] 旅游业绩。可建造在森林或雨林上。无法建在雪地或雪地丘陵上。"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_GRANADA_EXPANSION2_DESCRIPTION",   "建造者现在能够建造阿卡萨城堡改良设施。[NEWLINE][NEWLINE]阿卡萨城堡提供+3 [ICON_Culture] 文化值。提供等于单元格魅力75%的 [ICON_SCIENCE] 科技值。占领单位 [ICON_Strength] 防御力+4，并自动获得2回合防御工事。研究“飞行”科技后可提供 [ICON_TOURISM] 旅游业绩。无法建在另一座阿卡萨城堡旁。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_GRANADA_BONUS_XP2",                "建造者现在能够建造阿卡萨城堡改良设施。[NEWLINE][NEWLINE]阿卡萨城堡提供+3 [ICON_Culture] 文化值。提供等于单元格魅力75%的 [ICON_SCIENCE] 科技值。占领单位 [ICON_Strength] 防御力+4，并自动获得2回合防御工事。研究“飞行”科技后可提供 [ICON_TOURISM] 旅游业绩。无法建在另一座阿卡萨城堡旁。"),
