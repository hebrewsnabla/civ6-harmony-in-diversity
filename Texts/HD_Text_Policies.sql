...
values
    ...
    ("LOC_POLICY_SCIENTIFIC_EXPEDITIONS_DESCRIPTION",                                 "Every foreign Commercial Hub district +3 [ICON_SCIENCE] Science to every cities on your original [ICON_Capital] Capital's continent. Every foreign Harbor district +3 [ICON_Culture] Culture to every cities on your original [ICON_Capital] Capital's continent."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_POLICY_SCIENTIFIC_EXPEDITIONS_DESCRIPTION",                                 "每个与 [ICON_Capital] 首都不在同一大陆的商业中心或港口分别为与 [ICON_Capital] 首都处于同一大陆的城市+3 [ICON_SCIENCE] 科技值或+3 [ICON_Culture] 文化值。"),
