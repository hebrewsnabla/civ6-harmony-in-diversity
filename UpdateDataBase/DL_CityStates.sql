...
values
	...
	('MINOR_CIV_CHINGUETTI_FAITH_FOLLOWERS',		'MODIFIER_PLAYER_ADJUST_TRADE_ROUTE_YIELD',NULL);

insert or replace into ModifierArguments
	(ModifierId,		Name,     Value)
values
	('MINOR_CIV_CHINGUETTI_UNIQUE_INFLUENCE_BONUS2','ModifierId',	'MINOR_CIV_CHINGUETTI_FAITH_FOLLOWERS'),
	('MINOR_CIV_CHINGUETTI_FAITH_FOLLOWERS',		'YieldType',	'YIELD_FAITH'),
	('MINOR_CIV_CHINGUETTI_FAITH_FOLLOWERS',		'Amount',		3);
...
--nanmadol
update Modifiers set SubjectRequirementSetId = 'NON-CITYCENTER_PLOT_IS_OR_ADJACENT_TO_COAST' where ModifierId = 'MINOR_CIV_NAN_MADOL_DISTRICTS_CULTURE_BONUS';

insert or replace into RequirementSets
	(RequirementSetId,			RequirementSetType)
values
	('NON-CITYCENTER_PLOT_IS_OR_ADJACENT_TO_COAST','REQUIREMENTSET_TEST_ALL');

insert or replace into RequirementSetRequirements
	(RequirementSetId,					RequirementId)
values
	('NON-CITYCENTER_PLOT_IS_OR_ADJACENT_TO_COAST', 'REQUIRES_DISTRICT_IS_NOT_CITY_CENTER'),
	('NON-CITYCENTER_PLOT_IS_OR_ADJACENT_TO_COAST',	'PLOT_IS_OR_ADJACENT_TO_COAST_REQUIREMENTS');
...
values
	...
	('MINOR_CIV_AUCKLAND_UNIQUE_INFLUENCE_BONUS_INDUSTRIAL',		'MODIFIER_ALL_PLAYERS_ATTACH_MODIFIER','PLAYER_IS_SUZERAIN'),
	('MINOR_CIV_AUCKLAND_UNIQUE_INFLUENCE_BONUS_BASE',				'MODIFIER_ALL_PLAYERS_ATTACH_MODIFIER','PLAYER_IS_SUZERAIN'),
	...
	('MINOR_CIV_AUCKLAND_BONUS_LIGHTHOUSE',							'MODIFIER_BUILDING_YIELD_CHANGE',		NULL),
	('MINOR_CIV_AUCKLAND_BONUS_SHIPYARD',							'MODIFIER_BUILDING_YIELD_CHANGE',		NULL),
	('MINOR_CIV_AUCKLAND_BONUS_SEAPORT',							'MODIFIER_BUILDING_YIELD_CHANGE',		NULL),
...
values
	...
	('MINOR_CIV_AUCKLAND_UNIQUE_INFLUENCE_BONUS_INDUSTRIAL',		'ModifierId',		'MINOR_CIV_AUCKLAND_FISHINGBOAT_BONUS_INDUSTRIAL'),
	('MINOR_CIV_AUCKLAND_UNIQUE_INFLUENCE_BONUS_BASE',				'ModifierId',		'MINOR_CIV_AUCKLAND_FISHINGBOAT_BONUS_BASE'),
	...
	('MINOR_CIV_AUCKLAND_BONUS_LIGHTHOUSE',							'BuildingType',		'BUILDING_LIGHTHOUSE'),
	('MINOR_CIV_AUCKLAND_BONUS_SHIPYARD',							'Amount',			2),
	('MINOR_CIV_AUCKLAND_BONUS_SHIPYARD',							'YieldType',		'YIELD_PRODUCTION'),
	('MINOR_CIV_AUCKLAND_BONUS_SHIPYARD',							'BuildingType',		'BUILDING_SHIPYARD'),
	('MINOR_CIV_AUCKLAND_BONUS_SEAPORT',							'BuildingType',		'BUILDING_SEAPORT'),
