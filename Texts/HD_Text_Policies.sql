...
values
    ...
    ("LOC_POLICY_PUBLIC_TRANSPORT_DESCRIPTION_XP2",                                   "City Center provides +100% adjacency bonuses to Holy Sites, Camupses, Theaters, Commercial Hubs, Harbors or Industrial Zones adjacent to it; provides +1 [ICON_Housing] Housing and +1 [ICON_Amenities] Amenity to these districts 2 tiles away from it; provides [ICON_Gold] Gold equal to the adjacency bonuses of these districts 3 tiles away from it."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_POLICY_PUBLIC_TRANSPORT_DESCRIPTION_XP2",                                   "市中心为相邻的圣地、学院、剧院广场、商业中心、港口或工业区+100%相邻加成；为距离2个单元格的这些区域提供+1 [ICON_Housing] 住房和+1 [ICON_Amenities] 宜居度；为距离3个单元格的这些区域提供等于相邻加成的 [ICON_GOLD] 金币。"),
