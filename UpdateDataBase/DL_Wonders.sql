...
values
	...
	('BUILDING_HERMITAGE',		'HERMITAGE_ADD_GREATWORKSLOT_ARTIFACT');

insert or replace into Modifiers
	(ModifierId,										ModifierType,											SubjectRequirementSetId)
values
	('HERMITAGE_THEATER_BUILDING_BOOST',				'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PRODUCTION',	Null),
	('HERMITAGE_ADD_GREATWORKSLOT_ARTIFACT',			'MODIFIER_PLAYER_DISTRICTS_ATTACH_MODIFIER',			'HD_THEATER_IS_WHITHIN_6_PLOT'),
	('HERMITAGE_ADD_GREATWORKSLOT_ARTIFACT_MODIFIER',	'MODIFIER_SINGLE_CITY_ADJUST_EXTRA_GREAT_WORK_SLOTS',	Null),
	('HERMITAGE_ARTIFACT_TOURISM_BOOST',				'MODIFIER_PLAYER_DISTRICTS_ATTACH_MODIFIER',			'HD_THEATER_IS_WHITHIN_6_PLOT'),
	('HERMITAGE_ARTIFACT_TOURISM_BOOST_MODIFIER',		'MODIFIER_SINGLE_CITY_ADJUST_TOURISM',					Null);
...
values
	...
	('HERMITAGE_ADD_GREATWORKSLOT_ARTIFACT',			'ModifierId',				'HERMITAGE_ADD_GREATWORKSLOT_ARTIFACT_MODIFIER'),
	('HERMITAGE_ARTIFACT_TOURISM_BOOST',				'ModifierId',				'HERMITAGE_ARTIFACT_TOURISM_BOOST_MODIFIER'),
	('HERMITAGE_ARTIFACT_TOURISM_BOOST_MODIFIER',  		'GreatWorkObjectType',      'GREATWORKOBJECT_ARTIFACT'),
    ('HERMITAGE_ARTIFACT_TOURISM_BOOST_MODIFIER',  		'ScalingFactor',            300),
	('HERMITAGE_ADD_GREATWORKSLOT_ARTIFACT_MODIFIER',   'BuildingType',      		'BUILDING_MUSEUM_ARTIFACT'),
    ('HERMITAGE_ADD_GREATWORKSLOT_ARTIFACT_MODIFIER',   'GreatWorkSlotType', 		'GREATWORKSLOT_ARTIFACT'),
    ('HERMITAGE_ADD_GREATWORKSLOT_ARTIFACT_MODIFIER',   'Amount',            		3);

insert or ignore into RequirementSets
	(RequirementSetId,											RequirementSetType)
values
	('HD_THEATER_IS_WHITHIN_6_PLOT',							'REQUIREMENTSET_TEST_ALL');

insert or ignore into RequirementSetRequirements
	(RequirementSetId,											RequirementId)
values
	('HD_THEATER_IS_WHITHIN_6_PLOT',							'REQUIRES_DISTRICT_IS_THEATER'),
	('HD_THEATER_IS_WHITHIN_6_PLOT',							'HD_REQUIRES_IS_WHITHIN_6_PLOT');
