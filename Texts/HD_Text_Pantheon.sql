...
values
    ...
    ("LOC_BELIEF_HD_UTAKI_DL_DESCRIPTION",                        "Cities adjacent to Coasts receive +2 [ICON_Housing] Housing. City Centers get +1 [ICON_Culture] Culture for every 2 adjacent Lake or Coast tiles and +1 [ICON_Production] Production for every 1 adjacent Lake or Coast tile."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_HD_UTAKI_DL_DESCRIPTION",                        "沿海市中心+2 [ICON_Housing] 住房。市中心每相邻2个近海或湖泊单元格+1 [ICON_Culture] 文化值，每相邻1个近海或湖泊单元格+1 [ICON_Production] 生产力。"),
