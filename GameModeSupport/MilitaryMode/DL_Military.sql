...
-- values
--     ('TECH_MILITARY_ENGINEERING',           'MILITARY_ENGINEERING_ADDITIONAL_HORSES_EXTRACTION'),
--     ('TECH_MILITARY_ENGINEERING',           'MILITARY_ENGINEERING_ADDITIONAL_IRON_EXTRACTION'),
--     ('TECH_MILITARY_ENGINEERING',           'MILITARY_ENGINEERING_ADDITIONAL_NITER_EXTRACTION'),
--     ('TECH_MILITARY_ENGINEERING',           'MILITARY_ENGINEERING_ADDITIONAL_COAL_EXTRACTION'),
--     ('TECH_MILITARY_ENGINEERING',           'MILITARY_ENGINEERING_ADDITIONAL_OIL_EXTRACTION'),
--     ('TECH_MILITARY_ENGINEERING',           'MILITARY_ENGINEERING_ADDITIONAL_ALUMINUM_EXTRACTION'),
--     ('TECH_MILITARY_ENGINEERING',           'MILITARY_ENGINEERING_ADDITIONAL_URANIUM_EXTRACTION');
-- update Technologies set Description = 'LOC_TECH_MILITARY_ENGINEERING_HD_DESCRIPTION' where TechnologyType = 'TECH_MILITARY_ENGINEERING';

insert into Modifiers
    (ModifierId,                                                ModifierType)
values
    ('MILITARY_ENGINEERING_ADDITIONAL_HORSES_EXTRACTION',       'MODIFIER_PLAYER_ADJUST_RESOURCE_ACCUMULATION_MODIFIER'),
    ('MILITARY_ENGINEERING_ADDITIONAL_IRON_EXTRACTION',         'MODIFIER_PLAYER_ADJUST_RESOURCE_ACCUMULATION_MODIFIER'),
    ('MILITARY_ENGINEERING_ADDITIONAL_NITER_EXTRACTION',        'MODIFIER_PLAYER_ADJUST_RESOURCE_ACCUMULATION_MODIFIER'),
    ('MILITARY_ENGINEERING_ADDITIONAL_COAL_EXTRACTION',         'MODIFIER_PLAYER_ADJUST_RESOURCE_ACCUMULATION_MODIFIER'),
    ('MILITARY_ENGINEERING_ADDITIONAL_OIL_EXTRACTION',          'MODIFIER_PLAYER_ADJUST_RESOURCE_ACCUMULATION_MODIFIER'),
    ('MILITARY_ENGINEERING_ADDITIONAL_ALUMINUM_EXTRACTION',     'MODIFIER_PLAYER_ADJUST_RESOURCE_ACCUMULATION_MODIFIER'),
    ('MILITARY_ENGINEERING_ADDITIONAL_URANIUM_EXTRACTION',      'MODIFIER_PLAYER_ADJUST_RESOURCE_ACCUMULATION_MODIFIER');
insert into ModifierArguments
    (ModifierId,                                                Name,           Value)
values
    ('MILITARY_ENGINEERING_ADDITIONAL_HORSES_EXTRACTION',       'ResourceType', 'RESOURCE_HORSES'),
    ('MILITARY_ENGINEERING_ADDITIONAL_IRON_EXTRACTION',         'ResourceType', 'RESOURCE_IRON'),
    ('MILITARY_ENGINEERING_ADDITIONAL_NITER_EXTRACTION',        'ResourceType', 'RESOURCE_NITER'),
    ('MILITARY_ENGINEERING_ADDITIONAL_COAL_EXTRACTION',         'ResourceType', 'RESOURCE_COAL'),
    ('MILITARY_ENGINEERING_ADDITIONAL_OIL_EXTRACTION',          'ResourceType', 'RESOURCE_OIL'),
    ('MILITARY_ENGINEERING_ADDITIONAL_ALUMINUM_EXTRACTION',     'ResourceType', 'RESOURCE_ALUMINUM'),
    ('MILITARY_ENGINEERING_ADDITIONAL_URANIUM_EXTRACTION',      'ResourceType', 'RESOURCE_URANIUM'),
    ('MILITARY_ENGINEERING_ADDITIONAL_HORSES_EXTRACTION',       'Amount',       '3'),
    ('MILITARY_ENGINEERING_ADDITIONAL_IRON_EXTRACTION',         'Amount',       '3'),
    ('MILITARY_ENGINEERING_ADDITIONAL_NITER_EXTRACTION',        'Amount',       '3'),
    ('MILITARY_ENGINEERING_ADDITIONAL_COAL_EXTRACTION',         'Amount',       '3'),
    ('MILITARY_ENGINEERING_ADDITIONAL_OIL_EXTRACTION',          'Amount',       '3'),
    ('MILITARY_ENGINEERING_ADDITIONAL_ALUMINUM_EXTRACTION',     'Amount',       '3'),
    ('MILITARY_ENGINEERING_ADDITIONAL_URANIUM_EXTRACTION',      'Amount',       '3');
