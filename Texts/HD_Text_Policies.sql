...
values
    ...
    ("LOC_POLICY_NEW_ROUTE_DESCRIPTION",                                              "Your international [ICON_TradeRoute] Trade Routes provide +2 [ICON_Culture] Culture and +2 [ICON_Science] Science, and additional +1 [ICON_Gold] Gold per Luxury and Strategic resource improved at the destination."),
