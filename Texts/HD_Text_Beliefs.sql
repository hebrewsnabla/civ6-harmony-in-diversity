...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_WORK_ETHIC_DL_DESCRIPTION",                  "所有专业化区域+2 [ICON_Production] 生产力，城市中每个信仰此宗教的居民将使 [ICON_Production] 生产力+1%，可以使用 [ICON_Faith] 信仰值购买工业区区域建筑。"),
    ("zh_Hans_CN",  "LOC_BELIEF_PRACTICAL_APPLICATION_NAME",                 "经世致用"),
    ("zh_Hans_CN",  "LOC_BELIEF_PRACTICAL_APPLICATION_DL_DESCRIPTION",       "每 [ICON_Citizen] 人口提供1.5 [ICON_Gold] 金币，城市中每个信仰此宗教的居民将使 [ICON_Gold] 金币+2%。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_MESSIAH_DL_DESCRIPTION",                     "购买圣地中建筑的费用降低10%且可以用 [ICON_Faith] 信仰值购买圣地建筑。建造圣地中建筑时+30%建造速度。每个圣地建筑为本城提供+5% [ICON_Faith] 信仰值。"),
    ("zh_Hans_CN",  "LOC_BELIEF_ABBOT_NAME",                                 "苦行"),
    ("zh_Hans_CN",  "LOC_BELIEF_ABBOT_DL_DESCRIPTION",                       "圣地+2 [ICON_Production] 生产力，圣地和神社为相邻的单元格提供+1 [ICON_Production] 生产力。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_JUST_WAR_DL_DESCRIPTION",                    "战斗单位处于信奉该宗教的外国城市境内时+5 [ICON_Strength] 战斗力，掠夺改良设施和区域可提供+25 [ICON_Faith] 信仰值。"),
