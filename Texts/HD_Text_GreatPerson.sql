...
values
    ...
    ("LOC_GREATPERSON_STRENGTH_AOE_KEQING",                      "+5 [ICON_STRENGTH] Combat Strength to all land units within 2 tiles."),
    ...
    ("LOC_WANGBEN_WALL",                                         "All land units gain +5 [ICON_STRENGTH] Combat Strength against district defenses."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_GREATPERSON_STRENGTH_AOE_KEQING",                               "在两个单元格以内，为所有陆地单位+5 [ICON_STRENGTH] 战斗力。"),
    ("zh_Hans_CN",  "LOC_UNIT_KEQING_NAME",                                              "客卿"),
    ("zh_Hans_CN",  "LOC_ABILITY_KEQING_AOE_MOVEMENT_DESCRIPTION",                       "客卿提供+1 [ICON_Movement] 移动力。"),
    ("zh_Hans_CN",  "LOC_ABILITY_KEQING_AOE_STRENGTH_DESCRIPTION",                       "客卿提供+5 [ICON_STRENGTH] 战斗力。"),
    ...
    ("zh_Hans_CN",  "LOC_WANGBEN_WALL",                                                  "攻击区域防御时，所有陆地单位+5 [ICON_STRENGTH] 战斗力。"),
    ("zh_Hans_CN",  "LOC_MENGAO_LEVEL",                                                  "赠予军事陆地单位1次强化等级。"),
