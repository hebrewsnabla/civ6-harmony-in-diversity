...
values
    ...
    (2,                     'ALLIANCE_ECONOMIC',      'ALLIANCE_ENVOY_POINTS_FROM_ALLIANCE_RCC'),
    -- 军事同盟
    (1,                     'ALLIANCE_MILITARY',      'ALLIANCE_ADJUST_COMBAT_STRENGTH_RCC'),
    (2,                     'ALLIANCE_MILITARY',      'ALLIANCE_INCREASE_PRODUCTION_WHEN_WAR_RCC'),
    -- 宗教同盟
    ...
    (2,                     'ALLIANCE_RELIGIOUS',     'ALLIANCE_ADJUST_RELIGIOUS_COMBAT_STRENGTH_RCC'),
    (3,                     'ALLIANCE_RELIGIOUS',     'ALLIANCE_YIELDS_FROM_FOLLOWING_ALLY_RELIGION_RCC'),
    (3,                     'ALLIANCE_RELIGIOUS',     'ALLIANCE_RELIGIOUS_PRESSURE_RCC'),
    -- 文化同盟
    ...
    (2,                     'ALLIANCE_CULTURAL',      'ALLIANCE_ADJUST_DISTRICT_GREAT_PEOPLE_POINTS_RCC'),
    (3,                     'ALLIANCE_CULTURAL',      'ALLIANCE_TOURISM_SHARING_FROM_ALLY_RCC'),
    (3,                     'ALLIANCE_CULTURAL',      'ALLIANCE_CULTURE_SHARING_FROM_ALLY_RCC'),
    -- 科技同盟
...
values
    ...
    ('ALLIANCE_ENVOY_POINTS_FROM_ALLIANCE_RCC',             'MODIFIER_ALLIANCE_PLAYERS_ENVOY_POINTS_FROM_ALLY',     'PLAYER_HAS_BUILDING_RCC_OR_WPH_REQUIREMENTS'),

    ('ALLIANCE_ADJUST_COMBAT_STRENGTH_RCC',                 'MODIFIER_ALLIANCE_COMBATS_UNIT_STRENGTHS',             'ALLIES_AT_WAR_WITH_TARGET_REQUIREMENTS_RCC'),
    ('ALLIANCE_INCREASE_PRODUCTION_WHEN_WAR_RCC',           'MODIFIER_ALLIANCE_CITIES_MILITARY_UNIT_PRODUCTION',    'PLAYER_HAS_BUILDING_RCC_OR_WPH_REQUIREMENTS'),
    ...
    ('ALLIANCE_ADJUST_RELIGIOUS_COMBAT_STRENGTH_RCC',       'MODIFIER_ALLIANCE_COMBATS_UNIT_STRENGTHS',             'RELIGIOUS_COMBAT_ENEMY_NOT_IN_ALLIED_RELIGION_RCC'),
    ('ALLIANCE_YIELDS_FROM_FOLLOWING_ALLY_RELIGION_RCC',    'MODIFIER_ALLIANCE_PLAYERS_YIELD_FROM_FOLLOWERS_OF_ALLY_RELIGIONS',    'PLAYER_HAS_BUILDING_RCC_OR_WPH_REQUIREMENTS'),
    ('ALLIANCE_RELIGIOUS_PRESSURE_RCC',                     'MODIFIER_ALLIANCE_PLAYERS_RELIGIOUS_PRESSURE',         'PLAYER_HAS_BUILDING_RCC_OR_WPH_REQUIREMENTS'),
    ...
    ('ALLIANCE_ADJUST_DISTRICT_GREAT_PEOPLE_POINTS_RCC',    'MODIFIER_ALLIANCE_DISTRICTS_ADJUST_GREAT_POINTS',      'ALLIANCE_CITY_HAS_TRADE_ROUTE_WITH_ALLY_RCC'),
    ('ALLIANCE_TOURISM_SHARING_FROM_ALLY_RCC',              'MODIFIER_ALLIANCE_PLAYERS_TOURISM_FROM_ALLY',          'PLAYER_HAS_BUILDING_RCC_OR_WPH_REQUIREMENTS'),
    ('ALLIANCE_CULTURE_SHARING_FROM_ALLY_RCC',              'MODIFIER_ALLIANCE_PLAYERS_CULTURE_FROM_ALLY',          'PLAYER_HAS_BUILDING_RCC_OR_WPH_REQUIREMENTS'),
    ...
    ('ALLIANCE_RESEARCH_AGREEMENT_RCC',                     'MODIFIER_ALLIANCE_RESEARCH_AGREEMENT',                 'PLAYER_HAS_BUILDING_RCC_OR_WPH_REQUIREMENTS'),
    ('ALLIANCE_SCIENCE_SHARING_FROM_ALLY_RCC',              'MODIFIER_ALLIANCE_PLAYERS_SCIENCE_FROM_ALLY',          'PLAYER_HAS_BUILDING_RCC_OR_WPH_REQUIREMENTS');
...
values
    ...
    ('ALLIANCE_ENVOY_POINTS_FROM_ALLIANCE_RCC',             'Amount',               1),

    ('ALLIANCE_ADJUST_COMBAT_STRENGTH_RCC',                 'Amount',               5),
    ('ALLIANCE_INCREASE_PRODUCTION_WHEN_WAR_RCC',           'Amount',               15),
    ...
    ('ALLIANCE_ADJUST_RELIGIOUS_COMBAT_STRENGTH_RCC',       'Amount',               10),
    ('ALLIANCE_YIELDS_FROM_FOLLOWING_ALLY_RELIGION_RCC',    'Amount',               1),
    ('ALLIANCE_YIELDS_FROM_FOLLOWING_ALLY_RELIGION_RCC',    'YieldType',            'YIELD_FAITH'),
    ('ALLIANCE_RELIGIOUS_PRESSURE_RCC',                     'Amount',               20),
    ...
    ('ALLIANCE_ADJUST_DISTRICT_GREAT_PEOPLE_POINTS_RCC',    'Amount',               2),
    ('ALLIANCE_TOURISM_SHARING_FROM_ALLY_RCC',              'Amount',               20),
    ('ALLIANCE_CULTURE_SHARING_FROM_ALLY_RCC',              'Amount',               10),
    ...
    ('ALLIANCE_RESEARCH_AGREEMENT_RCC',                     'Amount',               10),
    ('ALLIANCE_SCIENCE_SHARING_FROM_ALLY_RCC',              'Amount',               10);
