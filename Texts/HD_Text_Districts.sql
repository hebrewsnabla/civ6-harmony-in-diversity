...
values
	...
	("zh_Hans_CN",	"LOC_DISTRICT_HARBOR_HD_DESCRIPTION",							"城市中的海军活动区域。同时取消从该单元格上下船的 [ICON_Movement] 移动力消耗。必须修建在和陆地相邻的海岸或湖泊单元格上。如此城与海岸或湖边相邻，则+2 [ICON_HOUSING] 住房。为本城的渔船 +1 [ICON_FOOD] 食物。建造海军单位加速10%。允许开拓者上船。"),
	("zh_Hans_CN",	"LOC_DISTRICT_COTHON_HD_DESCRIPTION",							"腓尼基特色城市海军活动区域，取代港口且建造成本更低。必须修建在和陆地相邻的海岸或湖泊单元格上。如此城与海岸或湖边相邻，则+2 [ICON_HOUSING] 住房。为本城的渔船 +1 [ICON_FOOD] 食物。本城的余粮+15%，建造海军单位和开拓者加速50%。海军单位在此城驻扎一回合可完全恢复。允许开拓者上船。"),
	("zh_Hans_CN",	"LOC_DISTRICT_ROYAL_NAVY_DOCKYARD_HD_DESCRIPTION",				"城市中的英国特色海军活动区域，取代港口且建造成本更低。同时移除该单元格的上船、下船 [ICON_Movement] 移动力减益。必须建在与陆地相邻的海岸或湖泊地形上。如此城与海岸或湖边相邻，则+2 [ICON_HOUSING] 住房。为本城的渔船 +1 [ICON_FOOD] 食物。建造海军单位加速10%。[NEWLINE][NEWLINE]皇家海军船坞中建造的所有海军单位+1 [ICON_Movement] 移动力。修建在外国大陆上时+2 [ICON_Gold] 金币、每回合的忠诚度+4。相邻每个工业区+2 [ICON_Gold] 金币。本城正确改良的战略每回合积累+2。允许开拓者上船。"),
	...
	("zh_Hans_CN",	"LOC_DISTRICT_SUGUBA_HD_DESCRIPTION",							"马里特色区域，专精于经济与贸易，替代“商业中心”，与圣地相邻获得大相邻加成。允许本城使用金币购买区域。使用 [ICON_GOLD] 金币和 [ICON_FAITH] 信仰值在此城中购买单位、建筑和区域时，费用减少15%。[NEWLINE][NEWLINE]本城出发的 [ICON_TradeRoute] 贸易路线+2 [ICON_Gold] 金币。改良加成资源的牧场+1 [ICON_Food] 食物。"), --[NEWLINE][NEWLINE]每相邻一个圣地获得+2 [ICON_Gold] 金币加成。每相邻一个港口获得+2 [ICON_Gold] 金币加成。
