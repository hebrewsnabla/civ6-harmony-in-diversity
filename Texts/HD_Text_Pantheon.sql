...
values
    ...
    ("LOC_BELIEF_HD_DRUID_DL_DESCRIPTION",                        "+1 [ICON_Production] Production from Forest or Jungle tiles, +1 [ICON_Gold] Gold from improved Forest or Jungle tiles."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_HD_DRUID_DL_DESCRIPTION",                        "森林和雨林单元格+1 [ICON_Production] 生产力，改良后的森林和雨林单元格+1 [ICON_Gold] 金币。"),
