...
values
    ...
    ("LOC_GOVT_INHERENT_BONUS_THEOCRACY_XP1",                                         "+5 [ICON_Religion] Religious Strength in Theological Combat. Gains +1 [ICON_Faith] Faith from each follower of the Religion that is established as majority in your cities with Tier-2 Building of Holysite District."),
    ...
    ("LOC_POLICY_SIMULTANEUM_DL_DESCRIPTION",                                         "Temples generate 0.3 [ICON_FAITH] Faith and Worship Buildings generate 0.5 [ICON_FAITH] Faith per [ICON_Citizen] citizen in the city."),
