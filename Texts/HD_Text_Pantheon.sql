...
values
    ...
    ("LOC_BELIEF_GODDESS_OF_FESTIVALS_DL_DESCRIPTION",            "+1 [ICON_Food] Food from Plantations. Holy Site districts get +2 [ICON_Faith] Faith from each adjacent Plantation. Holy Site provides +1 [ICON_Faith] Faith to adjacent Plantations. +1 [ICON_GreatProphet] Great Prophet point per turn if a city owns a Plantation."),
    ("LOC_BELIEF_TENGRI_NAME",                                    "Tengri"),
    ("LOC_BELIEF_TENGRI_DL_DESCRIPTION",                          "+1 [ICON_Production] Production from Pastures. Holy Site districts get +2 [ICON_Faith] Faith from each adjacent Pasture. Holy Site provides +1 [ICON_Faith] Faith to all Pastures within the same city. +1 [ICON_GreatProphet] Great Prophet point per turn if a city owns a Pasture."),
