...
values
    ...
    ("LOC_BELIEF_WORK_ETHIC_DL_DESCRIPTION",                  ""),
    ...
    ("LOC_BELIEF_MESSIAH_DL_DESCRIPTION",                     ""),
    ("LOC_BELIEF_ABBOT_NAME",                                 "Abbot"),
    ("LOC_BELIEF_ABBOT_DL_DESCRIPTION",                       "Holy Site District and Shrine in cities following this Religion provides +1 [ICON_Production] Production to all adjacent tiles."),
    ...
    ("LOC_BELIEF_JUST_WAR_DL_DESCRIPTION",                    "Combat units gain +5 [ICON_Strength] Combat Strength when within the borders of foreign cities that follow this Religion."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_PAPAL_PRIMACY_DL_DESCRIPTION",               "将一个 [ICON_ENVOY]使者派遣至城邦后，将对该城邦施加200点宗教压力。征兵费用减少20%。除了城邦的任务外，城邦信教将自动向该城邦派遣1至2个 [ICON_Envoy] 使者。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_RELIGIOUS_COMMUNITY_DL_DESCRIPTION",         "信奉该宗教的城市，圣地中每座建筑为此城出发的国际 [ICON_TradeRoute] 贸易路线+1 [ICON_Science] 科技值，使每条通往此城的国际 [ICON_TradeRoute] 贸易路线为双方+1 [ICON_Science] 科技值。可用 [ICON_Faith] 信仰值购买商人，用 [ICON_FAITH] 信仰值和 [ICON_GOLD] 金币购买商人的费用降低20%。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_WORK_ETHIC_DL_DESCRIPTION",                  ""),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_MESSIAH_DL_DESCRIPTION",                     ""),
    ("zh_Hans_CN",  "LOC_BELIEF_ABBOT_NAME",                                 "苦行"),
    ("zh_Hans_CN",  "LOC_BELIEF_ABBOT_DL_DESCRIPTION",                       "信奉该宗教的城市，圣地和神社给相邻的单元格+1 [ICON_Production] 生产力。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_JUST_WAR_DL_DESCRIPTION",                    "战斗单位处于信奉该宗教的外国城市境内时+5 [ICON_Strength] 战斗力。"),
