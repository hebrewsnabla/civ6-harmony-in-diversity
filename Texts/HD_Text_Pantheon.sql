...
values
    ...
    ("LOC_BELIEF_HD_UTAKI_DL_DESCRIPTION",                        "Coast and Lake tiles provide a minor adjacency bonus for Harbor Districts. +1 [ICON_FOOD] Food and +1 [ICON_PRODUCTION] Production from Coast and Lake tiles adjacent to Harbor Districts."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_HD_UTAKI_DL_DESCRIPTION",                        "海岸和湖泊单元格可为港口提供少量相邻加成。相邻港口的近海和湖泊单元格+1 [ICON_FOOD] 食物，+1 [ICON_PRODUCTION] 生产力。"),
