...
values					
	...
	('BUILDING_HD_LANDFORM_EPO',		        'DISTRICT_PRESERVE',	    'CIVIC_CONSERVATION',	NULL,       	    750,	7,				'YIELD_GOLD',		'ADVISOR_GENERIC',		'LOC_BUILDING_HD_LANDFORM_EPO_NAME',		        'LOC_BUILDING_HD_LANDFORM_EPO_DESCRIPTION'),
	('BUILDING_HD_RESOURCE_EPO',		        'DISTRICT_PRESERVE',	    NULL,	                'TECH_CHEMISTRY',   750,	7,				'YIELD_GOLD',		'ADVISOR_GENERIC',		'LOC_BUILDING_HD_RESOURCE_EPO_NAME',		        'LOC_BUILDING_HD_RESOURCE_EPO_DESCRIPTION'),
	('BUILDING_HD_SPECIES_EPO',		            'DISTRICT_PRESERVE',	    NULL,	                'TECH_BIOLOGY_HD',  750,	7,				'YIELD_GOLD',		'ADVISOR_GENERIC',		'LOC_BUILDING_HD_SPECIES_EPO_NAME',			        'LOC_BUILDING_HD_SPECIES_EPO_DESCRIPTION'),
	('BUILDING_HD_SCENIC_EPO',		            'DISTRICT_PRESERVE',	    'CIVIC_CONSERVATION',	NULL,       	    750,	7,				'YIELD_GOLD',		'ADVISOR_GENERIC',		'LOC_BUILDING_HD_SCENIC_EPO_NAME',			        'LOC_BUILDING_HD_SCENIC_EPO_DESCRIPTION'),
...
update Buildings set Maintenance = 4,	Cost = 150, AdvisorType = 'ADVISOR_GENERIC', PrereqCivic = 'CIVIC_CIVIL_SERVICE'    where BuildingType = 'BUILDING_SANCTUARY';
