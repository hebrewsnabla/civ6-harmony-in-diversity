...
values
    ...
    ("LOC_BELIEF_DIVINE_INSPIRATION_DL_DESCRIPTION",          "All world wonders provide +4 [ICON_Faith] Faith. Holy Site provides extra [ICON_Faith] Faith equal to the district adjacency bonus. Each time gain [ICON_Faith] Faith equal to 50% production cost after Wonder construction."),
    ...
    ("LOC_BELIEF_RELIGIOUS_COMMUNITY_DL_DESCRIPTION",         "Each building in the Holy Site district provides +1 [ICON_SCIENCE] Science for international [ICON_TradeRoute] Trade Routes, and +1 [ICON_SCIENCE] Science for both sides of international [ICON_TradeRoute] Trade Routes to this city. May purchase trader units with [ICON_Faith] Faith. Trader are 20% cheaper to purchase. "),
    ...
    ("LOC_BELIEF_CAPELLANI_DL_DESCRIPTION",                   "After this belief being added, the religious units newly obtained from cities with this religion can provide +5 [ICON_Strength] Combat Strength to the Combat Units in the same plot."),
    ...
    ("LOC_BELIEF_MILLENNIALISM_DL_DESCRIPTION",               "After this belief being added, the apostles newly obtained from cities with this religion will receive 1 extra promotion."),
