...
values
    ...
    ("LOC_LEADER_TRAIT_KANDY_DESCRIPTION",                "+4 [ICON_Faith] Faith from [ICON_GreatWork_Relic] Relics."),
    --("LOC_CIVILIZATION_KANDY_BONUS",                      "Earn +100% [ICON_Faith] Faith from all [ICON_GreatWork_Relic] Relics."),
    ("LOC_LEADER_TRAIT_MITLA_DESCRIPTION",                "Campus and each Campus building provides +1 [ICON_FOOD] Food. +10% city growth speed in cities with Campus."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_KANDY_DESCRIPTION",                "[ICON_GreatWork_Relic] 遗物额外提供+4 [ICON_Faith] 信仰值。"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_BABYLON_DESCRIPTION",              "位于丘陵之上或靠近山脉的学院+3 [ICON_SCIENCE] 科技值。"), -- 学院提供+4 [ICON_GreatWork_WRITING] 大作家点数
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_MEXICO_CITY_DESCRIPTION",          "辐射建筑额外提供等同于其基础产出一半（向下取整且至少为1）的产出，该额外产出可以被辐射效果延伸。"),
...
values
    ...
    ("LOC_CSE_TRADE_TRAIT_SMALL_INFLUENCE_BONUS",               "+3 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_TRADE_TRAIT_MEDIUM_INFLUENCE_BONUS",              "+6 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_TRADE_TRAIT_LARGE_INFLUENCE_BONUS",               "+9 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS",             "+12 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_TRADE_TRAIT_SMALL_INFLUENCE_BONUS_ALT",           "+3 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_TRADE_TRAIT_MEDIUM_INFLUENCE_BONUS_ALT",          "+6 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_TRADE_TRAIT_LARGE_INFLUENCE_BONUS_ALT",           "+9 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS_ALT",         "+12 [ICON_GOLD] Gold from every *."),
    ...
    ("LOC_CSE_MARITIME_TRAIT_SMALL_INFLUENCE_BONUS",            "+3 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_MARITIME_TRAIT_MEDIUM_INFLUENCE_BONUS",           "+6 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_MARITIME_TRAIT_LARGE_INFLUENCE_BONUS",            "+9 [ICON_GOLD] Gold from every *."),
    ("LOC_CSE_MARITIME_TRAIT_LARGEST_INFLUENCE_BONUS",          "+12 [ICON_GOLD] Gold from every *.");
...
values
    ...
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_SMALL_INFLUENCE_BONUS",                "每座*+3 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_MEDIUM_INFLUENCE_BONUS",               "每座*+6 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_LARGE_INFLUENCE_BONUS",                "每座*+9 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS",              "每座*+12 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_SMALL_INFLUENCE_BONUS_ALT",            "每座*+3 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_MEDIUM_INFLUENCE_BONUS_ALT",           "每座*+6 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_LARGE_INFLUENCE_BONUS_ALT",            "每座*+9 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS_ALT",          "每座*+12 [ICON_Gold] 金币。"),
    ...
    ("zh_Hans_CN",  "LOC_CSE_MARITIME_TRAIT_SMALL_INFLUENCE_BONUS",             "每座*+3 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_MARITIME_TRAIT_MEDIUM_INFLUENCE_BONUS",            "每座*+6 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_MARITIME_TRAIT_LARGE_INFLUENCE_BONUS",             "每座*+9 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CSE_MARITIME_TRAIT_LARGEST_INFLUENCE_BONUS",           "每座*+12 [ICON_Gold] 金币。");