...
insert or replace into TraitModifiers
	(TraitType,										ModifierId)
values
	('TRAIT_CIVILIZATION_ZULU_ISIBONGO',			'CAPTURED_CITY_BARRACKS_SCIENCE'),
	('TRAIT_CIVILIZATION_ZULU_ISIBONGO',			'CAPTURED_CITY_BARRACKS_GOLD'),
	('TRAIT_CIVILIZATION_ZULU_ISIBONGO',			'CAPTURED_CITY_STABLE_SCIENCE'),
	('TRAIT_CIVILIZATION_ZULU_ISIBONGO',			'CAPTURED_CITY_STABLE_GOLD'),
	('TRAIT_CIVILIZATION_ZULU_ISIBONGO',			'CAPTURED_CITY_ARMORY_SCIENCE'),
	('TRAIT_CIVILIZATION_ZULU_ISIBONGO',			'CAPTURED_CITY_ARMORY_GOLD'),
	('TRAIT_CIVILIZATION_ZULU_ISIBONGO',			'CAPTURED_CITY_MILITARY_ACADEMY_SCIENCE'),
	('TRAIT_CIVILIZATION_ZULU_ISIBONGO',			'CAPTURED_CITY_MILITARY_ACADEMY_GOLD');

insert or replace into Modifiers
	(ModifierId,									ModifierType)
values
	('CAPTURED_CITY_BARRACKS_SCIENCE',				'MODIFIER_PLAYER_CAPTURED_CITY_ADJUST_BUILDING_YIELD_CHANGE'),
	('CAPTURED_CITY_BARRACKS_GOLD',					'MODIFIER_PLAYER_CAPTURED_CITY_ADJUST_BUILDING_YIELD_CHANGE'),
	('CAPTURED_CITY_STABLE_SCIENCE',				'MODIFIER_PLAYER_CAPTURED_CITY_ADJUST_BUILDING_YIELD_CHANGE'),
	('CAPTURED_CITY_STABLE_GOLD',					'MODIFIER_PLAYER_CAPTURED_CITY_ADJUST_BUILDING_YIELD_CHANGE'),
	('CAPTURED_CITY_ARMORY_SCIENCE',				'MODIFIER_PLAYER_CAPTURED_CITY_ADJUST_BUILDING_YIELD_CHANGE'),
	('CAPTURED_CITY_ARMORY_GOLD',					'MODIFIER_PLAYER_CAPTURED_CITY_ADJUST_BUILDING_YIELD_CHANGE'),
	('CAPTURED_CITY_MILITARY_ACADEMY_SCIENCE',		'MODIFIER_PLAYER_CAPTURED_CITY_ADJUST_BUILDING_YIELD_CHANGE'),
	('CAPTURED_CITY_MILITARY_ACADEMY_GOLD',			'MODIFIER_PLAYER_CAPTURED_CITY_ADJUST_BUILDING_YIELD_CHANGE');

insert or replace into ModifierArguments
	(ModifierId,									Name,			Value)
values
	('CAPTURED_CITY_BARRACKS_SCIENCE',				'BuildingType',	'BUILDING_BARRACKS'),
	('CAPTURED_CITY_BARRACKS_SCIENCE',				'YieldType',	'YIELD_SCIENCE'),
	('CAPTURED_CITY_BARRACKS_SCIENCE',				'Amount',		1),
	('CAPTURED_CITY_BARRACKS_GOLD',					'BuildingType',	'BUILDING_BARRACKS'),
	('CAPTURED_CITY_BARRACKS_GOLD',					'YieldType',	'YIELD_GOLD'),
	('CAPTURED_CITY_BARRACKS_GOLD',					'Amount',		2),
	('CAPTURED_CITY_STABLE_SCIENCE',				'BuildingType',	'BUILDING_BARRACKS'),
	('CAPTURED_CITY_STABLE_SCIENCE',				'YieldType',	'YIELD_SCIENCE'),
	('CAPTURED_CITY_STABLE_SCIENCE',				'Amount',		1),
	('CAPTURED_CITY_STABLE_GOLD',					'BuildingType',	'BUILDING_BARRACKS'),
	('CAPTURED_CITY_STABLE_GOLD',					'YieldType',	'YIELD_GOLD'),
	('CAPTURED_CITY_STABLE_GOLD',					'Amount',		2),
	('CAPTURED_CITY_ARMORY_SCIENCE',				'BuildingType',	'BUILDING_BARRACKS'),
	('CAPTURED_CITY_ARMORY_SCIENCE',				'YieldType',	'YIELD_SCIENCE'),
	('CAPTURED_CITY_ARMORY_SCIENCE',				'Amount',		1),
	('CAPTURED_CITY_ARMORY_GOLD',					'BuildingType',	'BUILDING_BARRACKS'),
	('CAPTURED_CITY_ARMORY_GOLD',					'YieldType',	'YIELD_GOLD'),
	('CAPTURED_CITY_ARMORY_GOLD',					'Amount',		2),
	('CAPTURED_CITY_MILITARY_ACADEMY_SCIENCE',		'BuildingType',	'BUILDING_BARRACKS'),
	('CAPTURED_CITY_MILITARY_ACADEMY_SCIENCE',		'YieldType',	'YIELD_SCIENCE'),
	('CAPTURED_CITY_MILITARY_ACADEMY_SCIENCE',		'Amount',		1),
	('CAPTURED_CITY_MILITARY_ACADEMY_GOLD',			'BuildingType',	'BUILDING_BARRACKS'),
	('CAPTURED_CITY_MILITARY_ACADEMY_GOLD',			'YieldType',	'YIELD_GOLD'),
	('CAPTURED_CITY_MILITARY_ACADEMY_GOLD',			'Amount',		2);