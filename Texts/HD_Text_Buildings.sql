...
values
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_HD_LANDFORM_EPO_NAME",                         "地貌生态环境专局"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_LANDFORM_EPO_DESCRIPTION",                  ""),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_RESOURCE_EPO_NAME",                         "不可再生资源管理专局"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_RESOURCE_EPO_DESCRIPTION",                  ""),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_SPECIES_EPO_NAME",                          "物种多样性维护专局"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_SPECIES_EPO_DESCRIPTION",                   ""),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_SCENIC_EPO_NAME",                           "自然名胜旅游专局"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_SCENIC_EPO_DESCRIPTION",                    ""),

    ("zh_Hans_CN",  "LOC_BUILDING_HD_DUMMY_PREREQ_PRESERVE_NAME",                "保护区"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_DUMMY_PREREQ_PRESERVE_DESCRIPTION",         "需要该城的保护区位于或相邻特定的地形或地貌单元格，且拥有一级建筑。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_DUMMY_FOREST_PRESERVE_NAME",                "保护区位于或相邻森林，且拥有一级建筑"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_DUMMY_FOREST_PRESERVE_DESCRIPTION",         "该城的保护区位于或相邻森林单元格（包括森林类自然奇观），且拥有一级建筑。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_DUMMY_JUNGLE_PRESERVE_NAME",                "保护区位于或相邻雨林，且拥有一级建筑"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_DUMMY_JUNGLE_PRESERVE_DESCRIPTION",         "该城的保护区位于或相邻雨林单元格（包括雨林类自然奇观），且拥有一级建筑。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_DUMMY_WETLANDS_PRESERVE_NAME",              "保护区位于或相邻湿地，且拥有一级建筑"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_DUMMY_WETLANDS_PRESERVE_DESCRIPTION",       "该城的保护区位于或相邻湿地单元格（包括沼泽、泛滥平原、绿洲、湿地类自然奇观），且拥有一级建筑。"),
    ("zh_Hans_CN",  "LOC_BUILDING_HD_DUMMY_WATER_PRESERVE_NAME",                 "保护区相邻湖泊或海岸单元格，且拥有一级建筑"),
