...
insert or replace into CommemorationModifiers
	(CommemorationType,					ModifierId)
values
	('COMMEMORATION_EXPLORATION',		'COMMEMORATION_EXPLORATION_SETTLER_MOVEMENT'),
	('COMMEMORATION_EXPLORATION',		'COMMEMORATION_EXPLORATION_DISTRICT_PRODUCTION');
insert or replace into Modifiers
	(ModifierId,										ModifierType,													OwnerRequirementSetId,		SubjectRequirementSetId)
values
	('COMMEMORATION_EXPLORATION_SETTLER_MOVEMENT',		'MODIFIER_PLAYER_UNITS_ADJUST_MOVEMENT',						'PLAYER_HAS_GOLDEN_AGE',	'UNIT_IS_UNIT_SETTLER_REQUIREMENTS'),
	('COMMEMORATION_EXPLORATION_DISTRICT_PRODUCTION',	'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION_MODIFIER',	'PLAYER_HAS_GOLDEN_AGE',	'CITY_HAS_0_SPECIALTY_DISTRICTS_REQUIREMENTS');
insert or replace into ModifierArguments
	(ModifierId,											Name,			Value)
values
	('COMMEMORATION_EXPLORATION_SETTLER_MOVEMENT',			'Amount',		2),
...
--	('POLICY_FORGING',					'EQUESTRIAN_ORDERS_ADDITIONAL_IRON_EXTRACTION'),
	...
	('POLICY_DRILL_MANUALS',			'ENCAMPMENT_HORSES'),
	('POLICY_DRILL_MANUALS',			'ENCAMPMENT_IRON'),
