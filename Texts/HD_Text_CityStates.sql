...
values
    ...
    ("LOC_LEADER_TRAIT_AKKAD_DESCRIPTION",                "May purchase support units with [ICON_Faith] Faith. Land units can escort moving civilian ,+1 [ICON_Movement] Movement and support units at their [ICON_Movement] Movement speed."),
    ("LOC_CIVILIZATION_AKKAD_BONUS",                      "May purchase support units with [ICON_Faith] Faith. Land units can escort moving civilian ,+1 [ICON_Movement] Movement and support units at their [ICON_Movement] Movement speed."),
    ...
    ("LOC_LEADER_TRAIT_RAPA_NUI_DESCRIPTION",             "Your Builders can now make Moai improvements.[NEWLINE][NEWLINE]Moai provide +3 [ICON_Culture] Culture. +1 [ICON_Culture] Culture for every 2 adjacent Moai. +2 [ICON_Culture] Culture if on or adjacent to a Volcanic Soil tile.  Additional [ICON_Culture] Culture and [ICON_Tourism] Tourism as you advance through the Civics and Technology Tree. Can be built on Plains, Plains Hills, Grassland, Grassland Hills, or Volcanic Soil. Can only be placed adjacent to a Lake or Coast tile.Can be built on resourses and use them."),
    ...
    ("LOC_LEADER_TRAIT_TARUGA_DESCRIPTION",               "+10% [ICON_SCIENCE] Science in all cities for each different improved Strategic resource they have."),
    ("LOC_CIVILIZATION_TARUGA_BONUS",                     "+10% [ICON_SCIENCE] Science in all cities for each different improved Strategic resource they have."),
    ("LOC_LEADER_TRAIT_VALLETTA_DESCRIPTION",             "City Center buildings and Encampment district buildings can be bought with [ICON_Faith] Faith and be bought with 20% off. Purchasing Ancient, Medieval, and Renaissance Walls (including Tsikhe) is 50% cheaper, but they can only be bought with [ICON_Faith] Faith."),
    ("LOC_CIVILIZATION_VALLETTA_BONUS",                   "City Center buildings and Encampment district buildings can be bought with [ICON_Faith] Faith and be bought with 20% off. Purchasing Ancient, Medieval, and Renaissance Walls (including Tsikhe) is 50% cheaper, but they can only be bought with [ICON_Faith] Faith."),
    ("LOC_LEADER_TRAIT_SINGAPORE_DESCRIPTION",            "Your International [ICON_TradeRoute] Trade Routes gain +3 [ICON_Production] Production. Your [ICON_TradeRoute] Trade Routes to an Ally's city or vassal city-state gain +6 [ICON_Gold] Gold."),
    ("LOC_CIVILIZATION_SINGAPORE_BONUS",                  "Your International [ICON_TradeRoute] Trade Routes gain +3 [ICON_Production] Production. Your [ICON_TradeRoute] Trade Routes to an Ally's city or vassal city-state gain +6 [ICON_Gold] Gold."),
    ...
    ("LOC_LEADER_TRAIT_FEZ_DESCRIPTION",                  "+2 [ICON_SCIENCE] Science from each Shrine, Temple and Religious building. Campus +2 [ICON_Science] Science."),
    ("LOC_CIVILIZATION_FEZ_BONUS",                        "+2 [ICON_SCIENCE] Science from each Shrine, Temple and Religious building. Campus +2 [ICON_Science] Science."),
    ("LOC_LEADER_TRAIT_HATTUSA_EXPANSION2_DESCRIPTION",   "Provides you with 2 of each Strategic resource per turn that you have revealed. Each kind of Strategic resource +2 [ICON_Science] Science for your city."),
    ("LOC_CIVILIZATION_HATTUSA_BONUS_XP2",                "Provides you with 2 of each Strategic resource per turn that you have revealed. Each kind of Strategic resource +2 [ICON_Science] Science for your city."),
    ...
    ("LOC_LEADER_TRAIT_ANTIOCH_DESCRIPTION",              "City with governor has 15% off when buying buildings."),
    ("LOC_CIVILIZATION_ANTIOCH_BONUS",                    "City with governor has 15% off when buying buildings."),
    ...
    ("LOC_LEADER_TRAIT_MUSCAT_DESCRIPTION",               "+1 [ICON_Amenities] Amenity in cities with a Commercial Hub district. +100% Commercial Hub district adjacency bonus."),
    ("LOC_CIVILIZATION_MUSCAT_BONUS",                     "+1 [ICON_Amenities] Amenity in cities with a Commercial Hub district. +100% Commercial Hub district adjacency bonus."),
    ("LOC_LEADER_TRAIT_SAMARKAND_DESCRIPTION",            "Your Builders can now make Trading Dome improvements.[NEWLINE][NEWLINE]+2 [ICON_GOLD] Gold. +4 [ICON_GOLD] Gold after discovring Civiv Medieval Faires. +2 [ICON_Gold] Gold to adjacent Luxury resource. +2 [ICON_Gold] Gold for every adjacent Luxury resource. Your outgoing international [ICON_TradeRoute] Trade Routes grant +2 [ICON_GOLD] Gold per Trading Dome at the origin. Cannot be built next to another Trading Dome."),
    ("LOC_CIVILIZATION_SAMARKAND_BONUS",                  "Your Builders can now make Trading Dome improvements.[NEWLINE][NEWLINE]+2 [ICON_GOLD] Gold. +4 [ICON_GOLD] Gold after discovring Civiv Medieval Faires. +2 [ICON_Gold] Gold to adjacent Luxury resource. +2 [ICON_Gold] Gold for every adjacent Luxury resource. Your outgoing international [ICON_TradeRoute] Trade Routes grant +2 [ICON_GOLD] Gold per Trading Dome at the origin. Cannot be built next to another Trading Dome."),
    ...
    ("LOC_LEADER_TRAIT_LISBON_DESCRIPTION",               "Your Trader units are immune to being plundered on water tiles. [ICON_TradeRoute] Trade Routes receive bonus +6 [ICON_Gold] Gold for routes to other civilizations, and bonus +1 [ICON_Food] Food and +1 [ICON_Production] Production for routes between your own cities. Double when between multiple continents."),
    ("LOC_CIVILIZATION_LISBON_BONUS",                     "Your Trader units are immune to being plundered on water tiles. [ICON_TradeRoute] Trade Routes receive bonus +6 [ICON_Gold] Gold for routes to other civilizations, and bonus +1 [ICON_Food] Food and +1 [ICON_Production] Production for routes between your own cities. Double when between multiple continents."),
    ("LOC_LEADER_TRAIT_MOHENJO_DARO_DESCRIPTION",         "Your cities have full [ICON_Housing] Housing from water, as if they were all next to a River.+0.3 [ICON_Culture] Culture for each [ICON_Citizen] citizen in this city if city has Theater or Entertainment Complex"),
    ("LOC_CIVILIZATION_MOHENJO_DARO_BONUS",               "Your cities have full [ICON_Housing] Housing from water, as if they were all next to a River.+0.3 [ICON_Culture] Culture for each [ICON_Citizen] citizen in this city if city has Theater or Entertainment Complex"),
    ...
    ("LOC_LEADER_TRAIT_CARDIFF_DESCRIPTION",              "Cities receive +3 [ICON_Power] Power for every Harbor building. +4 corresponding output for buildings powered."),
    ...
    ("LOC_LEADER_TRAIT_AYUTTHAYA_DESCRIPTION",            "Theater, Holy Site, Commercial Hub, Entertainment Complex and Wonders provide 2 [ICON_CULTURE] Culture if they are located near river."),
    ("LOC_CIVILIZATION_AYUTTHAYA_BONUS",                  "Theater, Holy Site, Commercial Hub, Entertainment Complex and Wonders provide 2 [ICON_CULTURE] Culture if they are located near river."),
    ...
    ("LOC_LEADER_TRAIT_NAZCA_DESCRIPTION",            "Nazca Lines provide +1 [ICON_Faith] Faith, +1 [ICON_Food] Food and +1 [ICON_Production] Production to adjacent tiles. +1 [ICON_Faith] Faith to adjacent Desert and Desert hill tiles and tiles with a resourse. +1 [Icon_Food] Food to adjacent tiles after discovering Civil Service. +1 [ICON_Production] to adjacent flat tiles after researching Mass Production. +1 Appeal. Can only be built on flat Desert. This tile cannot be worked."),
    ("LOC_CIVILIZATION_NAZCA_BONUS",                  "Nazca Lines provide +1 [ICON_Faith] Faith, +1 [ICON_Food] Food and +1 [ICON_Production] Production to adjacent tiles. +1 [ICON_Faith] Faith to adjacent Desert and Desert hill tiles and tiles with a resourse. +1 [Icon_Food] Food to adjacent tiles after discovering Civil Service. +1 [ICON_Production] to adjacent flat tiles after researching Mass Production. +1 Appeal. Can only be built on flat Desert. This tile cannot be worked."),    
    ("LOC_LEADER_TRAIT_CAHOKIA_DESCRIPTION",              "Your Builders can now make Cahokia Mounds improvements.[NEWLINE][NEWLINE]Cahokia Mounds provide +3 [ICON_GOLD] Gold. Cities receive +1 [ICON_AMENITIES] Amenity from their first and second Cahokia Mound improvement. +1 [ICON_FOOD] Food for every adjacent Districts. +2 [ICON_FOOD] Food for every adjacent Districts once Feudalism is discovered. Provides +1 [ICON_HOUSING] Housing. Receive an additional [ICON_HOUSING] Housing once Cultural Heritage is discovered. Cannot be built adjacent to other Cahokia Mounds."),
    ("LOC_CIVILIZATION_CAHOKIAL_BONUS",                   "Your Builders can now make Cahokia Mounds improvements.[NEWLINE][NEWLINE]Cahokia Mounds provide +3 [ICON_GOLD] Gold. Cities receive +1 [ICON_AMENITIES] Amenity from their first and second Cahokia Mound improvement. +1 [ICON_FOOD] Food for every adjacent Districts. +2 [ICON_FOOD] Food for every adjacent Districts once Feudalism is discovered. Provides +1 [ICON_HOUSING] Housing. Receive an additional [ICON_HOUSING] Housing once Cultural Heritage is discovered. Cannot be built adjacent to other Cahokia Mounds.");
...
values
    ...
    ("zh_Hans_CN",  "LOC_MINOR_CIV_MEDIUM_INFLUENCE_ENVOYS",             "派遣2位 [ICON_Envoy] 使者："),
    ("zh_Hans_CN",  "LOC_MINOR_CIV_LARGE_INFLUENCE_ENVOYS",              "派遣5位 [ICON_Envoy] 使者："),
    ("zh_Hans_CN",  "LOC_MINOR_CIV_LARGEST_INFLUENCE_ENVOYS",            "派遣9位 [ICON_Envoy] 使者："),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_AKKAD_DESCRIPTION",                "可以使用信仰购买支援单位。陆地战斗单位可利用自身的 [ICON_Movement] 移动力护送平民和支援单位并+1 [ICON_Movement] 移动力。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_AKKAD_BONUS",                      "可以使用信仰购买支援单位。陆地战斗单位可利用自身的 [ICON_Movement] 移动力护送平民和支援单位并+1 [ICON_Movement] 移动力。"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_TARUGA_DESCRIPTION",               "对于所有城市，其3个单元格内每拥有一种已改良的战略资源，便+10% [ICON_SCIENCE] 科技值。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_TARUGA_BONUS",                     "对于所有城市，其3个单元格内每拥有一种已改良的战略资源，便+10% [ICON_SCIENCE] 科技值。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_VALLETTA_DESCRIPTION",             "[ICON_Faith] 信仰值可用来购买市中心建筑和军营区的建筑，购买市中心建筑和军营区的建筑打八折。购买远古、中世纪、文艺复兴城墙（包括堡垒）的费用降低50%，但只能通过 [ICON_Faith] 信仰值购买。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_VALLETTA_BONUS",                   "[ICON_Faith] 信仰值可用来购买市中心建筑和军营区的建筑，购买市中心建筑和军营区的建筑打八折。购买远古、中世纪、文艺复兴城墙（包括堡垒）的费用降低50%，但只能通过 [ICON_Faith] 信仰值购买。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_SINGAPORE_DESCRIPTION",            "您的国际 [ICON_TradeRoute] 贸易路线+3 [ICON_Production] 生产力。您通往盟友城市或宗主城邦的[ICON_TradeRoute] 贸易路线+6 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_SINGAPORE_BONUS",                  "您的国际 [ICON_TradeRoute] 贸易路线+3 [ICON_Production] 生产力。您通往盟友城市或宗主城邦的[ICON_TradeRoute] 贸易路线+6 [ICON_Gold] 金币。"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_BABYLON_DESCRIPTION",              "所有的 [ICON_GreatWork_WRITING] 著作巨作、[ICON_GreatWork_RELIC] 遗物和 [ICON_GreatWork_Artifact] 文物+3 [ICON_SCIENCE] 科技值。学院提供+4 [ICON_GreatWork_WRITING] 大作家点数"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_BABYLON_BONUS",                    "所有的 [ICON_GreatWork_WRITING] 著作巨作、[ICON_GreatWork_RELIC] 遗物和 [ICON_GreatWork_Artifact] 文物+3 [ICON_SCIENCE] 科技值。学院提供+4 [ICON_GreatWork_WRITING] 大作家点数"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_FEZ_DESCRIPTION",                  "为城市中的每个圣地建筑+2 [ICON_SCIENCE] 科技值。学院+2 [ICON_SCIENCE] 科技值"),
    ...
    ("zh_Hans_CN",  "LOC_CIVILIZATION_ANTIOCH_BONUS",                    "拥有总督的城市购买建筑花费-15%"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_MUSCAT_DESCRIPTION",               "商业中心为城市提供+1 [ICON_Amenities] 宜居度。商业相邻翻倍"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_MUSCAT_BONUS",                     "商业中心为城市提供+1 [ICON_Amenities] 宜居度。商业相邻翻倍"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_SAMARKAND_DESCRIPTION",            "您的建造者现在能够建造圆顶市集改良设施。[NEWLINE][NEWLINE]+2 [ICON_GOLD] 金币。拥有市政中世纪集市后+4 [ICON_GOLD] 金币。给相邻奢侈+2 [ICON_GOLD] 金币。每与一个奢侈品资源相邻则+2 [ICON_Gold] 金币。起源城市每有一座圆顶市集，对外国际贸易 [ICON_TradeRoute] 路线提供的 [ICON_GOLD] 金币便+2。无法建在另一座圆顶市集旁。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_SAMARKAND_BONUS",                  "您的建造者现在能够建造圆顶市集改良设施。[NEWLINE][NEWLINE]+2 [ICON_GOLD] 金币。拥有市政中世纪集市后+4 [ICON_GOLD] 金币。给相邻奢侈+2 [ICON_GOLD] 金币。每与一个奢侈品资源相邻则+2 [ICON_Gold] 金币。起源城市每有一座圆顶市集，对外国际贸易 [ICON_TradeRoute] 路线提供的 [ICON_GOLD] 金币便+2。无法建在另一座圆顶市集旁。"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_LISBON_DESCRIPTION",               "您的商人单位对水域单元格的掠夺免疫。 [ICON_TradeRoute] 贸易路线将获得以下加成：通往其他文明的贸易路线获得+6 [ICON_Gold] 金币加成；本国城市间的贸易路线获得+1 [ICON_Food] 食物和+1 [ICON_Production] 生产力加成。跨大陆翻倍。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_LISBON_BONUS",                     "您的商人单位对水域单元格的掠夺免疫。 [ICON_TradeRoute] 贸易路线将获得以下加成：通往其他文明的贸易路线获得+6 [ICON_Gold] 金币加成；本国城市间的贸易路线获得+1 [ICON_Food] 食物和+1 [ICON_Production] 生产力加成。跨大陆翻倍。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_MOHENJO_DARO_DESCRIPTION",         "无论您的城市是否相邻淡水，水源提供的基础 [ICON_Housing] 住房均与相邻淡水时相同。剧院和娱乐中心为城市每个人口+0.3 [ICON_CULTURE] 文化值。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_MOHENJO_DARO_BONUS",               "无论您的城市是否相邻淡水，水源提供的基础 [ICON_Housing] 住房均与相邻淡水时相同。剧院和娱乐中心为城市每个人口+0.3 [ICON_CULTURE] 文化值。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_GRANADA_EXPANSION2_DESCRIPTION",   "建造者现在能够建造阿卡萨城堡改良设施。[NEWLINE][NEWLINE]阿卡萨城堡提供+3 [ICON_Culture] 文化值。提供等于单元格魅力100%的 [ICON_SCIENCE] 科技值。占领单位 [ICON_Strength] 防御力+4，并自动获得2回合防御工事。研究“飞行”科技后可提供 [ICON_TOURISM] 旅游业绩。无法建在另一座阿卡萨城堡旁。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_GRANADA_BONUS_XP2",                "建造者现在能够建造阿卡萨城堡改良设施。[NEWLINE][NEWLINE]阿卡萨城堡提供+3 [ICON_Culture] 文化值。提供等于单元格魅力100%的 [ICON_SCIENCE] 科技值。占领单位 [ICON_Strength] 防御力+4，并自动获得2回合防御工事。研究“飞行”科技后可提供 [ICON_TOURISM] 旅游业绩。无法建在另一座阿卡萨城堡旁。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_CARDIFF_DESCRIPTION",              "每个港口内建筑向城市提供3点 [ICON_Power] 电力。通电建筑额外产出+4"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_CARDIFF_BONUS",                    "每个港口内建筑向城市提供3点 [ICON_Power] 电力。通电建筑额外产出+4"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_HONG_KONG_DESCRIPTION",            "城市建造项目时+20% [ICON_Production] 生产力。每个学院和学院中的建筑提供+2 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_HONG_KONG_BONUS",                  "城市建造项目时+20% [ICON_Production] 生产力。每个学院和学院中的建筑提供+2 [ICON_Production] 生产力。"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_AYUTTHAYA_DESCRIPTION",            "位于河流旁的剧院、圣地、商业中心、娱乐中心和奇观提供2 [ICON_CULTURE] 文化值。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_AYUTTHAYA_BONUS",                  "位于河流旁的剧院、圣地、商业中心、娱乐中心和奇观提供2 [ICON_CULTURE] 文化值。"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_CAGUANA_DESCRIPTION",              "您的建造者现在可以建造改良设施巴特依。[NEWLINE][NEWLINE]+2 [ICON_Culture] 文化值。每与1座资源和娱乐中心相邻，则+1 [ICON_Culture] 文化值（拥有“人文主义”市政后+2 [Icon_Culture] 文化值）。研究完“飞行”后将产出 [Icon_Tourism] 旅游业绩。无法建造在另一座巴特依旁。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_CAGUANA_BONUS",                    "您的建造者现在可以建造改良设施巴特依。[NEWLINE][NEWLINE]+2 [ICON_Culture] 文化值。每与1座资源和娱乐中心相邻，则+1 [ICON_Culture] 文化值（拥有“人文主义”市政后+2 [Icon_Culture] 文化值）。研究完“飞行”后将产出 [Icon_Tourism] 旅游业绩。无法建造在另一座巴特依旁。"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_CAHOKIA_DESCRIPTION",              "建造者可以建造卡霍基亚土墩改良设施。[NEWLINE][NEWLINE]+3 [ICON_GOLD] 金币。为本城提供+1点 [ICON_AMENITIES] 宜居度，最多可叠加2层。每个相邻区域+1 [ICON_FOOD] 食物；研发“封建主义”后，变更为每个相邻区域+2 [ICON_FOOD] 食物。提供+1 [ICON_HOUSING] 住房；研发“文化遗产”后，可额外获得+1 [ICON_HOUSING] 住房。无法建造在另一个卡霍基亚土墩旁。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_CAHOKIA_BONUS",                    "建造者可以建造卡霍基亚土墩改良设施。[NEWLINE][NEWLINE]+3 [ICON_GOLD] 金币。为本城提供+1点 [ICON_AMENITIES] 宜居度，最多可叠加2层。每个相邻区域+1 [ICON_FOOD] 食物；研发“封建主义”后，变更为每个相邻区域+2 [ICON_FOOD] 食物。提供+1 [ICON_HOUSING] 住房；研发“文化遗产”后，可额外获得+1 [ICON_HOUSING] 住房。无法建造在另一个卡霍基亚土墩旁。");
