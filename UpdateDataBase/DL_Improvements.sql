...
insert or replace into Improvement_ValidFeatures (ImprovementType, FeatureType, PrereqTech, PrereqCivic) values
	...
	('IMPROVEMENT_GREAT_WALL', 'FEATURE_FLOODPLAINS', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_GREAT_WALL', 'FEATURE_FLOODPLAINS_GRASSLAND', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_GREAT_WALL', 'FEATURE_FLOODPLAINS_PLAINS', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_MISSION', 'FEATURE_FLOODPLAINS', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_MISSION', 'FEATURE_FLOODPLAINS_GRASSLAND', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_MISSION', 'FEATURE_FLOODPLAINS_PLAINS', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_FORT', 'FEATURE_FLOODPLAINS', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_FORT', 'FEATURE_FLOODPLAINS_GRASSLAND', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_FORT', 'FEATURE_FLOODPLAINS_PLAINS', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_ROMAN_FORT', 'FEATURE_FLOODPLAINS', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_ROMAN_FORT', 'FEATURE_FLOODPLAINS_GRASSLAND', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_ROMAN_FORT', 'FEATURE_FLOODPLAINS_PLAINS', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_GOLF_COURSE', 'FEATURE_FLOODPLAINS', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_GOLF_COURSE', 'FEATURE_FLOODPLAINS_GRASSLAND', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_GOLF_COURSE', 'FEATURE_FLOODPLAINS_PLAINS', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_MEKEWAP', 'FEATURE_FLOODPLAINS', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_MEKEWAP', 'FEATURE_FLOODPLAINS_GRASSLAND', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_MEKEWAP', 'FEATURE_FLOODPLAINS_PLAINS', 'TECH_BUTTRESS', NULL),
	...
	('IMPROVEMENT_OPEN_AIR_MUSEUM', 'FEATURE_FLOODPLAINS', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_OPEN_AIR_MUSEUM', 'FEATURE_FLOODPLAINS_GRASSLAND', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_OPEN_AIR_MUSEUM', 'FEATURE_FLOODPLAINS_PLAINS', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_ICE_HOCKEY_RINK', 'FEATURE_FLOODPLAINS', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_ICE_HOCKEY_RINK', 'FEATURE_FLOODPLAINS_GRASSLAND', 'TECH_BUTTRESS', NULL),
	('IMPROVEMENT_ICE_HOCKEY_RINK', 'FEATURE_FLOODPLAINS_PLAINS', 'TECH_BUTTRESS', NULL);
...
update Improvements set Description = "{" || Description || "}{LOC_IMPROVEMENT_BUTTRESS_ON_FLOODLANDS}"
