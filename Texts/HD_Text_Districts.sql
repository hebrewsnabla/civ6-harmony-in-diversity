...
values
	...
	("zh_Hans_CN",	"LOC_DISTRICT_COTHON_HD_DESCRIPTION",							"腓尼基特色城市海军活动区域，取代港口且建造成本更低。必须修建在和陆地相邻的海岸或湖泊单元格上。如此城与海岸或湖边相邻，则+2 [ICON_HOUSING] 住房。该城市的渔船+1 [ICON_FOOD] 食物，余粮+15%，建造海军单位和开拓者加速50%。海军单位在此城驻扎一回合可完全恢复。"),
