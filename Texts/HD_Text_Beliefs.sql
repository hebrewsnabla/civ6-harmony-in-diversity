...
values
    ...
    ("LOC_BELIEF_MESSIAH_DL_DESCRIPTION",                     "Holy Site and all Holy Site buildings provide +4 [ICON_Faith] Faith. City Center buildings are 20% cheaper to purchase. May purchase City Center buildings with [ICON_Faith] Faith."),
    ("LOC_BELIEF_ABBOT_DL_DESCRIPTION",                       "All Holy Site buildings provide +1 [ICON_Production] Production to all adjacent tiles. Holy Site district provides +2 [ICON_Production] Production. May purchase Holy Site district buildings with [ICON_FAITH] Faith."), -- 
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_ABBOT_DL_DESCRIPTION",                       "所有圣地建筑为相邻的单元格提供+1 [ICON_Production] 生产力。圣地+2 [ICON_Production] 生产力。圣地区域内建筑可以用 [ICON_FAITH] 信仰值购买。"),
    ("zh_Hans_CN",  "LOC_BELIEF_MESSIAH_DL_DESCRIPTION",                     "圣地和所有圣地建筑提供+4 [ICON_Faith] 信仰值。购买市中心内建筑的费用降低20%且可以用 [ICON_Faith] 信仰值购买。"),
