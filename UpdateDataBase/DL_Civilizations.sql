...
insert or replace into Modifiers
	(ModifierId,				ModifierType,									SubjectRequirementSetId)
values
	('THEATER_CULTURE_TIER1',	'MODIFIER_ALL_PLAYERS_ATTACH_MODIFIER',			'ST_BASILS_THERTER_MODIFIER_REQUIREMENT_CULTURE'),
	('THEATER_CULTURE_TIER2',	'MODIFIER_ALL_PLAYERS_ATTACH_MODIFIER',			'ST_BASILS_THERTER_MODIFIER_REQUIREMENT_CULTURE_EX'),
	('THEATER_GOLD_TIER1',		'MODIFIER_ALL_PLAYERS_ATTACH_MODIFIER',			'ST_BASILS_THERTER_MODIFIER_REQUIREMENT_GOLD'),
	('THEATER_GOLD_TIER2',		'MODIFIER_ALL_PLAYERS_ATTACH_MODIFIER',			'ST_BASILS_THERTER_MODIFIER_REQUIREMENT_GOLD_EX');
