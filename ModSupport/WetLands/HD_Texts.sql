...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_LADY_OF_THE_REEDS_AND_MARSHES_DL_DESCRIPTION",   "草本沼泽、绿洲、沙漠泛滥平原提供+2 [ICON_Production] 生产力。草本沼泽提供+1 [ICON_Science] 科技值。"),
    ("zh_Hans_CN",	"LOC_IMPROVEMENT_GREAT_WALL_EXPANSION2_DESCRIPTION", 		"解锁建造者建造中国特色改良设施长城的能力。[NEWLINE][NEWLINE]+1 [ICON_Food] 食物，+2 [ICON_GOLD] 金币。提升 [ICON_Strength] 防御力。敌方军事单位每相邻一段长城-2 [ICON_Strength] 战斗力。每相邻1个长城+2 [ICON_Culture] 文化值。解锁“城堡”科技后，每相邻1个长城+2 [ICON_GOLD] 金币。建造在与建造者相邻的单元格上。必须沿着帝国的边界线建造。可以修建在山脉、树林和木本沼泽上。仅能被自然灾害掠夺（不会遭到破坏）。"),
	("zh_Hans_CN",	"LOC_IMPROVEMENT_MOAI_DESCRIPTION",							"解锁建造者建造摩艾石像的能力。[NEWLINE][NEWLINE]+2 [ICON_Culture] 文化值。在火山土上或与其相邻时+2 [ICON_Culture] 文化值。相邻湖泊或近海时+1 [ICON_Culture] 文化值。与每2个摩艾石像相邻+1 [ICON_Culture] 文化值，解锁“中世纪集市”后变为每与1个摩艾石像相邻。获得等同于 [ICON_Culture] 文化值产出的 [ICON_Tourism] 旅游业绩。只可建在平原、平原丘陵、草原、草原丘陵或火山土单元格之上。");