...
values
    ...
    ("zh_Hans_CN",  "LOC_POLICY_ILKUM_DESCRIPTION",                                                  "+50% 建造者 的生产速度。"),
    ("zh_Hans_CN",  "LOC_POLICY_SERFDOM_DESCRIPTION",                                                "+50% 建造者 的生产速度，新训练的建造者获得一点额外劳动力。"),
    ("zh_Hans_CN",  "LOC_POLICY_PUBLIC_WORKS_DESCRIPTION",                                           "+50% 建造者 的生产速度，新训练的建造者获得两点额外劳动力。"),
