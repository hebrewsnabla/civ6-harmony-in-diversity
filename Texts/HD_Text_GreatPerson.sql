...
values
	...
	("LOC_COLAEUS_SETTLER_PRODUCTION",									  "+50% production spped towards Settlers in this city."),
	("LOC_COLAEUS_SETTLER_MOVEMENT_ATTACH",								  "+1 [ICON_MOVEMENT] Movement for Settlers trained in cities with Commercial Hub."),
	("LOC_MARCUS_LICINIUS_CRASSUS_SWORDSMAN",							  "Grants 2 Swordsman units."),
	("LOC_MARCUS_LICINIUS_CRASSUS_IRON",								  "Grants 2 [ICON_RESOURCE_IRON] Iron per turn."),
	...
	("LOC_GREAT_PERSON_INDIVIDUAL_HD_CROESUS_ACTIVE",					  "Instantly builds a Market in this district.[NEWLINE]+1 [ICON_AMENITIES] Amenity for cities with a market.[NEWLINE]Increases [ICON_GOLD] Gold yield benefit of Happiness by 40%."),
	("LOC_GREAT_PERSON_INDIVIDUAL_HD_SANG_HONGYANG_ACTIVE",				  "Instantly builds a Mint in this district.[NEWLINE]Mint provides an extra +4 [ICON_GOLD] Gold and +1 [ICON_CULTURE] Culture with its regional effect."),
...
values
	...
	("zh_Hans_CN",  "LOC_GREAT_PERSON_INDIVIDUAL_HD_CROESUS_ACTIVE",					  "立即在该区域建造1座市场。[NEWLINE]有市场的城市+1 [ICON_AMENITIES] 宜居度。[NEWLINE]宜居度带来的 [ICON_GOLD] 金币产出加成增加40%。"),
	("zh_Hans_CN",  "LOC_GREAT_PERSON_INDIVIDUAL_HD_SANG_HONGYANG_ACTIVE",				  "立即在该区域建造1座铸币厂。[NEWLINE]铸币厂额外辐射4 [ICON_GOLD] 金币、1 [ICON_CULTURE] 文化值。"),
