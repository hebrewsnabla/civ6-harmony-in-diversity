...
values
    ...
    ("LOC_GAMEMODE_MPTEST_DESCRIPTION",                     "Mode for Testing, current testing mode contains Multi Player adjustments."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_GAMEMODE_MPTEST_DESCRIPTION",                      "用于测试的模式，当前测试模式中在进行联机相关的测试。联机体验的玩家可选择开启。"),
    ...
    ("zh_Hans_CN",  "LOC_GAMEMODE_TREE_RANDOMIZER_DESCRIPTION",             "[COLOR_Civ6LightBlue]“和而不同”：我们已适配了科技和市政的需求，但该模式打乱了科技树和市政树，请谨慎开启。[ENDCOLOR][NEWLINE][NEWLINE]此模式会随机选择历史时代中的科技与市政，带来不同寻常的花费与先决条件。所有玩家的科技与市政树皆相同。此外，在达到先决条件前，科技与市政为隐藏状态，一路保留探索秘密的神秘感，直至游戏结束。"),
