...
values
    ...
    ("LOC_BELIEF_MONUMENT_TO_THE_GODS_DL_DESCRIPTION",            "+15% [ICON_Production] Production towards Ancient and Classical era wonders. When chosen, receive a free Monument in your capital. Monument provides +1 [ICON_CULTURE] Culture and +10% [ICON_Culture] Culture to the city. May purchase Monument with [ICON_Faith] Faith."),
    ("LOC_BELIEF_FERTILITY_RITES_DL_DESCRIPTION",                 "When chosen, receive a free Granary in your capital. Granary provides +1 [ICON_FOOD] Food and +10% [ICON_FOOD] Food to the city. May purchase Granary with [ICON_Faith] Faith."),
    ...
    ("LOC_BELIEF_DIVINE_SPARK_DL_DESCRIPTION",                    "+2 [ICON_GreatPerson] Great Person Points from districts. Your [ICON_CAPITAL] capital can build 1 more district than the [ICON_CITIZEN] Population limit allows."),
    ...
    ("LOC_BELIEF_THE_PEOPLE_OF_POLAR_DL_DESCRIPTION",             "+2 [ICON_FOOD] Food for cities on Tundra. +1 [ICON_PRODUCTION] Production, +2 [ICON_GOLD] Gold to Improvements over resource on Tundra."),
    ...
    ("LOC_BELIEF_RELIGIOUS_SETTLEMENTS_DL_DESCRIPTION",           "+1 [ICON_MOVEMENT] Movement to Settlers. Gain 4 extra tiles and 30 [ICON_GREATPROPHET] Great Prophet points upon founding cities."),
    ...
    ("LOC_BELIEF_OCEAN_MOTHER_DL_DESCRIPTION",                    "City center receive +1 [ICON_Food] Food and +1 [ICON_Faith] Faith from each adjacent Coast tile. +2 [ICON_GreatProphet] Great Prophet point per turn for cities adjacent to Coasts."),
    ...
    ("LOC_BELIEF_HD_MAZU_BELIEF_DL_DESCRIPTION",                  "Cities adjacent to Coasts get +2 [ICON_Production] Production and +2 [ICON_HOUSING] Housing. Fishing Boats provide +2 [ICON_Gold] Gold for each adjacent Specialty Districts."), 
    ...
    ("LOC_BELIEF_HD_GOD_KING_DL_DESCRIPTION",                     "+1 of all yields, +1 [ICON_Amenities] Amenity and +1 [ICON_HOUSING] Housing in your [ICON_CAPITAL] Capital. When chosen, recieve a [ICON_CITIZEN] Citizen in your [ICON_CAPITAL] capital and a free [ICON_ENVOY] envoy. +1 [ICON_GREATPROPHET] Great Prophet point. Speeds up your Exoplanet Expedition by +1 Light Year per turn after reasearching 'Offworld Mission' Technology."),
    ...
    ("LOC_BELIEF_HD_UTAKI_DL_DESCRIPTION",                        "City Centers get +1 [ICON_Culture] Culture for every 2 adjacent Lake or Coast tiles and +1 [ICON_Production] Production for every 1 adjacent Lake or Coast tile."),
    ...
    ("LOC_BELIEF_ILLUMINATORS_DESCRIPTION",                	      "When chosen, receive a Recon unit with free promotion in your [ICON_Capital] Capital. +1 [ICON_Movement] Movement for all Recon Units. +5 [ICON_STRENGTH] Combat Strength for all units when fighting Barbarians. Gain 50 [ICON_FAITH] Faith when you clear a Barbarian Outpost. The unit that cleared the Barbarian Outpost heals +100 HP. Allows the construction of Barbarian Horseman, Barbarian Horse Archer and Primitive Quadrireme."),
    ("LOC_ABILITY_STARLIGHT_NAVIGATER_DESCRIPTION",              "+1 [ICON_MOVEMENT] Movement. Escorted units move at the same speed."),
    ("LOC_BELIEF_STARLIGHT_NAVIGATER_NAME",             		  "Starlight Navigater"),
    ("LOC_BELIEF_STARLIGHT_NAVIGATER_DESCRIPTION",               "When chosen, receive an Oarlocked Rowboats in your [ICON_Capital] Capital. +50% construction speed towards Naval Raider units. +1 [ICON_Movement] Movement for all Naval Raider Units. Escorted units with Naval Raider units move at the same speed.");
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_MONUMENT_TO_THE_GODS_DL_DESCRIPTION",            "远古和古典奇观+15% [ICON_Production] 生产力。选择后即可在首都中获得一个免费的纪念碑。纪念碑+1 [ICON_CULTURE] 文化值，给所在城市提供+10% [ICON_Culture] 文化值。可以使用 [ICON_Faith] 信仰值购买纪念碑。"),
    ("zh_Hans_CN",  "LOC_BELIEF_FERTILITY_RITES_DL_DESCRIPTION",                 "选择后即可在首都中获得一个免费的粮仓。粮仓+1 [ICON_FOOD] 食物，给所在城市提供+10% [ICON_FOOD] 食物。可以使用 [ICON_Faith] 信仰值购买粮仓。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_DIVINE_SPARK_DL_DESCRIPTION",                    "每个区域提供的 [ICON_GreatPerson] 伟人点数+2。首都可以无视 [ICON_CITIZEN] 人口限制额外建造1个区域。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_THE_PEOPLE_OF_POLAR_DL_DESCRIPTION",             "冻土上的城市+2 [ICON_FOOD] 食物，冻土上改良资源的改良设施+1 [ICON_PRODUCTION] 生产力、+2 [ICON_GOLD] 金币。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_RELIGIOUS_SETTLEMENTS_DL_DESCRIPTION",           "开拓者+1 [ICON_MOVEMENT] 移动力。创建城市时获得额外4个单元格和30 [ICON_GREATPROPHET] 大预言家点数。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_OCEAN_MOTHER_DL_DESCRIPTION",                    "市中心相邻每个海岸单元格+1 [ICON_Food] 食物和+1 [ICON_Faith] 信仰值。相邻海岸的城市每回合+2 [ICON_GreatProphet] 大预言家点数。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_HD_MAZU_BELIEF_DL_DESCRIPTION",                  "位于海边的城市+2 [ICON_Production] 生产力、+2 [ICON_HOUSING] 住房。渔船相邻每个专业化区域获得+2 [ICON_Gold] 金币。"), 
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_HD_GOD_KING_DL_DESCRIPTION",                     "首都+1所有产出、+1 [ICON_Amenities] 宜居度、+1 [ICON_HOUSING] 住房。选择后获得1 [ICON_ENVOY] 使者，首都获得1 [ICON_CITIZEN] 人口。+1 [ICON_GREATPROPHET] 大预言家点数。解锁“外星任务”科技后以每回合1光年的速度加速系外行星探索。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_HD_UTAKI_DL_DESCRIPTION",                        "市中心每相邻2个近海或湖泊单元格+1 [ICON_Culture] 文化值，每相邻1个近海或湖泊单元格+1 [ICON_Production] 生产力。"),
