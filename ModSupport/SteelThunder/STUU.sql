...
-- -- 印度
update Units set Cost = 210, Maintenance = 5, BaseMoves = 2, Range = 0, Combat = 65, RangedCombat = 0, StrategicResource = 'RESOURCE_NITER' where UnitType = 'UNIT_INDIAN_SEPOY';
...
update Units set Cost = 80, Maintenance = 3, BaseMoves = 2, Range = 0, Combat = 40, RangedCombat = 0, StrategicResource = NULL where UnitType = 'UNIT_JAPANESE_SOHEI';
