...
values
    ...
    ("LOC_BELIEF_GODDESS_OF_THE_HUNT_DL_DESCRIPTION",             "+1 [ICON_Food] Food and +1 [ICON_Production] Production from Camps over Luxury and Bonus resources. +3 [ICON_Gold] Gold from all Camps."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_GODDESS_OF_THE_HUNT_DL_DESCRIPTION",             "采集奢侈品资源和加成资源的营地+1 [ICON_Food] 食物和 +1 [ICON_Production] 生产力，所有营地+3 [ICON_Gold] 金币。"),
