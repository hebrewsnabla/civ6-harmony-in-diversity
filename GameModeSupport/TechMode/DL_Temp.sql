...
update Civics set Cost = 1150 where CivicType = 'CIVIC_EVOLUTION_THEORY_HD'; 
update Civics set Cost = 1150 where CivicType = 'CIVIC_HISTORICAL_PHILOSOPHY_HD'; 
update Civics set Cost = 1150 where CivicType = 'CIVIC_ETHICS_HD'; 
update Civics set Cost = 1600 where CivicType = 'CIVIC_SOCIAL_SCIENCE_HD'; 
-- Civic Tree v4
...
update Civics set Cost = 1600 where CivicType = 'CIVIC_COLONIALISM';   
...
update Civics set Cost = 1600 where CivicType = 'CIVIC_OPERA_BALLET';   
update Civics set Cost = 1900 where CivicType = 'CIVIC_NATURAL_HISTORY';   
...
update Civics set Cost = 2500 where CivicType = 'CIVIC_CAPITALISM';   
update Civics set Cost = 2700 where CivicType = 'CIVIC_NUCLEAR_PROGRAM';   
