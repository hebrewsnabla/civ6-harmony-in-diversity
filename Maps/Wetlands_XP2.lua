...
function GenerateMap()
	print("Generating Continents and Islands Map");
	local pPlot;
...
function AddFeatures()
	...
	local args = {rainfall = rainfall, iMarshPercent = 12, iSwampPercent = 12, iJunglePercent = 30, iForestPercent = 30, iOasisPercent = 2}
