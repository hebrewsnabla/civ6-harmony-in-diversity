...
values
    ...
    ("zh_Hans_CN",  "LOC_POLICY_PUBLIC_TRANSPORT_DESCRIPTION_XP2",                                   "拥有至少20 [ICON_Citizen] 公民的市中心为相邻的圣地、学院、剧院广场、商业中心、港口或工业区+50%相邻加成；为距离2个单元格的这些区域提供+1 [ICON_Housing] 住房；为距离3个单元格的这些区域提供等于相邻加成的 [ICON_GOLD] 金币。"),
