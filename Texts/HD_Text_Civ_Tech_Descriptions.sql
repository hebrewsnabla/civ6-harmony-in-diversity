...
values
    ...
    ("LOC_BOOST_TRIGGER_EVOLUTION_THEORY_HD",                                               "Build 1 Camp on an oversea continent."),
    ("LOC_BOOST_TRIGGER_LONGDESC_EVOLUTION_THEORY_HD",                                      "The collection of biological resources in camps around the world has inspired not only Biology but also social thinking."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BOOST_TRIGGER_EVOLUTION_THEORY_HD",                                "在异大陆建造1座营地。"),
    ("zh_Hans_CN",  "LOC_BOOST_TRIGGER_LONGDESC_EVOLUTION_THEORY_HD",                       "在世界各地的营地搜集了多种生物资源，这不仅激励了生物学，也引发了社会思考。"),
