...
delete from Policies where PolicyType = 'POLICY_CIVIL_PRESTIGE';--xhh
...
-- update Policies set PrereqCivic = 'CIVIC_FEUDALISM' where PolicyType = 'POLICY_CIVIL_PRESTIGE';--xhh
...
delete from PolicyModifiers where PolicyType = 'POLICY_COLONIAL_OFFICES' and ModifierId = 'COLONIALOFFICES_FOREIGNGROWTH';--xhh
...
values
	...
	('COLONIALOFFICES_FOREIGNFOOD',							'Amount',				5),--xhh
	('COLONIALOFFICES_FOREIGNFOODPERCENTAGE',				'YieldType',			'YIELD_FOOD'),
	('COLONIALOFFICES_FOREIGNFOODPERCENTAGE',				'Amount',				10),--xhh
	('HD_MILITARY_RESEARCH_UNIT_TRAIN_GRANT_SCIENCE_XHH',	'YieldType',			'YIELD_SCIENCE'),
	('HD_MILITARY_RESEARCH_UNIT_TRAIN_GRANT_SCIENCE_XHH',	'UnitProductionPercent',75);--xhh
...
values
	...
	('POLICY_PLUTONOMY',				'KIND_POLICY'),--xhh
	('POLICY_PHILOSOPHY_EDUCATION',		'KIND_POLICY'),--xhh
	('POLICY_PURITAN',					'KIND_POLICY'),--xhh
	('POLICY_SCIENTIFIC_EXPEDITIONS',	'KIND_POLICY'),--xhh
	('POLICY_SISHU',					'KIND_POLICY'),--xhh
	('POLICY_COMPILE',					'KIND_POLICY'),--xhh
	('POLICY_SUPPLY_LINES',				'KIND_POLICY');--xhh
...
values
	...
	--
	('POLICY_DOMESTIC_TRADE',			'LOC_POLICY_DOMESTIC_TRADE_NAME',			'LOC_POLICY_DOMESTIC_TRADE_DESCRIPTION',			'CIVIC_MEDIEVAL_FAIRES',					NULL,						'SLOT_ECONOMIC'),
	('POLICY_HIGHWAY',					'LOC_POLICY_HIGHWAY_NAME',					'LOC_POLICY_HIGHWAY_DESCRIPTION',					'CIVIC_MERCANTILISM',						NULL,						'SLOT_ECONOMIC'),
	('POLICY_SILK_ROAD',				'LOC_POLICY_SILK_ROAD_NAME',				'LOC_POLICY_SILK_ROAD_DESCRIPTION',					'CIVIC_EXPLORATION',						NULL,						'SLOT_ECONOMIC'),
	...
	('POLICY_SOCIAL_STATISTICS',		'LOC_POLICY_SOCIAL_STATISTICS_NAME',		'LOC_POLICY_SOCIAL_STATISTICS_DESCRIPTION',			'CIVIC_SOCIAL_SCIENCE_HD',					NULL,						'SLOT_ECONOMIC'),--xhh
	('POLICY_PLUTONOMY',				'LOC_POLICY_PLUTONOMY_NAME',				'LOC_POLICY_PLUTONOMY_DESCRIPTION',					'CIVIC_SOCIAL_SCIENCE_HD',					NULL,						'SLOT_ECONOMIC'),--xhh
	('POLICY_PHILOSOPHY_EDUCATION',		'LOC_POLICY_PHILOSOPHY_EDUCATION_NAME',		'LOC_POLICY_PHILOSOPHY_EDUCATION_DESCRIPTION',		'CIVIC_HISTORICAL_PHILOSOPHY_HD',			NULL,						'SLOT_WILDCARD'),--xhh
	('POLICY_PURITAN',					'LOC_POLICY_PURITAN_NAME',					'LOC_POLICY_PURITAN_DESCRIPTION',					'CIVIC_ETHICS_HD',							NULL,						'SLOT_ECONOMIC'),--xhh
	('POLICY_SCIENTIFIC_EXPEDITIONS',	'LOC_POLICY_SCIENTIFIC_EXPEDITIONS_NAME',	'LOC_POLICY_SCIENTIFIC_EXPEDITIONS_DESCRIPTION',	'CIVIC_EVOLUTION_THEORY_HD',				NULL,						'SLOT_ECONOMIC'),--xhh
	('POLICY_SISHU',					'LOC_POLICY_SISHU_NAME',					'LOC_POLICY_SISHU_DESCRIPTION',						'CIVIC_IMPERIAL_EXAMINATION_SYSTEM_HD',		NULL,						'SLOT_ECONOMIC'),--xhh
	('POLICY_COMPILE',					'LOC_POLICY_COMPILE_NAME',					'LOC_POLICY_COMPILE_DESCRIPTION',					NULL,										'TECH_PAPER_MAKING_HD',		'SLOT_WILDCARD'),--xhh
	('POLICY_SUPPLY_LINES',				'LOC_POLICY_SUPPLY_LINES_NAME',				'LOC_POLICY_SUPPLY_LINES_DESCRIPTION',				NULL,										'TECH_MILITARY_TACTICS',	'SLOT_MILITARY');--xhh
...
--	('POLICY_ENTREPRENEURSHIP',		'POLICY_ECONOMIC_UNION');
	...
	('POLICY_RETAINERS',			'POLICY_FREELANCERS'),--xhh
	('POLICY_SISHU',				'POLICY_SOCIAL_STATISTICS'),--xhh
	('POLICY_COMPILE',				'POLICY_NOBEL_PRIZE'),--xhh
	('POLICY_INSPIRATION',			'POLICY_COMPILE'),--xhh
	('POLICY_LOGISTICS',			'POLICY_SUPPLY_LINES');--xhh
...
values
	...
	('POLICY_FREELANCERS',				'RETAINERS_AMENITYBONUS'),--xhh
...
--	('POLICY_ENTREPRENEURSHIP',			'ENTREPRENEURSHIP_DISTRICTGOLD'),
	...
	('POLICY_SOCIAL_STATISTICS',		'SOCIAL_STATISTICS_POPULATION_SCIENCE'),--xhh
	('POLICY_SOCIAL_STATISTICS',		'SOCIAL_STATISTICS_POPULATION_CULTURE'),--xhh
	('POLICY_PLUTONOMY',				'PLUTONOMY_THEATER_GOLD_PERCENTAGE_BOOST'),--xhh
	('POLICY_PLUTONOMY',				'PLUTONOMY_CAMPUS_PRODUCTION_PERCENTAGE_BOOST'),--xhh
	('POLICY_PHILOSOPHY_EDUCATION',		'PHILOSOPHY_EDUCATION_WONDER_GREAT_PERSON_POINTS'),--xhh
	('POLICY_PURITAN',					'PURITAN_WORKSHIP_GOLD_PERCENTAGE_BOOST'),--xhh
	('POLICY_PURITAN',					'PURITAN_WORKSHIP_PRODUCTION_PERCENTAGE_BOOST'),--xhh
	('POLICY_SCIENTIFIC_EXPEDITIONS',	'SCIENTIFIC_EXPEDITIONS_SCIENCE_PERCENTAGE_BOOST'),--xhh
	('POLICY_SCIENTIFIC_EXPEDITIONS',	'SCIENTIFIC_EXPEDITIONS_CULTURE_PERCENTAGE_BOOST'),--xhh
	('POLICY_SISHU',					'SISHU_POPULATION_SCIENCE'),--xhh
	('POLICY_SISHU',					'SISHU_POPULATION_CULTURE'),--xhh
	('POLICY_COMPILE',					'COMPILE_FIXED_SCIENTIST_POINTS'),--xhh
	('POLICY_COMPILE',					'COMPILE_LIBRARY_SCIENTIST_POINTS'),--xhh
	('POLICY_SUPPLY_LINES',				'SUPPLY_LINES_MOVEMENT_BONUS');--xhh
...
--	('ENTREPRENEURSHIP_DISTRICTGOLD',						'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_MODIFIER',						'DISTRICT_IS_COMMERCIAL_HUB'),
	...
	('SOCIAL_STATISTICS_POPULATION_SCIENCE',				'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_PER_POPULATION',				'CITY_HAS_3_SPECIALTY_DISTRICTS_REQUIREMENTS'),--xhh
	('SOCIAL_STATISTICS_POPULATION_CULTURE',				'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_PER_POPULATION',				'CITY_HAS_3_SPECIALTY_DISTRICTS_REQUIREMENTS'),--xhh
	('PLUTONOMY_THEATER_GOLD_PERCENTAGE_BOOST',				'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER',					'HD_CITY_HAS_DISTRICT_THEATER_XHH'),--xhh
	('PLUTONOMY_CAMPUS_PRODUCTION_PERCENTAGE_BOOST',		'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER',					'HD_CITY_HAS_DISTRICT_CAMPUS_XHH'),--xhh
	('PHILOSOPHY_EDUCATION_WONDER_GREAT_PERSON_POINTS',		'MODIFIER_PLAYER_CITIES_ADJUST_GREAT_PERSON_POINT_BONUS',				'HD_CITY_HAS_DISTRICT_WONDER_XHH'),--xhh
	('PURITAN_WORKSHIP_GOLD_PERCENTAGE_BOOST',				'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER',					'HD_CITY_HAS_RELIGIOUS_TIER_3_BUILDING_REQUIREMENTS'),--xhh
	('PURITAN_WORKSHIP_PRODUCTION_PERCENTAGE_BOOST',		'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER',					'HD_CITY_HAS_RELIGIOUS_TIER_3_BUILDING_REQUIREMENTS'),--xhh
	('SCIENTIFIC_EXPEDITIONS_SCIENCE_PERCENTAGE_BOOST',		'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER',					'HD_OVERSEAS_CITY_HAS_DISTRICT_COMMERCIAL_HUB_XHH'),--xhh
	('SCIENTIFIC_EXPEDITIONS_CULTURE_PERCENTAGE_BOOST',		'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER',					'HD_OVERSEAS_CITY_HAS_DISTRICT_HARBOR_XHH'),--xhh
	('SISHU_POPULATION_SCIENCE',							'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_PER_POPULATION',				'CITY_HAS_2_SPECIALTY_DISTRICTS_REQUIREMENTS'),--xhh
	('SISHU_POPULATION_CULTURE',							'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_PER_POPULATION',				'CITY_HAS_2_SPECIALTY_DISTRICTS_REQUIREMENTS'),--xhh
	('COMPILE_FIXED_SCIENTIST_POINTS',						'MODIFIER_PLAYER_ADJUST_GREAT_PERSON_POINTS',							NULL),--xhh
	('COMPILE_LIBRARY_SCIENTIST_POINTS',					'MODIFIER_PLAYER_CITIES_ADJUST_GREAT_PERSON_POINT',						'HD_COMPILE_CITY_HAS_LIBRARY_XHH'),--xhh
	('SUPPLY_LINES_MOVEMENT_BONUS',							'MODIFIER_PLAYER_UNITS_ADJUST_FRIENDLY_TERRITORY_START_MOVEMENT',		NULL);--xhh
...
--	('ENTREPRENEURSHIP_DISTRICTGOLD',										'Amount',						100),
	...
	('SOCIAL_STATISTICS_POPULATION_SCIENCE',								'YieldType',									'YIELD_SCIENCE'),--xhh
	('SOCIAL_STATISTICS_POPULATION_SCIENCE',								'Amount',						0.8),--xhh
	('SOCIAL_STATISTICS_POPULATION_CULTURE',								'YieldType',					'YIELD_CULTURE'),--xhh
	('SOCIAL_STATISTICS_POPULATION_CULTURE',								'Amount',						0.8),--xhh
	('PLUTONOMY_THEATER_GOLD_PERCENTAGE_BOOST',								'YieldType',					'YIELD_GOLD'),--xhh
	('PLUTONOMY_THEATER_GOLD_PERCENTAGE_BOOST',								'Amount',						10),--xhh
	('PLUTONOMY_CAMPUS_PRODUCTION_PERCENTAGE_BOOST',						'YieldType',					'YIELD_PRODUCTION'),--xhh
	('PLUTONOMY_CAMPUS_PRODUCTION_PERCENTAGE_BOOST',						'Amount',						5),--xhh
	('PHILOSOPHY_EDUCATION_WONDER_GREAT_PERSON_POINTS',						'Amount',						25),--xhh
	('PURITAN_WORKSHIP_GOLD_PERCENTAGE_BOOST',								'YieldType',					'YIELD_GOLD'),--xhh
	('PURITAN_WORKSHIP_GOLD_PERCENTAGE_BOOST',								'Amount',						15),--xhh
	('PURITAN_WORKSHIP_PRODUCTION_PERCENTAGE_BOOST',						'YieldType',					'YIELD_PRODUCTION'),--xhh
	('PURITAN_WORKSHIP_PRODUCTION_PERCENTAGE_BOOST',						'Amount',						15),--xhh
	('SCIENTIFIC_EXPEDITIONS_SCIENCE_PERCENTAGE_BOOST',						'YieldType',					'YIELD_SCIENCE'),--xhh
	('SCIENTIFIC_EXPEDITIONS_SCIENCE_PERCENTAGE_BOOST',						'Amount',						15),--xhh
	('SCIENTIFIC_EXPEDITIONS_CULTURE_PERCENTAGE_BOOST',						'YieldType',					'YIELD_CULTURE'),--xhh
	('SCIENTIFIC_EXPEDITIONS_CULTURE_PERCENTAGE_BOOST',						'Amount',						15),--xhh
	('SISHU_POPULATION_SCIENCE',											'YieldType',					'YIELD_SCIENCE'),--xhh
	('SISHU_POPULATION_SCIENCE',											'Amount',						0.4),--xhh
	('SISHU_POPULATION_CULTURE',											'YieldType',					'YIELD_CULTURE'),--xhh
	('SISHU_POPULATION_CULTURE',											'Amount',						0.4),--xhh
	('COMPILE_FIXED_SCIENTIST_POINTS',										'GreatPersonClassType',			'GREAT_PERSON_CLASS_SCIENTIST'),--xhh
	('COMPILE_FIXED_SCIENTIST_POINTS',										'Amount',						4),--xhh
	('COMPILE_LIBRARY_SCIENTIST_POINTS',									'GreatPersonClassType',			'GREAT_PERSON_CLASS_SCIENTIST'),--xhh
	('COMPILE_LIBRARY_SCIENTIST_POINTS',									'Amount',						2),--xhh
	('SUPPLY_LINES_MOVEMENT_BONUS',											'Amount',						2);--xhh
...
values
	...
	('HD_CITY_HAS_DISTRICT_THEATER_XHH', 						'REQUIREMENTSET_TEST_ALL'),--xhh
	('HD_CITY_HAS_DISTRICT_CAMPUS_XHH', 						'REQUIREMENTSET_TEST_ALL'),--xhh
	('HD_CITY_HAS_DISTRICT_WONDER_XHH', 						'REQUIREMENTSET_TEST_ALL'),--xhh
	('HD_OVERSEAS_CITY_HAS_DISTRICT_COMMERCIAL_HUB_XHH', 		'REQUIREMENTSET_TEST_ALL'),--xhh
	('HD_OVERSEAS_CITY_HAS_DISTRICT_HARBOR_XHH', 				'REQUIREMENTSET_TEST_ALL'),--xhh
	('HD_COMPILE_CITY_HAS_LIBRARY_XHH', 						'REQUIREMENTSET_TEST_ALL');--xhh
...
values
	...
	('HD_CITY_HAS_DISTRICT_THEATER_XHH', 						'REQUIRES_CITY_HAS_DISTRICT_THEATER'),--xhh
	('HD_CITY_HAS_DISTRICT_CAMPUS_XHH', 						'REQUIRES_CITY_HAS_DISTRICT_CAMPUS'),--xhh
	('HD_CITY_HAS_DISTRICT_WONDER_XHH', 						'REQUIRES_CITY_HAS_WONDER'),--xhh
	('HD_OVERSEAS_CITY_HAS_DISTRICT_COMMERCIAL_HUB_XHH', 		'REQUIRES_CITY_HAS_DISTRICT_COMMERCIAL_HUB'),--xhh
	('HD_OVERSEAS_CITY_HAS_DISTRICT_COMMERCIAL_HUB_XHH', 		'REQUIRES_CITY_IS_NOT_OWNER_CAPITAL_CONTINENT'),--xhh
	('HD_OVERSEAS_CITY_HAS_DISTRICT_HARBOR_XHH', 				'REQUIRES_CITY_HAS_DISTRICT_HARBOR'),--xhh
	('HD_OVERSEAS_CITY_HAS_DISTRICT_HARBOR_XHH', 				'REQUIRES_CITY_IS_NOT_OWNER_CAPITAL_CONTINENT'),--xhh
	('HD_COMPILE_CITY_HAS_LIBRARY_XHH', 						'REQUIRES_CITY_HAS_BUILDING_LIBRARY');--xhh
...
update Policies set PrereqTech = 'TECH_ENGINEERING' where PolicyType = 'POLICY_BASTIONS';
