...
from Units where FormationClass = 'FORMATION_CLASS_CIVILIAN' and TrackReligion = 0 and PurchaseYield is not null and UnitType != 'UNIT_SPY' and UnitType != 'UNIT_TRADER';
