...
values
	...
	('RESOURCE_SPONGE',			'YIELD_PRODUCTION',		1),
	...
	('RESOURCE_SORGHUM',		'YIELD_GOLD',			1),
	-- 加成
	('RESOURCE_TOMATO',			'YIELD_FOOD',			1),
	('RESOURCE_TIN',			'YIELD_GOLD',			3),
...
values
	...
	('RESOURCE_SORGHUM',		'TERRAIN_GRASS'),
	('RESOURCE_SORGHUM',		'TERRAIN_PLAINS'),
	-- 加成
...
values
	...
	('RESOURCE_SEASHELLS',		'FEATURE_REEF'),
	('RESOURCE_SORGHUM',		'FEATURE_MARSH'),
	('RESOURCE_SORGHUM',		'FEATURE_FLOODPLAINS'),
	('RESOURCE_SORGHUM',		'FEATURE_FLOODPLAINS_GRASSLAND'),
	('RESOURCE_SORGHUM',		'FEATURE_FLOODPLAINS_PLAINS'),
	-- 加成
...
values
	...
	('BELIEF_PAN',			                'PAN_LUMBER_MILL_LUXURY_CULTURE'),
	('BELIEF_PAN',			                'PAN_LUMBER_MILL_LUXURY_FAITH'),
	('BELIEF_PAN',			                'PAN_LUMBER_MILL_BONUS_CULTURE'),
	('BELIEF_PAN',			                'PAN_LUMBER_MILL_BONUS_FAITH'),
...
values
	('PAN_LUMBER_MILL_LUXURY_CULTURE',				                'MODIFIER_ALL_CITIES_ATTACH_MODIFIER',				'CITY_FOLLOWS_PANTHEON_REQUIREMENTS'),			
	('PAN_LUMBER_MILL_LUXURY_CULTURE_MODIFIER',		               	'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',		'PLOT_HAS_LUXURY_LUMBER_MILL_REQUIREMENTS'),
	('PAN_LUMBER_MILL_LUXURY_FAITH',				                'MODIFIER_ALL_CITIES_ATTACH_MODIFIER',				'CITY_FOLLOWS_PANTHEON_REQUIREMENTS'),			
	('PAN_LUMBER_MILL_LUXURY_FAITH_MODIFIER',		               	'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',		'PLOT_HAS_LUXURY_LUMBER_MILL_REQUIREMENTS'),
	('PAN_LUMBER_MILL_BONUS_CULTURE',				                'MODIFIER_ALL_CITIES_ATTACH_MODIFIER',				'CITY_FOLLOWS_PANTHEON_REQUIREMENTS'),			
	('PAN_LUMBER_MILL_BONUS_CULTURE_MODIFIER',		               	'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',		'PLOT_HAS_BONUS_LUMBER_MILL_REQUIREMENTS'),
	('PAN_LUMBER_MILL_BONUS_FAITH',				                	'MODIFIER_ALL_CITIES_ATTACH_MODIFIER',				'CITY_FOLLOWS_PANTHEON_REQUIREMENTS'),			
	('PAN_LUMBER_MILL_BONUS_FAITH_MODIFIER',		               	'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',		'PLOT_HAS_BONUS_LUMBER_MILL_REQUIREMENTS'),
...
values
	('PAN_LUMBER_MILL_LUXURY_CULTURE',	                	'ModifierId',			'PAN_LUMBER_MILL_LUXURY_CULTURE_MODIFIER'),
	('PAN_LUMBER_MILL_LUXURY_CULTURE_MODIFIER',	            'YieldType',			'YIELD_CULTURE'),
	('PAN_LUMBER_MILL_LUXURY_CULTURE_MODIFIER',	            'Amount',				1),
	('PAN_LUMBER_MILL_LUXURY_FAITH',	                	'ModifierId',			'PAN_LUMBER_MILL_LUXURY_FAITH_MODIFIER'),
	('PAN_LUMBER_MILL_LUXURY_FAITH_MODIFIER',	            'YieldType',			'YIELD_FAITH'),
	('PAN_LUMBER_MILL_LUXURY_FAITH_MODIFIER',	            'Amount',				1),
	('PAN_LUMBER_MILL_BONUS_CULTURE',	                	'ModifierId',			'PAN_LUMBER_MILL_BONUS_CULTURE_MODIFIER'),
	('PAN_LUMBER_MILL_BONUS_CULTURE_MODIFIER',	            'YieldType',			'YIELD_CULTURE'),
	('PAN_LUMBER_MILL_BONUS_CULTURE_MODIFIER',	            'Amount',				1),
	('PAN_LUMBER_MILL_BONUS_FAITH',	                		'ModifierId',			'PAN_LUMBER_MILL_BONUS_FAITH_MODIFIER'),
	('PAN_LUMBER_MILL_BONUS_FAITH_MODIFIER',	            'YieldType',			'YIELD_FAITH'),
	('PAN_LUMBER_MILL_BONUS_FAITH_MODIFIER',	            'Amount',				1),
	...
	('PAN_LUMBER_MILL_GREAT_PROPHET_MODIFIER',		        'Amount',				2),
