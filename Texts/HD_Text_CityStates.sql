...
values
    ...
    ("LOC_CIVILIZATION_HUNZA_BONUS",                      "Your [ICON_TradeRoute] Trade Routes generate +1 [ICON_Gold] Gold for every 4 tiles they travel."),
    ("LOC_LEADER_TRAIT_JAKARTA_DESCRIPTION",              "Your districts(except City center) and wonders on or next to Coast or Lake tiles provide +4 [ICON_Gold] Gold."),
    ("LOC_CIVILIZATION_JAKARTA_BONUS",                    "Your districts(except City center) and wonders on or next to Coast or Lake tiles provide +4 [ICON_Gold] Gold."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_HUNZA_DESCRIPTION",                "您的 [ICON_TradeRoute] 贸易路线每经过4个单元格，其提供的 [ICON_Gold] 金币便+1。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_HUNZA_BONUS",                      "您的 [ICON_TradeRoute] 贸易路线每经过4个单元格，其提供的 [ICON_Gold] 金币便+1。"),
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_JAKARTA_DESCRIPTION",              "您境内位于或与海岸湖泊单元格相邻的区域(市中心外)和奇观+4 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_JAKARTA_BONUS",                    "您境内位于或与海岸湖泊单元格相邻的区域(市中心外)和奇观+4 [ICON_Gold] 金币。"),
