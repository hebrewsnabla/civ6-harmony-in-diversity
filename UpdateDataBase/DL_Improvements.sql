...
-- Coastal Polder (Netherlands)
    ...
    values
		...
		('IMPROVEMENT_POLDER',		'FEATURE_SUK_KELP');
	...
	values
		...
		('IMPROVEMENT_POLDER',		'P_POLDER_FOOD_TIRE3'),
		...
		('IMPROVEMENT_POLDER',		'P_LAND_POLDER_FOOD_TIRE3');
	...
	values
		...
		('P_POLDER_FOOD_TIRE2',				'Placeholder',		'YIELD_FOOD',			1,				1,					'IMPROVEMENT_POLDER',		Null,						'TECH_BIOLOGY_HD',			'CIVIC_FEUDALISM',			Null),
		('P_POLDER_FOOD_TIRE3',				'Placeholder',		'YIELD_FOOD',			2,				1,					'IMPROVEMENT_POLDER',		'TECH_BIOLOGY_HD',			Null,						null,						Null),
		...
		('P_LAND_POLDER_FOOD_TIRE2',		'Placeholder',		'YIELD_FOOD',			1,				1,					'IMPROVEMENT_LAND_POLDER',	Null,						'TECH_BIOLOGY_HD',			'CIVIC_FEUDALISM',			Null),
		('P_LAND_POLDER_FOOD_TIRE3',		'Placeholder',		'YIELD_FOOD',			2,				1,					'IMPROVEMENT_LAND_POLDER',	'TECH_BIOLOGY_HD',			Null,						null,						Null);
...
-- Floodplain Polder (Netherlands)
	...
	values
		...
		('IMPROVEMENT_LAND_POLDER',		'LP_POLDER_FOOD_TIRE3'),
		...
		('IMPROVEMENT_LAND_POLDER',		'LP_LAND_POLDER_FOOD_TIRE3');
	...
	values
		...
		('LP_POLDER_FOOD_TIRE2',			'Placeholder',		'YIELD_FOOD',			1,				1,					'IMPROVEMENT_POLDER',		Null,						'TECH_BIOLOGY_HD',			'CIVIC_FEUDALISM',			Null),
		('LP_POLDER_FOOD_TIRE3',			'Placeholder',		'YIELD_FOOD',			2,				1,					'IMPROVEMENT_POLDER',		'TECH_BIOLOGY_HD',			Null,						null,						Null),
		...
		('LP_LAND_POLDER_FOOD_TIRE2',		'Placeholder',		'YIELD_FOOD',			1,				1,					'IMPROVEMENT_LAND_POLDER',	Null,						'TECH_BIOLOGY_HD',			'CIVIC_FEUDALISM',			Null),
		('LP_LAND_POLDER_FOOD_TIRE3',		'Placeholder',		'YIELD_FOOD',			2,				1,					'IMPROVEMENT_LAND_POLDER',	'TECH_BIOLOGY_HD',			Null,						null,						Null);
...
-- Golf Course (Scotland)(fox)
	...
	-- modifier
		...
		values
			...
			--
			('GOLD_COURSE_PRODUCTION_TIER1','MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',			'CITY_HAS_DISTRICT_INDUSTRIAL_ZONE_REQUIREMENTS'),
			('GOLD_COURSE_PRODUCTION_TIER2','MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',			'CITY_HAS_DISTRICT_INDUSTRIAL_ZONE_TIER_1_BUILDING_REQUIREMENTS'),
			('GOLD_COURSE_PRODUCTION_TIER3','MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',			'CITY_HAS_DISTRICT_INDUSTRIAL_ZONE_TIER_2_BUILDING_REQUIREMENTS'),
			('GOLD_COURSE_PRODUCTION_TIER4','MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',			'CITY_HAS_DISTRICT_INDUSTRIAL_ZONE_TIER_3_BUILDING_REQUIREMENTS'),
			('GOLD_COURSE_PRODUCTION_TIER5','MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',			'CITY_HAS_DISTRICT_INDUSTRIAL_ZONE_TIER_4_BUILDING_REQUIREMENTS'),
			('GOLD_COURSE_PRODUCTION',		'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',		'PLOT_HAS_IMPROVEMENT_GOLD_COURSE_REQUIREMENTS'),
			--
			('GOLD_COURSE_SCIENCE_TIER1',	'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',			'CITY_HAS_DISTRICT_CAMPUS_REQUIREMENTS'),
			('GOLD_COURSE_SCIENCE_TIER2',	'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',			'CITY_HAS_DISTRICT_CAMPUS_TIER_1_BUILDING_REQUIREMENTS'),
			('GOLD_COURSE_SCIENCE_TIER3',	'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',			'CITY_HAS_DISTRICT_CAMPUS_TIER_2_BUILDING_REQUIREMENTS'),
			('GOLD_COURSE_SCIENCE_TIER4',	'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',			'CITY_HAS_DISTRICT_CAMPUS_TIER_3_BUILDING_REQUIREMENTS'),
			('GOLD_COURSE_SCIENCE_TIER5',	'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',			'CITY_HAS_DISTRICT_CAMPUS_TIER_4_BUILDING_REQUIREMENTS'),
