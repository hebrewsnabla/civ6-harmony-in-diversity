...
values
    ...
    ("LOC_BELIEF_WORK_ETHIC_DL_DESCRIPTION",                  "+2 [ICON_Production] Production for all Districts if the city has a Holy Site district. Industrial Zone district buildings are 20% cheaper to purchase. May purchase Industrial Zone district buildings with [ICON_Faith] Faith."),
    ...
    ("LOC_BELIEF_ABBOT_DL_DESCRIPTION",                       "Holy Site district provides +2 [ICON_Production] Production. Shrines, Temples and Worship buildings provide +1 [ICON_Production] Production to all adjacent tiles. +1% [ICON_Production] Production for each citizen following this religion in the city."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_WORK_ETHIC_DL_DESCRIPTION",                  "拥有圣地的城市所有区域+2 [ICON_Production] 生产力，购买工业区区域内建筑的费用降低20%且可以用 [ICON_Faith] 信仰值购买。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_ABBOT_DL_DESCRIPTION",                       "圣地提供+2 [ICON_Production] 生产力。神社、寺庙和祭祀建筑为相邻的单元格提供+1 [ICON_Production] 生产力。每名信仰此宗教的居民将使 [ICON_Production] 生产力+1%。"),
