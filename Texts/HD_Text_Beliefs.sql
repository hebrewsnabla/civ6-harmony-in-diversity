...
values
    ...
    ("LOC_BELIEF_WORK_ETHIC_DL_DESCRIPTION",                  "Holy Site District and Shrine and Temple in cities that follow this Religion provides +1 [ICON_Production] Production to all adjacent tiles."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_WORK_ETHIC_DL_DESCRIPTION",                  "信奉该宗教的城市，圣地、神社和寺庙给相邻的单元格+1 [ICON_Production] 生产力。"),
