...
values
    ...
    ("LOC_BELIEF_PAPAL_PRIMACY_DL_DESCRIPTION",               "[ICON_ENVOY] Envoys spread +150 Religious Pressure. +1 or +2 [ICON_Envoy] Envoy at each City-State when it first adopts this Religion. City-States you are Suzerain of provide +2 [ICON_FAITH] Faith and +2 [ICON_GOLD] Gold."),
    ...
    ("LOC_BELIEF_WORK_ETHIC_DL_DESCRIPTION",                  "All Districts (except City Centers) provide +2 [ICON_Production] Production in cities having a Holy Site district. Industrial Zone district buildings are 20% cheaper to purchase, and can be purchased with [ICON_Faith] Faith."),
    ...
    ("LOC_BELIEF_RELIGIOUS_COLONIZATION_DL_DESCRIPTION",      "Settlers and Buildiers are 20% cheaper to purchase with [ICON_GOLD] Gold, and 20% cheaper to purchase with [ICON_FAITH] Faith (when allowed). May purchase buildings in Government Plaza district and Diplomatic Quarter district with [ICON_Faith] Faith."),
    ...
    ("LOC_BELIEF_ZEN_MEDITATION_VIETNAM_DESCRIPTION",         "+1 Appeal to all tiles of cities with a Holy Site district. +2 [ICON_Amenities] Amenity to cities having a Holy Site district adjacent to Mountains or Woods. Preserve district buildings are 40% cheaper to purchase, and can be purchased with [ICON_Faith] Faith."),
    ...
    ("LOC_BELIEF_MESSIAH_DL_DESCRIPTION",                     "Holy Site district buildings are 20% cheaper to purchase, and can be purchased with [ICON_Faith] Faith. Citiy receives +8% [ICON_Faith] Faith for each building in its Holy Site district."),
