...
update Buildings set RegionalRange = 6 where BuildingType = 'BUILDING_FOOD_MARKET';
update Buildings set RegionalRange = 6 where BuildingType = 'BUILDING_SHOPPING_MALL';
...
values
	...
	-- ('BUILDING_STAVE_CHURCH',		'CIVIC_GRANT_ONE_TRADE_ROUTE'),
	-- 
	...
	-- ('BUILDING_GRANARY',			'GRANARY_ADD_SOME_RESOURCE_FOOD'),
	...
	-- ('BUILDING_WORKSHOP',			'WORKSHOP_ADD_QUARRY_PRODUCTION'),
...
values
	...
	-- add improvements
	('WORKSHOP_ADD_MINE_PRODUCTION', 				'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					'PLOT_HAS_MINE_REQUIREMENTS'),
	('WORKSHOP_ADD_QUARRY_PRODUCTION', 				'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					'PLOT_HAS_QUARRY_REQUIREMENTS'),
...
values
	...
	('ELECTRONICS_FACTORY_POP_PRODUCTION_MODIFIER',	'Amount',		'0.5'),
	-- 
	...
	('WORKSHOP_ADD_QUARRY_PRODUCTION',				'YieldType',	'YIELD_PRODUCTION'),
	('WORKSHOP_ADD_QUARRY_PRODUCTION',				'Amount',		1),
	('WORKSHOP_ADD_LUMBER_MILL_PRODUCTION',			'YieldType',	'YIELD_PRODUCTION'),
	('WORKSHOP_ADD_LUMBER_MILL_PRODUCTION',			'Amount',		1),
	-- enhance trained units
...
-- 食品市场 购物商城
update Buildings_XP2 set RequiredPower = 2 where BuildingType = 'BUILDING_SHOPPING_MALL' or BuildingType = 'BUILDING_FOOD_MARKET';
