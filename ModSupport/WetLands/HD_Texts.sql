...
values
    ...
    ("LOC_TECH_BIOLOGY_HD_DESCRIPTION",               "+1 [ICON_Science] Science from the Reed Home improvement. +1 [ICON_Culture] Culture from the Oasis Garden improvement."),
    ...
    ("LOC_BELIEF_LADY_OF_THE_REEDS_AND_MARSHES_DL_DESCRIPTION",   "+2 [ICON_Production] Production from Marsh, Swamp, Oasis, and Desert Floodplains. +1 [ICON_Science] Science from Marsh. +1 [ICON_CULTURE] Culture from Swamp. Floodplain tiles no longer lower adjacent tiles' Appeal."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_TECH_BIOLOGY_HD_DESCRIPTION",               "芦苇屋+1 [ICON_Science] 科技值。绿洲花园+1 [ICON_Culture] 文化值。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_LADY_OF_THE_REEDS_AND_MARSHES_DL_DESCRIPTION",   "沼泽、绿洲、沙漠泛滥平原提供+2 [ICON_Production] 生产力。草本沼泽提供+1 [ICON_Science] 科技值，木本沼泽提供+1 [ICON_CULTURE] 文化值。泛滥平原不再为相邻单元格-1魅力。"),
    ...
    ("zh_Hans_CN",  "LOC_TRAIT_CIVILIZATION_VIETNAM_DESCRIPTION",    "所有区域（除市中心外）不移除树林、雨林、沼泽地貌。建在这些区域中的建筑以及区域本体和奇观将获得以下收益：建在树林上提供+2 [ICON_Production] 生产力、建在雨林上提供+2 [ICON_Food] 食物、建在草本沼泽上提供+2 [ICON_Science] 科技值、建在木本沼泽上提供+2 [ICON_CULTURE] 文化值。拥有“中世纪集市”市政后即可栽种树林。");