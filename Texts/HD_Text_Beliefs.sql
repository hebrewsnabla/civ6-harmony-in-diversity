...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_JESUIT_EDUCATION_DL_DESCRIPTION",            "神社为每人口提供0.3 [ICON_Science] 科技值。寺庙和祭祀建筑为每人口提供0.6 [ICON_Science] 科技值。购买学院区域内建筑的费用降低20%且可以用 [ICON_Faith] 信仰值购买。"),
