...
values
    ...
    ("LOC_GREATPERSON_JAMES_WATT_ACTIVE",                                 "Instantly builds a Factory and Workshop in this district. Factories provide +3 [ICON_Production] Production."),
    ...
    ("LOC_GREATPERSON_DMITRI_MENDELEEV_ACTIVE",                           "Triggers the [ICON_TechBoosted] Eureka moment for Chemistry and 1 random technology from the Industrial and Modern era. If Chemistry is already triggered, instead complete the tech."),
    ...
    ("LOC_GREAT_PERSON_INDIVIDUAL_BOOST_OR_GRANT_PRINTING",               "Triggers the [ICON_TechBoosted] Eureka moment for Printing. If Printing is already triggered, instead complete the tech."),
    ...
    ("LOC_GREAT_PERSON_INDIVIDUAL_BOOST_OR_GRANT_REFINING",               "Triggers the [ICON_TechBoosted] Eureka moment for Refining. If Refining is already triggered, instead complete the tech."),
    ("LOC_GREAT_PERSON_INDIVIDUAL_BOOST_OR_GRANT_SANITATION",             "Triggers the [ICON_TechBoosted] Eureka moment for Sanitation. If Sanitation is already triggered, instead complete the tech."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_GREATPERSON_JAMES_WATT_ACTIVE",                                 "立即在该区域建造工厂和工作坊。工厂+3 [ICON_Production] 生产力。"),
    ...
    ("zh_Hans_CN",  "LOC_GREATPERSON_DMITRI_MENDELEEV_ACTIVE",                           "为化学和工业或现代的1个随机科技启动 [ICON_TechBoosted] 尤里卡时刻。若化学尤里卡已被触发，则完成该科技。"),
    ...
    ("zh_Hans_CN",  "LOC_GREAT_PERSON_INDIVIDUAL_BOOST_OR_GRANT_PRINTING",               "为印刷术启动 [ICON_TechBoosted] 尤里卡时刻。若印刷术尤里卡已被触发，则完成该科技。"),
    ...
    ("zh_Hans_CN",  "LOC_GREAT_PERSON_INDIVIDUAL_BOOST_OR_GRANT_REFINING",               "为精炼启动 [ICON_TechBoosted] 尤里卡时刻。若精炼已被触发，则完成该科技。"),
    ("zh_Hans_CN",  "LOC_GREAT_PERSON_INDIVIDUAL_BOOST_OR_GRANT_SANITATION",             "为卫生设备启动 [ICON_TechBoosted] 尤里卡时刻。若卫生设备已被触发，则完成该科技。"),
