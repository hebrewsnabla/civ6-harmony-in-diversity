...
--========================================================================================================================
        ...
        (
            ...
            "zh_Hans_CN",
            "这个游戏模式为世界海洋注入了新的活力，添加了新的资源、新的功能和新的玩法。海藻森林充斥着海岸，提供了更多的食物并减缓了海军的速度。新的资源正在深海下等待着你的探索，如海豹、鱿鱼和珊瑚，大大增加了海洋资源的多样性。现在每个大洲的海岸奢侈品都是不同的，探索新的海洋意味着新的财富。区域和建筑如水上公园、水族馆都根据这些新内容进行了调整。"
        ),
--========================================================================================================================
-- Squid
--========================================================================================================================
...
insert or replace into EnglishText
    (Tag,                                                                                   Text)
values
    ("LOC_TECH_SAILING_HD_DESCRIPTION",                                                     "Allows harvesting of resources improved by Fishing Boats.Allows Builders and Traders to embark. Allows harvesting of Kelp Forest."),
...
insert or replace into LocalizedText
    (Language,      Tag,                                                                    Text)
values
    ("zh_Hans_CN",  "LOC_TECH_SAILING_HD_DESCRIPTION",                                      "允许收获由渔船改良的资源。允许建造者和商人上船。允许收获海藻森林。"),
