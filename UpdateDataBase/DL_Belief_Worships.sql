...
values
	('WAT_SCIENCE_PERCENTAGE_BOOST', 							0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER'),
	('PAGODA_CULTURE_PERCENTAGE_BOOST',							0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER'),
	('SYNAGOGUE_FAITH_PERCENTAGE_BOOST',						0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER'),
	-- ('MEETING_HOUSE_BUILDING_PRODUCTION_PERCENTAGE_BOOST',		0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_BUILDING_PRODUCTION_MODIFIER'),
	-- ('MEETING_HOUSE_DISTRICT_PRODUCTION_PERCENTAGE_BOOST',		0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_DISTRICT_PRODUCTION_MODIFIER'),
	('MEETING_HOUSE_PRODUCTION_PERCENTAGE_BOOST',				0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER'),
	('STUPA_AMENTITY_BONUS',									0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_EXTRA_AMENITY_FOR_LUXURY_DIVERSITY'),
	('CATHEDRAL_RELIGIOUS_ART_TOURISM_BONUS',					0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_TOURISM'),
	('CATHEDRAL_SCULPTURE_TOURISM_BONUS',						0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_TOURISM'),
	('CATHEDRAL_PORTRAIT_TOURISM_BONUS',						0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_TOURISM'),
	('CATHEDRAL_LANDSCAPE_TOURISM_BONUS',						0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_TOURISM'),
	('CATHEDRAL_RELIGIOUS_ART_CULTURE_BONUS',					0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_GREATWORK_YIELD'),
	('CATHEDRAL_SCULPTURE_CULTURE_BONUS',						0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_GREATWORK_YIELD'),
	('CATHEDRAL_PORTRAIT_CULTURE_BONUS',						0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_GREATWORK_YIELD'),
	('CATHEDRAL_LANDSCAPE_CULTURE_BONUS',						0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_GREATWORK_YIELD'),
	--('CATHEDRAL_RELIGIOUS_ART_FAITH_BONUS',						0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_GREATWORK_YIELD'),
	--('CATHEDRAL_SCULPTURE_FAITH_BONUS',							0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_GREATWORK_YIELD'),
	('GURDWARA_FOOD_PERCENTAGE_BOOST',							0,	0,	'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER'),
