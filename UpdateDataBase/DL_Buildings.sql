...
--军阀宝座锤陆军加速
	('GOV_CONQUEST_LAND_UNIT_PRODUCTION',	'MODIFIER_CITY_ADJUST_UNIT_DOMAIN_PRODUCTION'),
--军阀宝座锤海军加速
...
--军阀宝座锤陆军加速
	('GOV_CONQUEST_LAND_UNIT_PRODUCTION',		'Domain',		'DOMAIN_LAND'),
...
--MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER_GRANCOLOMBIA_MAYA
	...
	('BUILDING_GOV_CITYSTATES',				'GOV_CITYSTATES_GOVERNOR_POINT'),
--情报局
...
--额外总督点
	('GOV_CITYSTATES_GOVERNOR_POINT',		'MODIFIER_PLAYER_ADJUST_GOVERNOR_POINTS',								Null),
--情报局
...
values
--中书省
	('GOV_CITYSTATES_GOVERNOR_POINT',		'Amount',			1),
