...
values
    ...
    ("LOC_GOVERNOR_PROMOTION_EDUCATOR_CONNOISSEUR_DESCRIPTION",                             "+1 [ICON_CULTURE] Culture per turn for each [ICON_Citizen] Citizen in the city."),
    ("LOC_GOVERNOR_PROMOTION_EDUCATOR_RESEARCHER_DESCRIPTION",                              "+1 [ICON_SCIENCE] Science per turn for each [ICON_Citizen] Citizen in the city."),    
