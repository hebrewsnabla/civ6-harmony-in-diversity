...
update Buildings set PrereqDistrict = 'DISTRICT_HOLY_SITE' where BuildingType = 'BUILDING_CITY_POLICY_THEOLOGICAL_SEMINAR';
insert or replace into Building_CitizenYieldChanges
	(BuildingType,									YieldType,			YieldChange)
values
	('BUILDING_CITY_POLICY_THEOLOGICAL_SEMINAR',	'YIELD_FAITH',		-2),
	('BUILDING_CITY_POLICY_THEOLOGICAL_SEMINAR',	'YIELD_SCIENCE',	1),
	('BUILDING_CITY_POLICY_THEOLOGICAL_SEMINAR',	'YIELD_CULTURE',	1);
------【结束】------
