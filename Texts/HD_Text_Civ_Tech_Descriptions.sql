...
values
    ...
    ("LOC_TECH_MINING_HD_DESCRIPTION",                                                      "Allows chopping of Woods and Rainforests, and harvesting of resources improved by Mines or Lumber Mills."),
    ...
    ("LOC_TECH_CONSTRUCTION_HD_DESCRIPTION",                                                "Camp improvements provide +1 [ICON_PRODUCTION] Production."), -- and Lumber Mill 
...
--    ("LOC_TECH_ASTRONOMY_HD_DESCRIPTION",                                                   "+3 [ICON_Science] Science to Campus Districts adjacent to Mountains. +5% [ICON_Science] Science for cities with University."),
    ...
    -- ("LOC_CIVIC_MEDIEVAL_FAIRES_HD_DESCRIPTION",                                            "Plantation improvements provide +2 [ICON_gold] Gold."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_TECH_CALENDAR_HD_DESCRIPTION",                                     "农场+1 [ICON_Food] 食物。[NEWLINE]拥有粮仓的城市，每 [ICON_Citizen] 市民消耗的 [ICON_Food] 食物减少0.5。"),
