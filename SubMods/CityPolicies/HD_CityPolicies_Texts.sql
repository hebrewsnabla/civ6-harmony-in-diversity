...
values
    ...
    ("LOC_CITY_POLICY_REVISION_ALMANAC_EFFECT",                       "Aqueduct Project. Need maintenance cost of 6 [ICON_GOLD] Gold. Plantations and Farms over resource provides -1 [ICON_FOOD] Food, +1 [ICON_Production] Production and +1 [ICON_SCIENCE] Science. After Calendar is researched, provides +1 extra [ICON_Production] Production."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_CITY_POLICY_REVISION_ALMANAC_EFFECT",                       "水渠项目。需要6 [ICON_GOLD] 金币的维护费。城市中改良资源的农场或种植园-1[ICON_FOOD] 食物，+1 [ICON_Production] 生产力和+1 [ICON_SCIENCE] 科技值。研究“历法”科技后，额外提供+1 [ICON_Production] 生产力。"),
