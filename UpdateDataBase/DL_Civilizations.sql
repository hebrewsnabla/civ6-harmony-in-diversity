...
insert or replace into RequirementArguments (RequirementId,		Name,		Value) values
	...
	('REQUIRES_DISTRICTS_NOT_CITY_CENTER_NOT_WONDERS',	'RequirementSetId',	'HD_DISTRICTS_NOT_CITY_CENTER_NOT_WONDERS');
...
insert or replace into RequirementSets (RequirementSetId,		RequirementSetType) values
	...
	('HD_DISTRICTS_NOT_CITY_CENTER_NOT_WONDERS',    			'REQUIREMENTSET_TEST_ANY');
...
select 'HD_DISTRICTS_NOT_CITY_CENTER_NOT_WONDERS',  'REQUIRES_DISTRICT_IS_' || DistrictType from Districts where DistrictType! = 'DISTRICT_CITY_CENTER';
-----------------------------------------------------------------------------------------------------------------
...
-- 	('TRAIT_CIVILIZATION_SCOTTISH_ENLIGHTENMENT',		'TRAIT_NUCLEARPLANT_SCIENTIST_POINT_ECSTATIC'),
	...
	('TRAIT_CIVILIZATION_SCOTTISH_ENLIGHTENMENT',		'SCOTLAND_FRIENDLY_COMBAT');
...
-- 	('TRAIT_COALPLANT_ENGINEER_POINT_ECSTATIC',					'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_GREAT_PERSON',			'PLAYER_HAS_PLANT_ECSTATIC_REQUIREMENTS'),
	...
	('SCOTLAND_FRIENDLY_COMBAT',								'MODIFIER_PLAYER_UNITS_ADJUST_COMBAT_STRENGTH',					'HD_UNIT_IN_FRIENDLY_TERRITORY_REQUIREMENTS');
