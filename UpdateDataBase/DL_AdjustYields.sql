...
--艾雅法拉火山占有特效：全国冻土区域+1粮
--白沙漠占有特效：全国免疫沙尘暴
insert or replace into TraitModifiers
	(TraitType,					ModifierId)
values
	('TRAIT_LEADER_MAJOR_CIV',	'TUNDRA_DISTRICT_FOOD_EYJAFJALLAJOKULL'),
	('TRAIT_LEADER_MAJOR_CIV',	'DUST_STORM_GRADIENT_PREVENTION_MODIFIER'),
	('TRAIT_LEADER_MAJOR_CIV',	'DUST_STORM_HABOOB_PREVENTION_MODIFIER');
insert or replace into Modifiers
	(ModifierId,											ModifierType,											SubjectRequirementSetId)
values
	('TUNDRA_DISTRICT_FOOD_EYJAFJALLAJOKULL_MODIFIER',		'MODIFIER_CITY_DISTRICTS_ADJUST_YIELD_CHANGE',			'DISTRICTS_ON_TUNDRA_OR_TUNDRA_HILL_REQUIREMENTS'),
	('TUNDRA_DISTRICT_FOOD_EYJAFJALLAJOKULL',				'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER',				'PLAYER_HAS_EYJAFJALLAJOKULL'),
	('DUST_STORM_GRADIENT_PREVENTION_MODIFIER',				'MODIFIER_PLAYER_ADJUST_RANDOM_EVENT_NO_UNIT_DAMAGE',	'PLAYER_HAS_SAHARA_EL_BEYDA'),
	('DUST_STORM_HABOOB_PREVENTION_MODIFIER',				'MODIFIER_PLAYER_ADJUST_RANDOM_EVENT_NO_UNIT_DAMAGE',	'PLAYER_HAS_SAHARA_EL_BEYDA');
	
insert or replace into ModifierArguments
	(ModifierId,											Name,				Value)
values
	('TUNDRA_DISTRICT_FOOD_EYJAFJALLAJOKULL_MODIFIER',		'YieldType',		'YIELD_FOOD'),
	('TUNDRA_DISTRICT_FOOD_EYJAFJALLAJOKULL_MODIFIER',		'Amount',			1),
	('TUNDRA_DISTRICT_FOOD_EYJAFJALLAJOKULL',				'ModifierId',		'TUNDRA_DISTRICT_FOOD_EYJAFJALLAJOKULL_MODIFIER'),
	('DUST_STORM_GRADIENT_PREVENTION_MODIFIER',				'RandomEventType',	'RANDOM_EVENT_DUST_STORM_GRADIENT'),
	('DUST_STORM_GRADIENT_PREVENTION_MODIFIER',				'NoDamage',			1),
	('DUST_STORM_HABOOB_PREVENTION_MODIFIER',				'RandomEventType',	'RANDOM_EVENT_DUST_STORM_HABOOB'),
	('DUST_STORM_HABOOB_PREVENTION_MODIFIER',				'NoDamage',			1);