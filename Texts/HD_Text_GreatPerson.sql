...
values
	...
	("LOC_GREAT_PERSON_INDIVIDUAL_HD_CROESUS_ACTIVE",					  "Instantly builds a Market in this district.[NEWLINE]Market provide +2 [ICON_GOLD] Gold."),
...
values
	...
	("zh_Hans_CN",  "LOC_GREAT_PERSON_INDIVIDUAL_HD_CROESUS_ACTIVE",					  "立即在该区域建造1座市场。[NEWLINE]所有市场+2 [ICON_GOLD] 金币。"),
