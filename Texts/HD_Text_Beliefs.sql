...
values
    ...
    ("LOC_DISTRICT_MOUNTAIN_FAITH",                           "+{1_num} [ICON_Faith] Faith from the adjacent Mountain {1_Num : plural 2?tile; other?tiles;}."),
    ...
    ("LOC_BELIEF_JESUIT_EDUCATION_DL_DESCRIPTION",            "May purchase Campus district buildings with [ICON_Faith] Faith. +0.2 [ICON_Science] Science for each [ICON_Citizen] citizen in this city, doubles when the city has a Shrine, quadruple when the city has a Temple."),
    ...
    ("LOC_BELIEF_ABBOT_DL_DESCRIPTION",                       "+2 [ICON_Production] Production for Holy Site Districts. Shrines and Temples provide +1 [ICON_Production] Production to all adjacent tiles."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_JESUIT_EDUCATION_DL_DESCRIPTION",            "可以使用 [ICON_Faith] 信仰值购买学院区域内的建筑。每人口提供0.2 [ICON_Science] 科技值，若城市有神社则变为2倍，有寺庙则变为4倍。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_ABBOT_DL_DESCRIPTION",                       "圣地+2 [ICON_Production] 生产力。神社和寺庙为相邻的单元格提供+1 [ICON_Production] 生产力。"),
