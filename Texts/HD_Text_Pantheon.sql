...
values
    ...
    ("LOC_BELIEF_STONE_CIRCLES_DL_DESCRIPTION",                   "Quarries provide +1 [ICON_Faith] Faith and +1 [ICON_Production] Production. Cities having Quarries provide +2 [ICON_GreatProphet] Great Prophet point per turn."),
    ("LOC_BELIEF_RELIGIOUS_IDOLS_DL_DESCRIPTION",                 "+1 [ICON_Faith] Faith and +1 [ICON_CULTURE] Culture from Mines over Luxury and Bonus resources. +2 [ICON_GreatProphet] Great Prophet point per turn for cities having mines over Luxury or Bonus resources."),
    ...
    ("LOC_BELIEF_GODDESS_OF_FIRE_DL_DESCRIPTION",                 "Geothermal Fissures and Volcanic Soil provide +1 [ICON_FAITH] Faith and +1 [ICON_CULTURE] Culture. Cities having Geothermal Fissures, Volcanic Soil or Volcano (Volcanic Wonders included) tiles provide +4 [ICON_GreatProphet] Great Prophet point per turn."),
    ("LOC_BELIEF_THE_PEOPLE_OF_POLAR_NAME",                       "The People of Polar"),
    ("LOC_BELIEF_THE_PEOPLE_OF_POLAR_DL_DESCRIPTION",             "City centers provide +1 [ICON_Food] Food and +1 [ICON_Faith] Faith for each adjacent Tundra or Tundra Hills tile. Cities having Tundra or Tundra Hills tiles provide +2 [ICON_GreatProphet] Great Prophet point per turn."),
    ("LOC_BELIEF_GODDESS_OF_THE_DESERT_NAME",                     "Goddess of the Desert"),
    ("LOC_BELIEF_GODDESS_OF_THE_DESERT_DL_DESCRIPTION",           "City centers provide +1 [ICON_Food] Food and +1 [ICON_Faith] Faith for each adjacent Desert or Desert Hills tile. Cities having Desert or Desert Hills tiles provide +2 [ICON_GreatProphet] Great Prophet point per turn."),
    ...
    ("LOC_BELIEF_HD_MAZU_BELIEF_DL_DESCRIPTION",                  "City Centers adjacent to Coasts provide +2 [ICON_Production] Production. Harbor districts provide +2 [ICON_Production] Production. Fishing Boats provide +2 [ICON_Gold] Gold for each adjacent Specialized Districts."), 
    ("LOC_BELIEF_FISHING_TRADITION_NAME",                         "Fishing Traidition"),
    ("LOC_BELIEF_FISHING_TRADITION_DL_DESCRIPTION",               "Fishing Boats provide +1 [ICON_Production] Production. Fishing Boats over Bonus Resources provide additional +1 [ICON_Production] Production."), -- and +2 [ICON_Gold] Gold 
    ...
    ("LOC_BELIEF_HD_POSTERITY_OF_MOUNTAIN_DL_DESCRIPTION",        "Campus and Holy Site districts receive additional standard adjacency bonus from Mountains. Cities having Mountains provide +2 [ICON_GreatProphet] Great Prophet point per turn. Cities adjacent to Mountains receive +1 [ICON_Amenities] Amenity and +1 [ICON_Housing] Housing."),
    ("LOC_BELIEF_HD_SONG_OF_SIREN_NAME",                          "Song of Siren"),
    ("LOC_BELIEF_HD_SONG_OF_SIREN_DL_DESCRIPTION",                "Campus districts receive additional major adjacency bonus from Reefs. +2 [ICON_Production] Production from Reefs."),
    ("LOC_BELIEF_HD_UTAKI_NAME",                                  "Utaki"),
    ("LOC_BELIEF_HD_UTAKI_DL_DESCRIPTION",                        "Cities adjacent to Coasts receive +2 [ICON_Amenities] Amenity and +2 [ICON_Housing] Housing. City Centers provide +1 [ICON_Culture] Culture and +1 [ICON_Production] Production for every two adjacent Lake or Coast tiles."),
    ("LOC_BELIEF_HD_WOLF_GOD_NAME",                               "Lupercal"),
    ("LOC_BELIEF_HD_WOLF_GOD_DL_DESCRIPTION",                     "Camps over Luxury and Bonus resources provide +1 [ICON_CULTURE] Culture. Camps in cities with Holy Site districts provide +1 [ICON_Faith] Faith. Cities having Camps over Luxury or Bonus resources provide +2 [ICON_GreatProphet] Great Prophet point per turn."),
    ("LOC_BELIEF_HD_SUN_GOD_NAME",                                "Apollo"),
    ("LOC_BELIEF_HD_SUN_GOD_DL_DESCRIPTION",                      "Farms in cities with Holy Site districts provide +1 [ICON_FAITH] Faith. Plantations and Farms over resources provide +1 [ICON_FOOD] Food. Cities having Plantations or Farms over resources provide +2 [ICON_GreatProphet] Great Prophet point per turn.");
