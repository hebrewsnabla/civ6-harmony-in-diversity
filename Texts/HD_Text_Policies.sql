...
values
    ...
    ("LOC_POLICY_SUPERPOWER_DESCRIPTION",                                             "+2% [ICON_SCIENCE] Science in all your cities for Every Research Lab you have. +2% [ICON_CULTURE] Culture in all your cities for Every Broadcast Center you have."),
    ...
    ("LOC_POLICY_LIBERALISM_DESCRIPTION",                                             "+1 [ICON_Amenities] Amenity to all cities with at least 2 specialty districts. +50% construction speed toward Entertainment Complex and Water Park districts and buildings in these districts."),
    ...
    ("LOC_POLICY_DEEP_WATER_PORT_DESCRIPTION",                                        "+4 [ICON_Production] Production to all coastal city. Seaport provide +6 [ICON_GOLD] Gold and +3 [ICON_Housing] Housing."),
    ...
    -- Golden age
    ("LOC_MOMENT_CATEGORY_INFRASTRUCTURE_BONUS_GOLDEN_AGE",                           "Monumentality Golden Age:[NEWLINE]+15% construction speed towards Wonders. +1 [ICON_CULTURE] Culture, +1 [ICON_FAITH] Faith to all Wonders. Cities with Wonder can build one more district than the [ICON_Citizen] Population limit allows. "),
    ("LOC_MOMENT_CATEGORY_RELIGIOUS_BONUS_GOLDEN_AGE",                           	 "Exodus of the Evangelists Golden Age:[NEWLINE]+2 [ICON_MOVEMENT] Movement and +2 Charges for all Missionaries, Apostles, and Inquisitors. +6 [ICON_FAITH] for each foreign city following your Religion."),
    ("LOC_MOMENT_CATEGORY_SCIENTIFIC_BONUS_GOLDEN_AGE",                               "Free Inquiry Golden Age:[NEWLINE][ICON_TECHBOOSTED] Eurekas provide an additional 10% of technology costs. Each different District and Building provides +1 [ICON_SCIENCE] Science to your civilization."),
    ...
    ("LOC_MOMENT_CATEGORY_EXPLORATION_BONUS_GOLDEN_AGE",                              "Hic Sunt Dracones Golden Age:[NEWLINE]+3 starting [ICON_CITIZEN] Population for new cities. +2 [ICON_MOVEMENT] Movement for Settler, naval and embarked units. +100% [ICON_PRODUCTION] Production towards Districts in cities without a Specialty district."),
    ...
    ("LOC_MOMENT_CATEGORY_TOURISM_BONUS_GOLDEN_AGE",                                  "Wish You Were Here Golden Age:[NEWLINE]World Wonders and National Parks provide +100% [ICON_Tourism] Tourism."),
    ("LOC_MOMENT_CATEGORY_GOVERNMENT",                                                "Enlightened Despotism"),
    ("LOC_MOMENT_CATEGORY_GOVERNMENT_BONUS_GOLDEN_AGE",                               "Enlightened Despotism Golden Age:[NEWLINE]+1 Wildcard policy slot. Cities yield +5% [ICON_CULTURE] Culture."),
    ("LOC_MOMENT_CATEGORY_GOVERNMENT_BONUS_NORMAL_AGE",                               "Enlightened Despotism Normal Age:[NEWLINE]Historic Moments provide +1 Era Score."),
    ("LOC_MOMENT_CATEGORY_GOVERNMENT_BONUS_DARK_AGE",                                 "Enlightened Despotism Dark Age:[NEWLINE]Historic Moments provide +1 Era Score."),
    -- 黑暗卡
    ...
    ("LOC_GOVT_ACCUMULATED_BONUS_BRIEF_THEOCRACY_XP1",                                "15% Discount on Purchases with [ICON_Faith] Faith. Enable purchasing land military units with [ICON_Faith] Faith in cities that has Holy Site."),
        -- Tier 3
    ("LOC_GOVT_INHERENT_BONUS_DEMOCRACY_XP2",                                         "Your [ICON_TradeRoute] Trade Routes to an Ally's city or a city-state that you are the Suzerain of provide +3 [ICON_Food] Food and +3 [ICON_Production] Production for both cities. Alliance Points with all Allies increase by an additional 0.25 per turn. Allows city to purchase districts with [ICON_Gold] Gold."),
    ("LOC_GOVT_ACCUMULATED_BONUS_BRIEF_DEMOCRACY_XP1",                                "25% Discount on Purchases with [ICON_Gold] Gold."),
    ("LOC_GOVT_INHERENT_BONUS_COMMUNISM_XP1",                                         "+1 [ICON_Production] Production per [ICON_Citizen] Citizen in cities."),
    ...
    ("LOC_POLICY_CHARISMATIC_LEADER_ETHIOPIA_DESCRIPTION",                            "Open Borders with all city-states. +3 Influence points per turn; Diplomatic Quarter, Consulate and Chancery provide +1 Influence point per turn."),
    ("LOC_POLICY_DIPLOMATIC_LEAGUE_ETHIOPIA_DESCRIPTION",                             "Open Borders with all city-states. +3 Influence points per turn; Diplomatic Quarter, Consulate and Chancery provide +2 Influence point per turn."),
    ("LOC_POLICY_GUNBOAT_DIPLOMACY_ETHIOPIA_DESCRIPTION",                             "Open Borders with all city-states. +3 Influence points per turn; Diplomatic Quarter, Consulate and Chancery provide +3 Influence points per turn."),
    ...
    ("LOC_POLICY_MINARET_DESCRIPTION",                                                "Temples provide 0.3 [ICON_FAITH] Faith and Worship Buildings provide 0.5 [ICON_FAITH] Faith per [ICON_Citizen] citizen in the city."),
    ...
    ("LOC_POLICY_BREEDING_DESCRIPTION",                                  			  "All improved [ICON_RESOURCE_HORSES] Horses resources yield 3 additional resource per turn."),
    ("LOC_POLICY_FORGING_NAME",                                   					  "Forging"),
    ("LOC_POLICY_FORGING_DESCRIPTION",                                   			  "All improved [ICON_RESOURCE_IRON] Iron resources yield 3 additional resource per turn."),
    ...
    ("LOC_POLICY_EQUESTRIAN_ORDERS_DL_DESCRIPTION",                                   "All improved [ICON_RESOURCE_HORSES] Horses and [ICON_RESOURCE_IRON] Iron resources yield 3 additional resource per turn."),
    ...
    ("LOC_POLICY_PUBLIC_TRANSPORT_DESCRIPTION_XP2",                                   "Provides +50% adjacency bonuses to Districts adjacent to City Center or Neighborhood with at least 15 [ICON_Citizen] population. Provides [ICON_Gold] Gold equal to the adjacency bonuses of districts 3 tiles away from City Center or Neighborhood with at least 15 [ICON_Citizen] population."),
    ...
    ("LOC_POLICY_CITY_CENTRALIZATION_DESCRIPTION",                                    "+2 [ICON_Food] Food, +2 [ICON_Production] Production, +2 [ICON_SCIENCE] Science, +2 [ICON_CULTURE] Culture, +2 [ICON_Faith] Faith and +4 [ICON_Gold] Gold in all cities."),
    ...
    ("LOC_POLICY_TRIBUTE_TRADE_DESCRIPTION",                                          "Commercial Hubs and Harbor districts provide +1 Influence points per turn. [ICON_TradeRoute] Trade Routes to a city-state you are Suzerain of provide +3 [ICON_GOLD] Gold."),
    ...
    ("LOC_POLICY_SPORTS_MEDIA_DESCRIPTION",                                           "+100% Theater Square district adjacency bonuses. Regional effects from your Water Park and Entertainment Complex districts reach 3 tiles farther."),
    ...
    ("LOC_POLICY_RAJ_DESCRIPTION_XP2",                                                "+2 [ICON_Science] Science, +2 [ICON_Culture] Culture, +2 [ICON_Faith] Faith, and +2 [ICON_Gold] Gold from each city-state you are Suzerain of. +2 [ICON_Science] Science, +2 [ICON_Culture] Culture, +2 [ICON_Faith] Faith, and +2 [ICON_Gold] Gold to cities you captured."),
    ("LOC_POLICY_WEAPONS_MANAGEMENT_SERVICE_DESCRIPTION",                             "+100% Encampment adjacency bonuses."),
    ("LOC_POLICY_INTERNATIONALISM_NAME",                                              "Internationalism"),
    ...
    ("LOC_POLICY_WELL_FIELD_NAME",                                                    "Well Field"),
    ...
    ("LOC_POLICY_HOUSEHOOD_REGISTRATION_NAME",                                        "Househood Registration"),
    ...
    ("LOC_POLICY_HAJJ_DESCRIPTION",                                                   "+1 [ICON_Science] Science, +1 [ICON_Culture] Culture from each city-state you are Suzerain of."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_POLICY_SOCIAL_STATISTICS_DESCRIPTION",                                      "所有拥有至少3个专业化区域的城市每位 [ICON_Citizen] 公民将提供0.6点 [ICON_Science] 科技值和0.6点 [ICON_Culture] 文化值。"),
    ("zh_Hans_CN",  "LOC_POLICY_PLUTONOMY_NAME",                                                     "政治经济学"),
    ("zh_Hans_CN",  "LOC_POLICY_PLUTONOMY_DESCRIPTION",                                              "拥有剧院的城市+5% [ICON_GOLD] 金币，拥有学院的城市+5% [ICON_Production] 生产力。"),
    ...
    ("zh_Hans_CN",  "LOC_POLICY_NEW_ROUTE_DESCRIPTION",                                              "所有国际 [ICON_TradeRoute] 贸易路线+3 [ICON_Culture] 文化值和+3 [ICON_Science] 科技值。"),
    ("zh_Hans_CN",  "LOC_POLICY_WATER_TRANSPORT_NAME",                                               "漕运"),
    ("zh_Hans_CN",  "LOC_POLICY_WATER_TRANSPORT_DESCRIPTION",                                        "所有国内 [ICON_TradeRoute] 贸易路线+3 [ICON_Food] 食物和+3 [ICON_Production] 生产力。"),
    ...
    ("zh_Hans_CN",  "LOC_POLICY_LIBERALISM_DESCRIPTION",                                             "拥有至少两个专业化区域的城市+1 [ICON_Amenities] 宜居度。建造娱乐中心和水上乐园区域以及这些区域中的建筑时+50%建造速度。"),
    ...
    ("zh_Hans_CN",  "LOC_POLICY_GREEN_CITY_DESCRIPTION",                                             "位于惊艳单元格的城市国家公园和奇观 [ICON_TOURISM] 旅游业绩+100%。"), 
    ...
    -- 着力点
    ("zh_Hans_CN",  "LOC_MOMENT_CATEGORY_INFRASTRUCTURE_BONUS_GOLDEN_AGE",                           "“雄伟壮丽”黄金时代：[NEWLINE]建造奇观时+15%建造速度。奇观+1 [ICON_CULTURE] 文化值，+1 [ICON_FAITH] 信仰值。有奇观的城市可无视 [ICON_CITIZEN] 人口数量限制再建造一个区域。"),
    ...
    ("zh_Hans_CN",  "LOC_MOMENT_CATEGORY_GOVERNMENT",                                                "开明专制"),
    ("zh_Hans_CN",  "LOC_MOMENT_CATEGORY_GOVERNMENT_BONUS_GOLDEN_AGE",                               "“开明专制”黄金时代：[NEWLINE]+1 通配符政策槽位。所有城市+5% [ICON_CULTURE] 文化值。"),
    ("zh_Hans_CN",  "LOC_MOMENT_CATEGORY_GOVERNMENT_BONUS_NORMAL_AGE",                               "“开明专制”普通时代：[NEWLINE]每次获得时代分时额外获得1点时代分。"),
    ("zh_Hans_CN",  "LOC_MOMENT_CATEGORY_GOVERNMENT_BONUS_DARK_AGE",                                 "“开明专制”黑暗时代：[NEWLINE]每次获得时代分时额外获得1点时代分。"),
    -- 黑暗卡
    ...
    ("zh_Hans_CN",  "LOC_GOVT_ACCUMULATED_BONUS_BRIEF_THEOCRACY_XP1",                                "使用 [ICON_Faith] 信仰值购买可享受15%折扣。可使用信仰在拥有圣地的城市购买陆地军事单位。"),
        -- Tier 3
    ("zh_Hans_CN",  "LOC_GOVT_INHERENT_BONUS_DEMOCRACY_XP2",                                         "您通往盟友或宗主国城市的 [ICON_TradeRoute] 贸易路线为双边城市+3 [ICON_Food] 食物、+3 [ICON_Production] 生产力。所有盟友的同盟点数每回合额外增加0.25点。城市可使用 [ICON_Gold] 金币购买区域。"),
    ("zh_Hans_CN",  "LOC_GOVT_ACCUMULATED_BONUS_BRIEF_DEMOCRACY_XP1",                                "使用 [ICON_Gold] 金币购买时费用-25%。"),
    ("zh_Hans_CN",  "LOC_GOVT_INHERENT_BONUS_COMMUNISM_XP1",                                         "城市中每位 [ICON_Citizen] 公民将提供1点 [ICON_Production] 生产力。"),
    ...
    ("zh_Hans_CN",  "LOC_POLICY_MARKET_ECONOMY_DESCRIPTION",                                         "所有国际 [ICON_TradeRoute] 贸易路线+4 [ICON_Culture] 文化值和+4 [ICON_Science] 科技值。"),
    ...
    ("zh_Hans_CN",  "LOC_POLICY_BREEDING_DESCRIPTION",                                  			  "所有改良的 [ICON_RESOURCE_HORSES] 马每回合额外产出3点资源。"),
    ("zh_Hans_CN",  "LOC_POLICY_FORGING_NAME",                                   					  "锻造"),
    ("zh_Hans_CN",  "LOC_POLICY_FORGING_DESCRIPTION",                                   			  "所有改良的 [ICON_RESOURCE_IRON] 铁每回合额外产出3点资源。"),
    ...
    ("zh_Hans_CN",  "LOC_POLICY_EQUESTRIAN_ORDERS_DL_DESCRIPTION",                                   "所有改良的 [ICON_RESOURCE_HORSES] 马与 [ICON_RESOURCE_IRON] 铁每回合额外产出3点资源。"),
    ...
    ("zh_Hans_CN",  "LOC_POLICY_PUBLIC_TRANSPORT_DESCRIPTION_XP2",                                   "区域若相邻拥有至少15 [ICON_Citizen] 公民的城市或社区，则+50%相邻加成；若与拥有至少15 [ICON_Citizen] 公民的城市或社区距离3个单元格，则提供等于相邻加成的 [ICON_GOLD] 金币。"),
    ...
    ("zh_Hans_CN",  "LOC_POLICY_CITY_CENTRALIZATION_DESCRIPTION",                                    "所有城市+2 [ICON_Food] 食物、+2 [ICON_Production] 生产力、+2 [ICON_SCIENCE] 科技值、+2 [ICON_CULTURE] 文化值、+2 [ICON_Faith] 信仰值和+4 [ICON_Gold] 金币。"),
    ...
    ("zh_Hans_CN",  "LOC_POLICY_TRIBUTE_TRADE_DESCRIPTION",                                          "所有商业区和港口每回合提供+1影响力点数。通往宗主城邦的 [ICON_TradeRoute] 贸易路线+3 [ICON_GOLD] 金币。"),
    ...
    ("zh_Hans_CN",  "LOC_POLICY_SPORTS_MEDIA_DESCRIPTION",                                           "+100%剧院广场相邻加成。来自娱乐区或水上乐园区域建筑的辐射范围增加3个单元格。"),
    ...
    ("zh_Hans_CN",  "LOC_POLICY_RAJ_DESCRIPTION_XP2",                                                "作为宗主国，从每个下属城邦获得+2 [ICON_Science] 科技值、+2 [ICON_Culture] 文化值、+2 [ICON_Faith] 信仰值和+2 [ICON_Gold] 金币。每个您占领的城市+2 [ICON_Science] 科技值、+2 [ICON_Culture] 文化值、+2 [ICON_Faith] 信仰值和+2 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_POLICY_MONASTICISM_DESCRIPTION",                                            "拥有圣地的城市 [ICON_Science] 科技值+75%。[NEWLINE]但所有城市的 [ICON_Culture] 文化值-25%。"),
    ("zh_Hans_CN",  "LOC_POLICY_INTERNATIONALISM_NAME",                                              "国际主义"),
    ...
    ("zh_Hans_CN",  "LOC_POLICY_SOCIAL_DARWINISM_DESCRIPTION",                                       "每个您占领的城市给每个您建立的城市提供+1 [ICON_SCIENCE] 科技值和+1 [ICON_CULTURE] 文化值。"),
    ("zh_Hans_CN",  "LOC_POLICY_WELL_FIELD_NAME",                                                    "井田制"),
