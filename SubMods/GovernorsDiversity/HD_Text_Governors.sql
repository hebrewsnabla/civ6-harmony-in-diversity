...
values
    ...
    ("LOC_GOVERNOR_PROMOTION_ZONING_COMMISSIONER_DESCRIPTION",                    "This city gets +20% [ICON_Production] Production towards wonders. When Wonders being built in this city, grant Great Engineer Points equal to 20% of the cost of the building."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_GOVERNOR_PROMOTION_ZONING_COMMISSIONER_DESCRIPTION",                    "城市在建造奇观时 [ICON_Production] 生产力+20%。此城市建成奇观后获得等同于其生产力20%的大工程师点数。"),
