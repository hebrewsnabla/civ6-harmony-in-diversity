...
values
    ...
    ("LOC_BELIEF_DIVINE_SPARK_DL_DESCRIPTION",                    "+2 [ICON_GreatPerson] Great Person Points from Holy Sites (Prophet), Campuses (Scientist), Theater Squares  (Writer), Industial Zones (Engineer) and Commercial Hubs (Merchant). Your capital can build 1 more district than the [ICON_CITIZEN] Population limit allows."),
    ...
    ("LOC_BELIEF_THE_PEOPLE_OF_POLAR_DL_DESCRIPTION",             "+! [ICON_PRODUCTION] Production, +2 [ICON_GOLD] Gold to Improvements over resource on Tundra or Tundra Hills."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_DIVINE_SPARK_DL_DESCRIPTION",                    "从圣地（大预言家）、学院（大科学家）、剧院广场（大作家）、工业区（大工程师）以及商业区（大商人）处获得的 [ICON_GreatPerson] 伟人点数+2。首都可以无视 [ICON_CITIZEN] 人口限制额外建造1个区域。"),
