...
values
    ...
    ("LOC_GAMEMODE_AITEST_NAME",                          "Testing Tech and AI Mode"),
    ("LOC_GAMEMODE_AITEST_DESCRIPTION",                   "[COLOR_Red]Inner Testing Usage Only, please do not enable[ENDCOLOR]. Mode for Testing, current testing mode contains tech tree and AI adjustments."),
