...
values
    ...
    -- 政府区
    ("zh_Hans_CN",  "LOC_BUILDING_GOV_TALL_DESCRIPTION",                         "所有城市+1 [ICON_Amenities] 宜居度、+2 [ICON_Housing] 住房、+15%人口增长速度。[NEWLINE]本城建造奇观、区域和建筑时+30% [ICON_Production] 生产力，可以无视 [ICON_CITIZEN] 人口限制额外建造1个区域。[NEWLINE]奖励1个 [ICON_Governor] 总督头衔。"),
