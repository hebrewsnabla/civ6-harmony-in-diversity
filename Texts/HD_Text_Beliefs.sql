...
values
    ...
    ("LOC_BELIEF_WORLD_CHURCH_DL_DESCRIPTION",                "+1 [ICON_Culture] Culture for every 3 followers of this Religion."),
    ("LOC_BELIEF_CROSS_CULTURAL_DIALOGUE_DL_DESCRIPTION",     "+1 [ICON_Science] Science for every 3 followers of this Religion."),
    ...
    ("LOC_BELIEF_PAPAL_PRIMACY_DL_DESCRIPTION",               "[ICON_ENVOY] Envoys spread +150 Religious Pressure. +1 or +2 [ICON_Envoy] Envoy at each City-State when it first adopts this Religion. City-States you are a suzerain of provide +2 [ICON_FAITH] Faith and +2 [ICON_GOLD] Gold."),
    ...
    ("LOC_BELIEF_DIVINE_INSPIRATION_DL_DESCRIPTION",          "All world wonders provide +5 [ICON_Faith] Faith. Each time you complete a Wonder, gain [ICON_Faith] Faith equal to 25% its production cost."),
    ...
    ("LOC_BELIEF_JESUIT_EDUCATION_DL_DESCRIPTION",            "Campus district buildings are 20% cheaper to purchase. May purchase Campus district buildings with [ICON_Faith] Faith. All Holy Site buildings +0.4 [ICON_Science] Science for each [ICON_Citizen] citizen in this city."),
    ...
    ("LOC_BELIEF_WORK_ETHIC_DL_DESCRIPTION",                  "+2 [ICON_Production] Production for all Districts (except City Center) if the city has a Holy Site district. Industrial Zone district buildings are 20% cheaper to purchase. May purchase Industrial Zone district buildings with [ICON_Faith] Faith."),
    ("LOC_BELIEF_PRACTICAL_APPLICATION_NAME",                 "Practical Application"),
    ("LOC_BELIEF_PRACTICAL_APPLICATION_DL_DESCRIPTION",       "Each [ICON_Citizen] citizen yields +3 [ICON_Gold] Gold if the city has a Holy Site. Commercial Hub district buildings are 20% cheaper to purchase. May purchase Commercial Hub district buildings with [ICON_Faith] Faith."),
    ...
    ("LOC_BELIEF_HOLY_WATERS_DL_DESCRIPTION",                 "+100% Holy Site district adjacency bonuses if it is adjacent to Coast or Lake tiles. Districts and on or next to Coast or Lake tiles provide +4 [ICON_Faith] Faith if the city has a Holy Site district. Harbor district buildings are 20% cheaper to purchase. May purchase Harbor district buildings with [ICON_Faith] Faith."),
    ...
    ("LOC_BELIEF_MOSQUE_DL_DESCRIPTION",                      "Allows construction of Mosques (+8 [ICON_Faith] Faith, Missionary and Apostles created here have +1 spread; All Religious units created in this city receive +3 [ICON_Strength] Combat Strength in religious combats)."),
    ...
    ("LOC_BELIEF_DAR_E_MEHR_DL_DESCRIPTION",                  "Allows construction of Dar-e Mehrs (+8 [ICON_Faith] Faith, +2 additional [ICON_FAITH] Faith for each era since constructed or last repaired; Gain a Missionary unit after finishing construction).");
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_WORLD_CHURCH_DL_DESCRIPTION",                "该宗教每有3个信徒则+1 [ICON_CULTURE] 文化值。"),
    ("zh_Hans_CN",  "LOC_BELIEF_CROSS_CULTURAL_DIALOGUE_DL_DESCRIPTION",     "该宗教每有3个信徒则+1 [ICON_Science] 科技值。"),
    ("zh_Hans_CN",  "LOC_BELIEF_CHURCH_PROPERTY_DL_DESCRIPTION",             "每个信奉该宗教的城市+8 [ICON_Gold] 金币。"),
    ("zh_Hans_CN",  "LOC_BELIEF_LAY_MINISTRY_DL_DESCRIPTION",                "每个信奉该宗教的城市+2 [ICON_Culture] 文化。"),
    ("zh_Hans_CN",  "LOC_BELIEF_PILGRIMAGE_DL_DESCRIPTION",                  "每个信奉该宗教的城市+4 [ICON_Faith] 信仰。"),
    ("zh_Hans_CN",  "LOC_BELIEF_STEWARDSHIP_DL_DESCRIPTION",                 "每个信奉该宗教的城市+2 [ICON_Science] 科技。"),
    -- ("zh_Hans_CN",  "LOC_PROMOTION_JUST_WAR_DESCRIPTION",                    "+{1_Value}教皇权威"),
    ("zh_Hans_CN",  "LOC_BELIEF_PAPAL_PRIMACY_DL_DESCRIPTION",               "将一个 [ICON_ENVOY]使者派遣至城邦后，将对该城邦施加150点宗教压力。除了城邦的任务外，城邦信教将自动向该城邦派遣1至2个 [ICON_Envoy] 使者。每个宗主的城邦提供+2 [ICON_FAITH] 信仰和+2 [ICON_GOLD] 金币。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_FEED_THE_WORLD_DL_DESCRIPTION",              "圣地中每座建筑提供+4 [ICON_FOOD] 食物，+2 [ICON_HOUSING] 住房。"),
    ("zh_Hans_CN",  "LOC_BELIEF_CHORAL_MUSIC_DL_DESCRIPTION",                "圣地中每座建筑提供+4 [ICON_CULTURE] 文化值。"),
    ("zh_Hans_CN",  "LOC_BELIEF_DIVINE_INSPIRATION_DL_DESCRIPTION",          "所有世界奇观+5 [ICON_Faith] 信仰值。完成世界奇观后返还等同于奇观所需产能25%的 [ICON_Faith] 信仰值。"),
    ("zh_Hans_CN",  "LOC_BELIEF_JESUIT_EDUCATION_DL_DESCRIPTION",            "圣地中每座建筑为每人口提供0.4 [ICON_Science] 科技值。购买学院区域内建筑的费用降低20%且可以用 [ICON_Faith] 信仰值购买。"),
