...
insert or replace into EnglishText
    (Tag,                                                                                   Text)
values
    ("LOC_TECH_SAILING_HD_DESCRIPTION",                                                     "Allows harvesting of Kelp Forest and resources improved by Fishing Boats. Allows Builders, Settlers and Traders to embark."),
...
insert or replace into LocalizedText
    (Language,      Tag,                                                                    Text)
values
    ("zh_Hans_CN",  "LOC_TECH_SAILING_HD_DESCRIPTION",                                      "允许收获海藻森林和由渔船改良的资源。允许建造者、开拓者和商人上船。"),
