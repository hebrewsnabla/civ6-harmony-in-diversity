...
values
    ...
    ("LOC_PROJECT_GRANT_RESOURCE_HORSES_HD_DESCRIPTION",                      "Once completed, instantly gain +20 [ICON_RESOURCE_HORSES] Horses."),
    ...
    ("LOC_PROJECT_GRANT_RESOURCE_IRON_HD_DESCRIPTION",                        "Once completed, instantly gain +20 [ICON_RESOURCE_IRON] Iron."),
    ("LOC_PROJECT_GRANT_RESOURCE_NITER_HD_NAME",                              "high explosives"),
    ("LOC_PROJECT_GRANT_RESOURCE_NITER_HD_SHORT_NAME",                        "high explosives"),
    ("LOC_PROJECT_GRANT_RESOURCE_NITER_HD_DESCRIPTION",                       "Once completed, instantly gain +20 [ICON_RESOURCE_NITER] Niter."),
    ("LOC_PROJECT_GRANT_RESOURCE_COAL_HD_NAME",                               "specialty fuels"),
    ("LOC_PROJECT_GRANT_RESOURCE_COAL_HD_SHORT_NAME",                         "specialty fuels"),
    ("LOC_PROJECT_GRANT_RESOURCE_COAL_HD_DESCRIPTION",                        "Once completed, instantly gain +20 [ICON_RESOURCE_COAL] Coal."),
    ("LOC_PROJECT_GRANT_RESOURCE_OIL_HD_NAME",                                "shale extraction"),
    ("LOC_PROJECT_GRANT_RESOURCE_OIL_HD_SHORT_NAME",                          "shale extraction"),
    ("LOC_PROJECT_GRANT_RESOURCE_OIL_HD_DESCRIPTION",                         "Once completed, instantly gain +20 [ICON_RESOURCE_OIL] Oil."),
    ...
    ("LOC_PROJECT_GRANT_RESOURCE_ALUMINUM_HD_DESCRIPTION",                    "Once completed, instantly gain +20 [ICON_RESOURCE_ALUMINUM] Aluminum."),
    ...
    ("LOC_PROJECT_GRANT_RESOURCE_URANIUM_HD_DESCRIPTION",                     "Once completed, instantly gain +20 [ICON_RESOURCE_URANIUM] Uranium.");
...
values
    ...
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_HORSES_HD_DESCRIPTION",                      "城市项目，项目完成后提供20点 [ICON_RESOURCE_HORSES] 马。"),
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_IRON_HD_NAME",                               "土制高炉"),
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_IRON_HD_SHORT_NAME",                         "土制高炉"),
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_IRON_HD_DESCRIPTION",                        "城市项目，项目完成后提供20点 [ICON_RESOURCE_IRON] 铁。"),
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_NITER_HD_NAME",                              "烈性炸药"),
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_NITER_HD_SHORT_NAME",                        "烈性炸药"),
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_NITER_HD_DESCRIPTION",                       "城市项目，项目完成后提供20点 [ICON_RESOURCE_NITER] 硝石。"),
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_COAL_HD_NAME",                               "特种燃料"),
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_COAL_HD_SHORT_NAME",                         "特种燃料"),
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_COAL_HD_DESCRIPTION",                        "城市项目，项目完成后提供20点 [ICON_RESOURCE_COAL] 煤。"),
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_OIL_HD_NAME",                                "页岩提取"),
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_OIL_HD_SHORT_NAME",                          "页岩提取"),
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_OIL_HD_DESCRIPTION",                         "城市项目，项目完成后提供20点 [ICON_RESOURCE_OIL] 石油。"),
    ...
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_ALUMINUM_HD_DESCRIPTION",                    "城市项目，项目完成后提供20点 [ICON_RESOURCE_ALUMINUM] 铝。"),
    ...
    ("zh_Hans_CN",  "LOC_PROJECT_GRANT_RESOURCE_URANIUM_HD_DESCRIPTION",                     "城市项目，项目完成后提供20点 [ICON_RESOURCE_URANIUM] 铀。");
