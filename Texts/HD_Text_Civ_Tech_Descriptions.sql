...
values
    ...
    -- ("LOC_CIVIC_MERCANTILISM_HD_DESCRIPTION",         "Camp improvements receive +2 [ICON_gold] Gold."),
    ...
    ("LOC_BOOST_TRIGGER_COMBUSTION_LEU_MO",           "Build two Stations."),
    ...
    ("LOC_BOOST_TRIGGER_ELECTRICITY_HD",              "Build two Dams"),
...
values
    ...
    ("zh_Hans_CN",  "LOC_CIVIC_COLONIALISM_HD_DESCRIPTION",          "从每个宗主城邦获得+1 [ICON_Favor] 外交支持。"),
    ...
    ("zh_Hans_CN",  "LOC_BOOST_TRIGGER_ELECTRICITY_HD",              "建造2座堤坝。"),
