...
values
    ...
    ("zh_Hans_CN",  "LOC_DISTRICT_AQUEDUCT_HD_DESCRIPTION",             "区域从相邻河流、湖泊、绿洲或山脉引水，为该城市提供淡水资源。没有淡水资源的城市最多获得6个 [ICON_Housing] 住房。相反，已有淡水资源的城市 [ICON_Housing] 住房数量+2；干旱时可防止 [ICON_Food] 食物损失。本城所有淡水或相邻蓄水池的农田+1 [ICON_FOOD] 食物。必须修建在与市中心相邻的单元格中。军事工程师可消耗1次使用次数来完成蓄水池30%的修建进度。每个城市只允许建造1个。"),
    ("zh_Hans_CN",  "LOC_DISTRICT_BATH_NAME_JNR_UC",                    "水渠"),
    ("zh_Hans_CN",  "LOC_DISTRICT_BATH_HD_DESCRIPTION",                 "促进城市发展的罗马特色区域。取代蓄水池，建造费用更低。提供+2 [ICON_Housing] 住房和+1 [ICON_Amenities] 宜居度，建造水渠中的建筑加速50%。[NEWLINE][NEWLINE]从相邻河流、湖泊、绿洲或山脉引水，为该城市提供淡水资源。尚未拥有淡水资源的城市最多获得6个 [ICON_Housing] 住房。已有淡水资源的城市则+2 [ICON_Housing] 住房。干旱时可防止 [ICON_Food] 食物损失。本城所有淡水或相邻水渠的农田+1 [ICON_FOOD] 食物。必须修建在与市中心相邻的单元格中。[NEWLINE]军事工程师可消耗1次使用次数来完成水渠30%的修建进度。每个城市只允许建造1个。"),
