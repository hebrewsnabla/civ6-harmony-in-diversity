...
values
    ...
    ("LOC_GOVERNOR_PROMOTION_MERCHANT_CONTRACTOR_DESCRIPTION",                    "+10% [ICON_Gold] Gold output for each Commercial and Harbor district building in the city."),
    ("LOC_GOVERNOR_PROMOTION_MERCHANT_MULTINATIONAL_CORP_NAME",                   "Multinational Corporations"),
    ("LOC_GOVERNOR_PROMOTION_MERCHANT_MULTINATIONAL_CORP_DESCRIPTION",            "Yields gained are doubled for international [ICON_TradeRoute] Trade Routes from the city when player has the 'Exploration' Civic."),
    -- Victor
    ...
    -- Magnus
    ("LOC_GOVERNOR_PROMOTION_RESOURCE_MANAGER_SURPLUS_LOGISTICS_DESCRIPTION",     "+20% Growth in the city. Domestic [ICON_TradeRoute] Trade Routes ending the city provide +4 [ICON_Food] Food to their starting city."),
    ...
    ("LOC_BUILDING_DUMMY_MAGNUS_DESCRIPTION",                                     "Created when Governor Magnus with the Elected Officer title establishes within 6 tiles."),
    ...
    ("LOC_GOVERNOR_PROMOTION_AQUACULTURE_DESCRIPTION",                            "+1 [ICON_Production] Production for all improved plots in the city ."),
    ...
    ("LOC_GOVERNOR_PROMOTION_LOCAL_INFORMANTS_DESCRIPTION",                       "In Amani's city: Spies act as +1 level and Spy operations take 25% less time."),
    ...
    ("LOC_GOVERNOR_PROMOTION_AMBASSADOR_PUPPETEER_DESCRIPTION",                   "While established in a city-state, doubles the number of [ICON_Envoy] Envoys you have there. Enemy Spy level reduced by 1 in the city-state. Your Spy level is increased by 1 for offensive operations in the city-state."),
