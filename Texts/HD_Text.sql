...
values
    ...
    ("LOC_ABILITY_IGNORE_HILLS_AND_FOREST_HD_DESCRIPTION",                    "Ignore [ICON_MOVEMENT] movement penalty from Hills, Forest and Jungle. (Terracotta Army)"),
...
values
    ...
    ("zh_Hans_CN",  "LOC_ABILITY_IGNORE_HILLS_AND_FOREST_HD_DESCRIPTION",                    "无视丘陵、森林和雨林带来的 [ICON_Movement] 移动力减益。 (兵马俑)"),
