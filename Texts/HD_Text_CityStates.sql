...
values
    ...
    ("LOC_LEADER_TRAIT_SAMARKAND_DESCRIPTION",            "Your Builders can now make Trading Dome improvements.[NEWLINE][NEWLINE]+2 [ICON_GOLD] Gold. Extra +2 [ICON_GOLD] Gold after discovring Civiv Medieval Faires. +2 [ICON_Gold] Gold to adjacent Luxury resource. Your outgoing international [ICON_TradeRoute] Trade Routes grant +2 [ICON_GOLD] Gold per Trading Dome at the origin. Cannot be built next to another Trading Dome."), -- +2 [ICON_Gold] Gold for every adjacent Luxury resource. 
...
values
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_SAMARKAND_DESCRIPTION",            "您的建造者现在能够建造圆顶市集改良设施。[NEWLINE][NEWLINE]+2 [ICON_GOLD] 金币。拥有“中世纪集市”后额外+2 [ICON_GOLD] 金币。每与一个奢侈品资源相邻则+2 [ICON_Gold] 金币。起源城市每有一座圆顶市集，对外国际贸易 [ICON_TradeRoute] 路线提供的 [ICON_GOLD] 金币便+2。无法建在另一座圆顶市集旁。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_SAMARKAND_BONUS",                  "您的建造者现在能够建造圆顶市集改良设施。[NEWLINE][NEWLINE]+2 [ICON_GOLD] 金币。拥有“中世纪集市”后额外+2 [ICON_GOLD] 金币。每与一个奢侈品资源相邻则+2 [ICON_Gold] 金币。起源城市每有一座圆顶市集，对外国际贸易 [ICON_TradeRoute] 路线提供的 [ICON_GOLD] 金币便+2。无法建在另一座圆顶市集旁。"),
