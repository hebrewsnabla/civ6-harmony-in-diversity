...
values
    ...
    ("LOC_BELIEF_THE_PEOPLE_OF_POLAR_DL_DESCRIPTION",             "City centers provide +1 [ICON_Food] Food and +1 [ICON_Faith] Faith for each adjacent Tundra or Tundra Hills tile. Cities having Tundra or Tundra Hills tiles provide +2 [ICON_GreatProphet] Great Prophet points per turn."),
