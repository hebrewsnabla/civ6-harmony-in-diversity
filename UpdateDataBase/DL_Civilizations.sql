...
values
	('HWARANG_ALLBUFF',				'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER',		'CITY_HAS_BUILDING_RESEARCH_LAB',0,0),
	('HWARANG_ALLDEBUFF',			'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER',		'CITY_HAS_NOT_ASSIGNED_GOVERNOR_AND_NON_CAPITAL',0,0),
	('HWARANG_LOYALTY',				'MODIFIER_PLAYER_CITIES_ADJUST_IDENTITY_PER_TURN', 			'CITY_HAS_ASSIGNED_GOVERNOR_OR_CAPITAL',0,0),
	('HWARANG_LOYALTY_DEBUFF',		'MODIFIER_PLAYER_CITIES_ADJUST_IDENTITY_PER_TURN', 			'CITY_HAS_NOT_ASSIGNED_GOVERNOR_AND_NON_CAPITAL',0,0),
	...
	('HWARANG_AMENITY_DEBUFF',		'MODIFIER_PLAYER_CITIES_ADJUST_TRAIT_AMENITY',				'CITY_HAS_NOT_ASSIGNED_GOVERNOR_AND_NON_CAPITAL',0,0),
	('SEWON_FOOD',					'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER',		'CITY_HAS_DISTRICT_SEOWON',0,0),
	('SEWON_PRODUCTION',			'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER',		'CITY_HAS_DISTRICT_SEOWON',0,0),
	('LIBRARY_DISTRICT_PRODUCTION',	'MODIFIER_PLAYER_CITIES_ADJUST_ALL_DISTRICTS_PRODUCTION',		'CITY_HAS_BUILDING_LIBRARY',0,0),
	('LIBRARY_BUILDING_PRODUCTION',	'MODIFIER_PLAYER_CITIES_ADJUST_ALLBUILDING_PRODUCTION_MODIFIER','CITY_HAS_BUILDING_LIBRARY',0,0),
	...
	('RESEARCHLAB_POP_FOOD',			'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_PER_POPULATION','CITY_HAS_BUILDING_RESEARCH_LAB',0,0),
	('RESEARCHLAB_POP_PRODUCTION',		'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_PER_POPULATION','CITY_HAS_BUILDING_RESEARCH_LAB',0,0),
	('RESEARCHLAB_POP_SCIENCE',			'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_PER_POPULATION','CITY_HAS_BUILDING_RESEARCH_LAB',0,0),
	('RESEARCHLAB_POP_CULTURE',			'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_PER_POPULATION','CITY_HAS_BUILDING_RESEARCH_LAB',0,0),
	('RESEARCHLAB_POP_GOLD',			'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_PER_POPULATION','CITY_HAS_BUILDING_RESEARCH_LAB',0,0),
	('RESEARCHLAB_POP_FAITH',			'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_PER_POPULATION','CITY_HAS_BUILDING_RESEARCH_LAB',0,0),
...
values
	...
	('REQUIRES_CITY_NOT_ASSIGNED_GOVERNOR', 'Established', 	0);
...
values
	...
	('CITY_HAS_NOT_ASSIGNED_GOVERNOR_AND_NON_CAPITAL',		'REQUIRES_CITY_NOT_ASSIGNED_GOVERNOR'),
