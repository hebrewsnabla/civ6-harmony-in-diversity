...
values
    ...
    ("LOC_TECH_IRRIGATION_DESCRIPTION",                                                     "Allows clearing of Marsh, and harvesting of resources improved by Plantations. Allows Builders to build Farms on Plains Hills or Grassland Hills adjacent to fresh water or Aqueduct."),
    ...
    ("LOC_TECH_ROBOTICS_HD_DESCRIPTION",                                                    "Pasture improvements +2 [ICON_Food] Food."),
    ("LOC_TECH_CYBERNETICS_HD_DESCRIPTION",                                                 "{Lumber Mill improvements +1 [ICON_Production] production}[NEWLINE]{LOC_TECH_CYBERNETICS_DESCRIPTION}"),
    ("LOC_TECH_SMART_MATERIALS_HD_DESCRIPTION",                                             "{Mine improvements +1 [ICON_Production] production}[NEWLINE]{LOC_TECH_SMART_MATERIALS_DESCRIPTION}"),
    -- New Civics
...
values
    ...
    ("zh_Hans_CN",  "LOC_TECH_SCIENTIFIC_THEORY_HD_DESCRIPTION",                            "种植园+1 [ICON_Food] 食物。渔场+1 [ICON_housing] 住房。"),
    ...
    ("zh_Hans_CN",  "LOC_CIVIC_MEDIEVAL_FAIRES_HD_DESCRIPTION",                             "种植园+2 [ICON_gold] 金币。[newline]牧场+1 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_CIVIC_FEUDALISM_HD_DESCRIPTION",                                   "现与2个农场相邻时，农场产出的 [ICON_Food] 食物+1。[NEWLINE]种植园提供的 [ICON_Food] 食物+1。[NEWLINE]拥有大学的学院从雨林获得额外标准相邻加成。[NEWLINE]近战单位获得能力：在森林或雨林中战斗时+3 [ICON_Strength] 战斗力。"),
    ("zh_Hans_CN",  "LOC_CIVIC_GUILDS_HD_DESCRIPTION",                                      "营地+1[ICON_production] 生产力。[newline]允许在雨林上建造伐木场和营地。[newline]允许建造者植树造林（人造林）。"),
