...
values
    ...
    ("LOC_FEATURE_BARRIER_REEF_DESCRIPTION",              "Two tile Natural Wonder that can be found on Coast tiles and provides +2 [ICON_Food] Food, +1 [ICON_Production] Production, +2 [ICON_Science] Science and +2 [ICON_Gold] Gold. Major adjacency bonus to Campus districts."),
    ("LOC_FEATURE_HA_LONG_BAY_DESCRIPTION",               "Two tile Natural Wonder that can be found on Coast tiles and provides +4 [ICON_FOOD] Food, +1 [ICON_PRODUCTION] Production, and +1 [ICON_CULTURE] Culture. +15 [ICON_Strength] Combat Strength when defending in this tile."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_FEATURE_LYSEFJORDEN_DESCRIPTION",               "海军战斗单位进入相邻格位后将获得升级。为邻近单元格+1 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_FEATURE_CRATER_LAKE_DESCRIPTION",               "占1个单元格的自然奇观。其外观为湖泊，提供+6 [ICON_Faith] 信仰值、+2 [ICON_Science] 科技值，以及淡水。"),
    ("zh_Hans_CN",  "LOC_FEATURE_BARRIER_REEF_DESCRIPTION",              "位于海岸地貌上、占2个单元格的自然奇观，提供+2 [ICON_Food] 食物，+1 [ICON_Production] 生产力，+2 [ICON_Science] 科技值和+2 [ICON_Gold] 金币。对学院区域提供大量相邻加成。"),
    ("zh_Hans_CN",  "LOC_FEATURE_HA_LONG_BAY_DESCRIPTION",               "占两个单元格的自然奇观，位于海岸地貌上。+4 [ICON_FOOD] 食物、+1 [ICON_PRODUCTION] 生产力、+1 [ICON_CULTURE] 文化。在此单元格中进行防御时+15 [ICON_Strength] 战斗力。"),
    ("zh_Hans_CN",  "LOC_FEATURE_DEAD_SEA_DESCRIPTION",                  "占2个单元格的湖泊自然奇观，提供+3 [ICON_Faith] 信仰值及+3 [ICON_Culture] 文化值。单位相邻死海时选择恢复一回合，可在此期间完全恢复。不提供淡水。"),
    ("zh_Hans_CN",  "LOC_FEATURE_LAKE_RETBA_DESCRIPTION",                "占2个单元格的湖泊自然奇观。提供+3 [ICON_CULTURE] 文化值、+2 [ICON_GOLD] 金币、+1 [ICON_FOOD] 食物、+1 [ICON_PRODUCTION] 生产力。不提供淡水。"),
    ("zh_Hans_CN",  "LOC_FEATURE_GOBUSTAN_DESCRIPTION",                  "占3个单元格的自然奇观，提供+3 [ICON_CULTURE] 文化值与+2 [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_FEATURE_EYE_OF_THE_SAHARA_XP2_DESCRIPTION",     "占3个单元格的自然奇观。+1 [ICON_PRODUCTION] 生产力，+3 [ICON_SCIENCE] 科技值，+1 [ICON_Faith] 信仰值。游戏进入原子能时代后额外+1 [ICON_PRODUCTION] 生产力、+1 [ICON_SCIENCE] 科技值。"),
