...
values
    ...
    ("LOC_BELIEF_HD_GOD_KING_DL_DESCRIPTION",                     "Palace provides +1 [ICON_FOOD] Food, +1 [ICON_PRODUCTION] Production, +1 [ICON_CULTURE] Culture, +1 [ICON_SCIENCE] Science, +1 [ICON_FAITH] Faith and +1 [ICON_GOLD] Gold. When chosen, recieve a [ICON_CITIZEN] Citizen in your [ICON_CAPITAL] capital and a free [ICON_ENVOY] envoy. +1 [ICON_AMENITIES] Amenity and +1 [ICON_HOUSING] Housing in your capital."),
