...
values
    ...
    ("LOC_CITY_POLICY_REVISION_ALMANAC_EFFECT",                       "Aqueduct Project. If this city has and Aqueduct, each Plantation and Farm with any resource +1 [ICON_SCIENCE] Science in this city, but -6 [ICON_GOLD] Gold per turn."),
    ("LOC_CITY_POLICY_FREIGHT",                                       "Freight"),
    ("LOC_CITY_POLICY_FREIGHT_EFFECT",                                "Commercial Hub Project. Consumes 2 [ICON_RESOURCE_HORSES] Horses per turn, the Commercial Hub in this city provides 6 [ICON_PRODUCTION] Production."),
    ("LOC_CITY_POLICY_FORGING_IRON",                                  "Forging Iron"),
    ("LOC_CITY_POLICY_FORGING_IRON_EFFECT",                           "Industrial Zone Project. Consumes 2 [ICON_RESOURCE_IRON] Iron per turn, the Industrial Zone in this city provides 8 [ICON_PRODUCTION] Production.");
...
values
    ...
    ("zh_Hans_CN",  "LOC_CITY_POLICY_REVISION_ALMANAC_EFFECT",                       "水渠项目。若此城拥有水渠，城市中每个种植园和改良资源的农场+1 [ICON_SCIENCE] 科技值，但该城市-6 [ICON_GOLD] 金币。"),
    ("zh_Hans_CN",  "LOC_CITY_POLICY_FREIGHT",                                       "货运"),
    ("zh_Hans_CN",  "LOC_CITY_POLICY_FREIGHT_EFFECT",                                "商业中心项目。每回合消耗 2 [ICON_RESOURCE_HORSES] 马，此城拥有的商业中心提供+6 [ICON_PRODUCTION] 生产力。"),
    ("zh_Hans_CN",  "LOC_CITY_POLICY_FORGING_IRON",                                  "锻铁"),
    ("zh_Hans_CN",  "LOC_CITY_POLICY_FORGING_IRON_EFFECT",                           "工业区项目。每回合消耗 2 [ICON_RESOURCE_IRON] 铁，此城拥有的工业区提供+8 [ICON_PRODUCTION] 生产力。");
