...
values
    ...
    ("LOC_BUILDING_JNR_MANUFACTURY_DESCRIPTION",        "+1 [ICON_Production] Production and +2 [ICON_Gold] Gold for bonus and luxury resources."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_JNR_MANUFACTURY_DESCRIPTION",                 "本城的加成和奢侈资源+1 [ICON_Production] 生产力和+2 [ICON_Gold] 金币。"),
