...
values
    ...
    ("LOC_BELIEF_WORK_ETHIC_DL_DESCRIPTION",                  "+2 [ICON_Production] Production for all Speciality Districts. +1% [ICON_Production] Production for each citizen following this religion in the city. May purchase Industrial Zone district buildings with [ICON_Faith] Faith."),
    ("LOC_BELIEF_PRACTICAL_APPLICATION_NAME",                 "Practical Application"),
    ("LOC_BELIEF_PRACTICAL_APPLICATION_DL_DESCRIPTION",       "Each [ICON_Citizen] citizen yields +1.5 [ICON_Gold] Gold. +2% [ICON_Gold] Gold for each citizen following this religion in the city."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_WORK_ETHIC_DL_DESCRIPTION",                  "专业化区域+2 [ICON_Production] 生产力，城市中每个信仰此宗教的居民将使 [ICON_Production] 生产力+1%，可以使用 [ICON_Faith] 信仰值购买工业区内的建筑。"),
    ("zh_Hans_CN",  "LOC_BELIEF_PRACTICAL_APPLICATION_NAME",                 "经世致用"),
    ("zh_Hans_CN",  "LOC_BELIEF_PRACTICAL_APPLICATION_DL_DESCRIPTION",       "城市中每 [ICON_Citizen] 人口提供+1.5 [ICON_Gold] 金币，每个信仰此宗教的居民将使 [ICON_Gold] 金币+2%。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_ABBOT_DL_DESCRIPTION",                       "圣地区域+2 [ICON_Production] 生产力。圣地区域和神社为相邻的单元格提供+1 [ICON_Production] 生产力。"),
