...
values
    ...
    ('GREAT_PERSON_INDIVIDUAL_IBN_KHALDUN_EMPIRE_JOYFUL_SCIENCE',       'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_YIELD_BAB',    1,  1),
    ('GREAT_PERSON_INDIVIDUAL_IBN_KHALDUN_EMPIRE_JOYFUL_CULTURE',       'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_YIELD_BAB',    1,  1),
    ('GREAT_PERSON_INDIVIDUAL_IBN_KHALDUN_EMPIRE_JOYFUL_PRODUCTION',    'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_YIELD_BAB',    1,  1),
    ('GREAT_PERSON_INDIVIDUAL_IBN_KHALDUN_EMPIRE_JOYFUL_GOLD',          'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_YIELD_BAB',    1,  1),
    ('GREAT_PERSON_INDIVIDUAL_IBN_KHALDUN_EMPIRE_JOYFUL_FAITH',         'MODIFIER_PLAYER_CITIES_ADJUST_HAPPINESS_YIELD_BAB',    1,  1);
