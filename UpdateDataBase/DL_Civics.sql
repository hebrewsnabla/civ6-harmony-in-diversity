...
values
	...
	('CIVIC_DIPLOMATIC_SERVICE',					'CIVIC_AWARD_ONE_INFLUENCE_TOKEN'),
	('CIVIC_HUMANISM',								'CIVIC_AWARD_ONE_INFLUENCE_TOKEN'),
	
		-- 2使者
	('CIVIC_MILITARY_TRAINING',						'CIVIC_AWARD_TWO_INFLUENCE_TOKENS'),
	('CIVIC_DIVINE_RIGHT',							'CIVIC_AWARD_TWO_INFLUENCE_TOKENS'),
	('CIVIC_NAVAL_TRADITION',						'CIVIC_AWARD_TWO_INFLUENCE_TOKENS'),
	('CIVIC_EVOLUTION_THEORY_HD',					'CIVIC_AWARD_TWO_INFLUENCE_TOKENS'),
	('CIVIC_ETHICS_HD',								'CIVIC_AWARD_TWO_INFLUENCE_TOKENS'),
		-- 3使者
	('CIVIC_NATIONALISM',							'CIVIC_AWARD_THREE_INFLUENCE_TOKENS'),
	('CIVIC_OPERA_BALLET',							'CIVIC_AWARD_THREE_INFLUENCE_TOKENS'),
	('CIVIC_NATURAL_HISTORY',						'CIVIC_AWARD_THREE_INFLUENCE_TOKENS'),
	('CIVIC_SCORCHED_EARTH',						'CIVIC_AWARD_THREE_INFLUENCE_TOKENS'),
...
update Civics set Cost = 45 where CivicType = 'CIVIC_CRAFTSMANSHIP';
update Civics set Cost = 45 where CivicType = 'CIVIC_FOREIGN_TRADE';
