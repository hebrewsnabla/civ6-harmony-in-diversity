...
values
    ...
    ('TRAIT_CIVILIZATION_TA_SETI',  'TRAIT_BONUS_MINE_PRODUCTION_PERCENTAGE');
...
values
    ...
    ('TRAIT_BONUS_MINE_PRODUCTION_PERCENTAGE',      'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER',    'HD_CITY_HAS_IMPROVED_RESOURCE_COPPER_REQUIRMENTS'),
...
values  
    ...
    ('TRAIT_BONUS_MINE_PRODUCTION_PERCENTAGE',      'YieldType',    'YIELD_PRODUCTION'),
    ('TRAIT_BONUS_MINE_PRODUCTION_PERCENTAGE',      'Amount',       10),
