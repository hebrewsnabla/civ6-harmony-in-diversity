...
--谒见厅奇观、建筑加速
	('GOV_TALL_BUILDING_PRODUCTION',			'MODIFIER_SINGLE_CITY_ADJUST_BUILDING_PRODUCTION_MODIFIER',			NULL),
--谒见厅区域加速
	('GOV_TALL_DISTRICT_PRODUCTION',			'MODIFIER_SINGLE_CITY_ADJUST_DISTRICT_PRODUCTION_MODIFIER',			NULL),
--谒见厅区域使者
...
--谒见厅奇观、建筑加速
	('GOV_TALL_BUILDING_PRODUCTION',			'Amount',		30),
--谒见厅区域加速
	('GOV_TALL_DISTRICT_PRODUCTION',			'Amount',		30),
--谒见厅区域使者
