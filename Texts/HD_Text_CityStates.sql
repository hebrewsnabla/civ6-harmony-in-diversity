...
values
    ...
    ("LOC_LEADER_TRAIT_BABYLON_DESCRIPTION",              "+1 [ICON_SCIENCE] Science from cities on Hills. Campus recieves a standard adjacency bonus from Hills."), -- Campus provides +4 Great Writer points per turn.
...
values
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_BABYLON_DESCRIPTION",              "丘陵上的城市+1 [ICON_SCIENCE] 科技值。学院从丘陵获得标准相邻加成。"), -- 学院提供+4 [ICON_GreatWork_WRITING] 大作家点数
