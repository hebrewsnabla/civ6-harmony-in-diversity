...
values
    ...
    ("LOC_PROMOTION_SPY_SPIN_WEB_DESCRIPTION",                                  "+1 spy partner, because you're a spy with a long history."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_PROMOTION_SPY_SPIN_WEB_DESCRIPTION",                               "你是身经百战的特工，已培养一名间谍搭档。"),    
