...
values
	...
	("GOVERNOR_PROMOTION_CAPOU_AGHA",		"GRAND_VISIER_ALLIANCE_COMBAT_STRENGTH"),
	("GOVERNOR_PROMOTION_GRAND_VISIER",		"PASHA_BONUS_UNIT_PRODUCTION"),
	("GOVERNOR_PROMOTION_GRAND_VISIER",		"CAPOU_AGHA_EXTRA_MELEE_AND_SIEGE");
insert or replace into Modifiers
	(ModifierId,                                            	ModifierType)
values
	("HD_MILITARY_RESEARCH_UNIT_TRAIN_GRANT_SCIENCE_TIME",  	"MODIFIER_SINGLE_CITY_GRANT_YIELD_PER_UNIT_COST"),
	("HEAD_FALCONER_ENCAMPMENT_BUILDINGS_PRODUCTION_MODIFIER",	"MODIFIER_SINGLE_CITY_ADJUST_BUILDING_PRODUCTION");
insert or replace into Modifiers
	(ModifierId,                                            	ModifierType,										SubjectRequirementSetId)
values
...
insert or replace into ModifierArguments
	(ModifierId,                                            	Name,                   	Type,                Value)
values
	("HD_MILITARY_RESEARCH_UNIT_TRAIN_GRANT_SCIENCE_TIME",  	"YieldType",           		"ARGTYPE_IDENTITY",	"YIELD_SCIENCE"),
	("HD_MILITARY_RESEARCH_UNIT_TRAIN_GRANT_SCIENCE_TIME",  	"UnitProductionPercent",	"ARGTYPE_IDENTITY",	25),
	("HEAD_FALCONER_ENCAMPMENT_BUILDINGS_PRODUCTION_MODIFIER",	"DistrictType",				"ARGTYPE_IDENTITY",	"DISTRICT_ENCAMPMENT"),
	("HEAD_FALCONER_ENCAMPMENT_BUILDINGS_PRODUCTION_MODIFIER",	"Amount",					"ARGTYPE_IDENTITY",	30),
	("HEAD_FALCONER_ENCAMPMENT_SCIENCE_BONUS1",					"YieldType",				"ARGTYPE_IDENTITY",	"YIELD_SCIENCE"),
	("HEAD_FALCONER_ENCAMPMENT_SCIENCE_BONUS1",					"Amount",					"ARGTYPE_IDENTITY",	3),
	("HEAD_FALCONER_BARRACKS_STABLE_SCIENCE_BONUS1",			"YieldType",				"ARGTYPE_IDENTITY",	"YIELD_SCIENCE"),
	("HEAD_FALCONER_BARRACKS_STABLE_SCIENCE_BONUS1",			"Amount",					"ARGTYPE_IDENTITY",	3),
	("HEAD_FALCONER_ARMORY_SCIENCE_BONUS1",						"YieldType",				"ARGTYPE_IDENTITY",	"YIELD_SCIENCE"),
	("HEAD_FALCONER_ARMORY_SCIENCE_BONUS1",						"Amount",					"ARGTYPE_IDENTITY",	3),
	("HEAD_FALCONER_MILITARY_ACADEMY_SCIENCE_BONUS1",			"YieldType",				"ARGTYPE_IDENTITY",	"YIELD_SCIENCE"),
	("HEAD_FALCONER_MILITARY_ACADEMY_SCIENCE_BONUS1",			"Amount",					"ARGTYPE_IDENTITY",	3);
