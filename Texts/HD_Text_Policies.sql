...
values
    ...
    ("LOC_POLICY_PURITAN_DESCRIPTION",                                                "+10% [ICON_GOLD] Gold and 10% [ICON_Production] Production in all cities with a Worship Building."),
    ("LOC_POLICY_SCIENTIFIC_EXPEDITIONS_NAME",                                        "Scientific Expeditions"),
    ("LOC_POLICY_SCIENTIFIC_EXPEDITIONS_DESCRIPTION",                                 "Every Commercial Hub district in a foreign city +3 [ICON_SCIENCE] Science to every cities on your original [ICON_Capital] Capital's continent. Every Harbor district in a foreign city +3 [ICON_Culture] Culture to every cities on your original [ICON_Capital] Capital's continent."),
    ...
    ("LOC_POLICY_ART_PATRONS_DESCRIPTION",                                            "+30% [ICON_PRODUCTION] Production toward Theather Square buildings and Commercial Hub buildings."),
    ("LOC_POLICY_HISTORICAL_PROGRESS_NAME",                                           "Historical Progress"),
    ("LOC_POLICY_HISTORICAL_PROGRESS_DESCRIPTION",                                    "+30% [ICON_PRODUCTION] Production toward Campus buildings and Industrial Zone buildings."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_POLICY_PURITAN_DESCRIPTION",                                                "拥有祭祀建筑的城市+10% [ICON_GOLD] 金币和10% [ICON_Production] 生产力。"),
    ("zh_Hans_CN",  "LOC_POLICY_SCIENTIFIC_EXPEDITIONS_NAME",                                        "科学考察队"),
    ("zh_Hans_CN",  "LOC_POLICY_SCIENTIFIC_EXPEDITIONS_DESCRIPTION",                                 "与 [ICON_Capital] 首都不在同一大陆的城市中的每个商业中心或港口分别为与 [ICON_Capital] 首都处于同一大陆的城市+3 [ICON_SCIENCE] 科技值或+3 [ICON_Culture] 文化值。"),
    ...
    ("zh_Hans_CN",  "LOC_POLICY_ART_PATRONS_DESCRIPTION",                                            "建造剧院广场和商业中心内的建筑时+30% [ICON_PRODUCTION] 建造速度。"),
    ("zh_Hans_CN",  "LOC_POLICY_HISTORICAL_PROGRESS_NAME",                                           "历史进步"),
    ("zh_Hans_CN",  "LOC_POLICY_HISTORICAL_PROGRESS_DESCRIPTION",                                    "建造工业区和学院内的建筑时+30% [ICON_PRODUCTION] 建造速度。"),
    ...
    ("zh_Hans_CN",  "LOC_POLICY_PUBLIC_TRANSPORT_DESCRIPTION_XP2",                                   "市中心为相邻的圣地、学院、剧院广场、商业中心、港口或工业区+100%相邻加成；为距离2个单元格的这些区域提供+1 [ICON_Housing] 住房；为距离3个单元格的这些区域提供等于相邻加成的 [ICON_GOLD] 金币。"),
