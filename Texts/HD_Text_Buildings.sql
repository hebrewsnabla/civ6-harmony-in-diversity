...
values
    ...
    -- Government
    ("LOC_BUILDING_GOV_TALL_DESCRIPTION",                         "+1 [ICON_Amenities] Amenity, +2 [ICON_Housing] Housing and +15% Growth rate in all cities.[NEWLINE]+30% construction speed towards wonders, districts and buildings in this city, and can build 1 more district than the [ICON_CITIZEN] Population limit allows.[NEWLINE]Awards +1 [ICON_Governor] Governor Title."),
    ...
    ("LOC_BUILDING_HD_WORLD_PARLIAMENT_HEADQUARTERS_DESCRIPTION", "Building unique to America. +1 Wildcard Policy Slot. +3 Dipolomatic Victory Point. +50% Influence points. +1 Diplomatic visibility towards all civilizations. Accumulates 2 extra Alliance Points per turn. Double bonus of [ICON_TRADEROUTE] Trade Routes from alliances. If you are the suzerain of at least 3 City States of the same type, all of your cities receive +10% of the respective yield.Your Spy level is increased by 3 for all offensive operations，enemy Spy level reduced by 3 in your lands"),
    ...
    ("LOC_BUILDING_HD_MONASTERY_DESCRIPTION",                     "+1 [ICON_CULTURE] Culture to adjacent Charming tiles, and additionally extra +1 [ICON_SCIENCE] Science to adjacent Breathtaking tiles. "),
    ...
    ("LOC_BUILDING_SANCTUARY_DESCRIPTION",                        "+1 [ICON_FOOD] Food to all Forest tiles in this city. +2 [ICON_GOLD] Gold to Charming Forest tiles in this city. Extra +1 [ICON_CULTURE] Culture to Breathtaking Forest tiles in this city.[NEWLINE][NEWLINE]Can only be built on or adjacent to Forest or Forest Natural Wonder tiles."),
    ("LOC_BUILDING_HD_JUNGLE_PRESERVE_NAME",                      "Jungle Conservation Department"),
    ("LOC_BUILDING_HD_JUNGLE_PRESERVE_DESCRIPTION",               "+1 [ICON_PRODUCTION] Production to all Rainforest tiles in this city. +2 [ICON_GOLD] Gold to Charming Rainforest tiles in this city. Extra +1 [ICON_SCIENCE] Science to Resources on Breathtaking Rainforest tiles in this city.[NEWLINE][NEWLINE]Can only be built on or adjacent to Rainforest or Rainforest Natural Wonder tiles."),
    ("LOC_BUILDING_HD_WETLANDS_PRESERVE_NAME",                    "Wetlands Conservation"),
    ("LOC_BUILDING_HD_WETLANDS_PRESERVE_DESCRIPTION",             "+1 [ICON_PRODUCTION] Production to all Floodplain, Marsh or Swamp, and Oasis tiles in this city. +2 [ICON_GOLD] Gold to Charming Floodplain, Marsh or Swamp, and Oasis tiles. Extra +1 [ICON_SCIENCE] Science to  Breattaking Floodplain, Marsh or Swamp, and Oasis tiles in this city.[NEWLINE][NEWLINE]Can only be built on or adjacent to Floodplain, Marsh, Swamp, Oasis tiles or Wetland Natural Wonder tiles."),
    ("LOC_BUILDING_HD_WATER_PRESERVE_NAME",                       "Hydrology Conservation Department"),
    ("LOC_BUILDING_HD_WATER_PRESERVE_DESCRIPTION",                "+2 [ICON_GOLD] Gold to all Coast and Lake tiles in this city. +1 [ICON_CULTURE] Culture to Features and +1 +1 [ICON_PRODUCTION] Production to Resources on Coast and Lake tiles.[NEWLINE][NEWLINE]Can only be built adjacent to Lake and Coast tiles, or Lake and Coast Natural Wonder tiles."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_STAVE_CHURCH_DESCRIPTION",                     "挪威特色建筑。取代寺庙。允许使用 [ICON_Faith] 信仰值购买开拓者。允许购买使徒、上师、审判官，拥有特定信仰还可购买武僧（这些宗教单位只能通过 [ICON_Faith] 信仰值购买）。圣地可从树林获得额外的标准相邻加成。城市中每个森林单元格+1 [ICON_Food] 食物。本城的 [ICON_Faith] 信仰值+5%。"), --+1 [ICON_TradeRoute] 贸易路线容量。
    ...
    -- 政府区
    ("zh_Hans_CN",  "LOC_BUILDING_GOV_TALL_DESCRIPTION",                         "所有城市+1 [ICON_Amenities] 宜居度、+2 [ICON_Housing] 住房、+15%人口增长速度。[NEWLINE]本城建造奇观、区域和建筑时加速30%，可以无视 [ICON_CITIZEN] 人口限制额外建造1个区域。[NEWLINE]奖励1个 [ICON_Governor] 总督头衔。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_HD_WORLD_PARLIAMENT_HEADQUARTERS_DESCRIPTION", "美国特色建筑。+1通配符政策槽位。+3外交胜利点数。+50%影响力点数。对所有文明+1 [ICON_VISLIMITED] 外交能见度。所有盟友的同盟点数每回合额外增加2点。来自同盟的 [ICON_TRADEROUTE] 贸易路线收益翻倍。对于每一类城邦，若你是其中至少3个的宗主国，所有城市此类城邦对应的产出+10%。我方间谍出击时+3级成功率，领土内的敌方间谍下降3级。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_HD_MONASTERY_DESCRIPTION",                     "相邻的迷人单元格+1 [ICON_CULTURE] 文化值。相邻的惊艳单元格额外+1 [ICON_SCIENCE] 科技值。"),
    ...
    ("zh_Hans_CN",  "LOC_BUILDING_HD_WATER_PRESERVE_DESCRIPTION",                "本城的湖泊或海岸单元格+2 [ICON_GOLD] 金币，这些单元格上的地貌+1 [ICON_CULTURE] 文化值，资源+1 [ICON_PRODUCTION] 生产力。[NEWLINE][NEWLINE]只能建造在相邻湖泊或海岸（包括水域或海岸类自然奇观）的单元格上。"),
