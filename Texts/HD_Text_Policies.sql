...
values
    ...
    ("LOC_POLICY_CHARISMATIC_LEADER_DESCRIPTION",                                     "Open Borders with all city-states. +3 Influence points per turn and +1 Influence point per turn for Diplomatic Quarter, Consulate and Chancery."),
    ("LOC_POLICY_DIPLOMATIC_LEAGUE_DESCRIPTION",                                      "Open Borders with all city-states. +3 Influence points per turn and +2 Influence points per turn for Diplomatic Quarter, Consulate and Chancery."),
    ("LOC_POLICY_GUNBOAT_DIPLOMACY_DESCRIPTION",                                      "Open Borders with all city-states. +3 Influence points per turn and +3 Influence points per turn for Diplomatic Quarter, Consulate and Chancery."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_POLICY_CHARISMATIC_LEADER_DESCRIPTION",                                     "开放所有城邦的边境，影响力点数每回合+3，外交区、领事馆、外交办提供的影响力点数每回合+1。"),
    ("zh_Hans_CN",  "LOC_POLICY_DIPLOMATIC_LEAGUE_DESCRIPTION",                                      "开放所有城邦的边境，影响力点数每回合+3，外交区、领事馆、外交办提供的影响力点数每回合+2。"),
    ("zh_Hans_CN",  "LOC_POLICY_GUNBOAT_DIPLOMACY_DESCRIPTION",                                      "开放所有城邦的边境，影响力点数每回合+3，外交区、领事馆、外交办提供的影响力点数每回合+3。"),
