...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_WORK_ETHIC_DL_DESCRIPTION",                  "专业化区域+2 [ICON_Production] 生产力，城市中每个信仰此宗教的居民将使 [ICON_Production] 生产力+1%，可以使用 [ICON_Faith] 信仰值购买工业区区域建筑。"),
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_MESSIAH_DL_DESCRIPTION",                     "购买圣地中建筑的费用降低10%且可以用 [ICON_Faith] 信仰值购买。建造圣地中建筑时+30%建造速度。每个圣地建筑提供+5% [ICON_Faith] 信仰值。"),
