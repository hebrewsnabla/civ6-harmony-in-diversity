...
values
	...
	("LOC_GREAT_PERSON_INDIVIDUAL_HD_ALI_MUGHAYAT_SYAH_NAME",			  "Ali Mughayat Syah"),
	...
	("LOC_GREAT_PERSON_INDIVIDUAL_HD_CROESUS_ACTIVE",					  "Instantly builds a Market in this district.[NEWLINE]Market provide +3 [ICON_GOLD] Gold."),
	("LOC_GREAT_PERSON_INDIVIDUAL_HD_SANG_HONGYANG_ACTIVE",				  "Instantly builds a Mint in this district.[NEWLINE]Mint provides an extra +1 [ICON_CULTURE] Culture with its regional effect."),
	("LOC_MARCO_POLO_NOTHING",				  			 				  "Triggers the [ICON_CIVICBOOSTED] Inspiration of 'Exploration' Civic."),
	("LOC_PIERO_DE_BARDI_COMMERCIAL_ATTACH",				  			  "+1 [ICON_ENVOY] Envoy each time you complete a Commercial Hub afterwards."),
...
values
	...
	("zh_Hans_CN",  "LOC_COLAEUS_SETTLER_MOVEMENT_ATTACH",								  "开拓者+1 [ICON_MOVEMENT] 移动力。"),
	...
	("zh_Hans_CN",  "LOC_GREAT_PERSON_INDIVIDUAL_HD_CROESUS_ACTIVE",					  "立即在该区域建造1座市场。[NEWLINE]所有市场+3 [ICON_GOLD] 金币。"),
	("zh_Hans_CN",  "LOC_GREAT_PERSON_INDIVIDUAL_HD_SANG_HONGYANG_ACTIVE",				  "立即在该区域建造1座铸币厂。[NEWLINE]铸币厂额外辐射1 [ICON_CULTURE] 文化值。"),
	("zh_Hans_CN",  "LOC_MARCO_POLO_NOTHING",				  			 	  			  "触发“探索”市政的 [ICON_CIVICBOOSTED] 鼓舞。"),
	("zh_Hans_CN",  "LOC_PIERO_DE_BARDI_COMMERCIAL_ATTACH",				  			 	  "此后每建成1个商业中心便获得1个 [ICON_ENVOY] 使者。"),
...
insert or replace into EnglishText
    (Tag,                                                        Text)
values
    ("LOC_GREATPERSON_MOVEMENT_AOE_KEQING",                      "+1 [ICON_MOVEMENT] Movement to all land units within 2 tiles."),
    ...
    ("LOC_GREAT_PERSON_INDIVIDUAL_ZHANGHAN_NAME",                "Zhang Han"),
    ...
    ("LOC_MENGYI_GOVERNORS",                                     "Grant 1 [ICON_GOVERNOR] Governor Title or recruit a new [ICON_GOVERNOR] Governor."),
    ("LOC_WANGJIAN_HILLS",                                       "All land units ignore [ICON_MOVEMENT] movement penalty from Hills."),
    ("LOC_WANGBEN_WALL_TEXT",                                    "Combat Strength vs. District defenses"),
    ("LOC_WANGBEN_WALL",                                         "All land units gain +3 [ICON_STRENGTH] Combat Strength against district defenses."),
    ("LOC_ZHANGHAN_STRENGTH_TEXT",                               "Combat Strength vs. Free Cities"),
    ("LOC_ZHANGHAN_STRENGTH_1_TEXT",                             "Combat Strength vs. Barbarians"),
    ("LOC_ZHANGHAN_STRENGTH",                                    "+5 [ICON_STRENGTH] Combat Strength when fighting Free Cities or Barbarians."),
...
insert or replace into LocalizedText
    (Language,      Tag,                                                                 Text)
values
    ("zh_Hans_CN",  "LOC_GREATPERSON_MOVEMENT_AOE_KEQING",                               "在两个单元格以内，为所有陆地单位+1 [ICON_MOVEMENT] 移动力。"),
    ("zh_Hans_CN",  "LOC_UNIT_KEQING_NAME",                                              "客卿"),
    ("zh_Hans_CN",  "LOC_ABILITY_KEQING_AOE_MOVEMENT_DESCRIPTION",                       "客卿提供+1 [ICON_Movement] 移动力。"),
    ...
    ("zh_Hans_CN",  "LOC_GREAT_PERSON_INDIVIDUAL_ZHANGHAN_NAME",                         "章邯"),
    ...
    ("zh_Hans_CN",  "LOC_MENGYI_GOVERNORS",                                              "提供1个 [ICON_GOVERNOR] 总督头衔或新招募1名 [ICON_GOVERNOR] 总督。"),
    ("zh_Hans_CN",  "LOC_WANGJIAN_HILLS",                                                "所有陆地单位无视丘陵对 [ICON_MOVEMENT] 移动力的减益。"),
    ("zh_Hans_CN",  "LOC_WANGBEN_WALL_TEXT",                                             "与区域防御战斗"),
    ("zh_Hans_CN",  "LOC_WANGBEN_WALL",                                                  "攻击区域防御时，所有陆地单位+3 [ICON_STRENGTH] 战斗力。"),
    ("zh_Hans_CN",  "LOC_ZHANGHAN_STRENGTH_TEXT",                                        "与自由城市战斗"),
    ("zh_Hans_CN",  "LOC_ZHANGHAN_STRENGTH_1_TEXT",                                      "与蛮族战斗"),
    ("zh_Hans_CN",  "LOC_ZHANGHAN_STRENGTH",                                             "与自由城市或蛮族单位作战时+5 [ICON_STRENGTH] 战斗力。"),
