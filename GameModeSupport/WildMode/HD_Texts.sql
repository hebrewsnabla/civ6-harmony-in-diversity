...
insert or replace into LocalizedText
    (Language,      Tag,                                                     Text)
values
    ("zh_Hans_CN",  "LOC_MOMENT_CATEGORY_SCIENTIFIC_BONUS_GOLDEN_AGE",      "“自由探索”黄金时代：[NEWLINE][ICON_CivicBoosted]鼓舞额外提供10%的科技开销。城市每拥有1处特色区域，则+2 [ICON_Science] 科技值。港口提供等同于金币的科技。"),
