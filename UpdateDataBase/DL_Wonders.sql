...
values
	...
	('BUILDING_STATUE_LIBERTY',			'STATUE_OF_LIBERTY_SEAPORT');
insert or replace into Modifiers
	(ModifierId,								ModifierType,												SubjectRequirementSetId)
values
	...
	('STATUE_OF_LIBERTY_SEAPORT',				'MODIFIER_PLAYER_CITIES_GRANT_BUILDING_IN_CITY_IGNORE',		null);
insert or replace into ModifierArguments
	(ModifierId,								Name,				Value)
values
	...
	('STATUE_OF_LIBERTY_SEAPORT',				'BuildingType',		'BUILDING_SEAPORT');
