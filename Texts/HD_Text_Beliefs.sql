...
values
    ...
    ("LOC_BELIEF_FEED_THE_WORLD_DL_DESCRIPTION",              "Shrines and Altars provide +3 [ICON_FOOD] Food and +2 [ICON_HOUSING] Housing. Temples, Churches, Hospitiums, Gardens and Worship buildings provide +6 [ICON_FOOD] Food and +2 [ICON_HOUSING] Housing."),
    ("LOC_BELIEF_CHORAL_MUSIC_DL_DESCRIPTION",                "Shrines and Altars provide +3 [ICON_CULTURE] Culture. Temples, Churches, Hospitiums, Gardens and Worship buildings provide +6 [ICON_CULTURE] Culture."),
    ("LOC_BELIEF_DIVINE_INSPIRATION_DL_DESCRIPTION",          "All world wonders provide +4 [ICON_Faith] Faith. Each time you complete a Wonder, gain [ICON_Faith] Faith equal to 50% its production cost."),
    ...
    ("LOC_BELIEF_JESUIT_EDUCATION_DL_DESCRIPTION",            "Campus district buildings are 20% cheaper to purchase. May purchase Campus district buildings with [ICON_FAITH] Faith. Shrines and Altars provide +0.3 [ICON_SCIENCE] Science for each [ICON_CITIZEN] citizen in this city. Temples, Churches, Hospitiums, Gardens and Worship buildings provide +0.6 [ICON_SCIENCE] Science for each [ICON_CITIZEN] citizen in this city."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_FEED_THE_WORLD_DL_DESCRIPTION",              "神社和祭坛提供+3 [ICON_FOOD] 食物，+2 [ICON_HOUSING] 住房。寺庙、教堂、救济院、花园和祭祀建筑提供+6 [ICON_FOOD] 食物，+2 [ICON_HOUSING] 住房。"),
    ("zh_Hans_CN",  "LOC_BELIEF_CHORAL_MUSIC_DL_DESCRIPTION",                "神社和祭坛提供+3 [ICON_CULTURE] 文化值。寺庙、教堂、救济院、花园和祭祀建筑提供+6 [ICON_CULTURE] 文化值。"),
    ("zh_Hans_CN",  "LOC_BELIEF_DIVINE_INSPIRATION_DL_DESCRIPTION",          "所有世界奇观+4 [ICON_Faith] 信仰值。完成世界奇观后返还等同于奇观所需产能50%的 [ICON_Faith] 信仰值。"),
    ("zh_Hans_CN",  "LOC_BELIEF_JESUIT_EDUCATION_DL_DESCRIPTION",            "神社和祭坛为每人口提供0.3 [ICON_SCIENCE] 科技值。寺庙、教堂、救济院、花园和祭祀建筑为每人口提供0.6 [ICON_SCIENCE] 科技值。购买学院区域内建筑的费用降低20%且可以用 [ICON_FAITH] 信仰值购买。"),
