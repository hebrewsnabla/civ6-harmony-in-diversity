-- ===========================================================================
--	Taken from Expansion2/UI/Civilopedia/CivilopediaPage_Unit.lua
-- ===========================================================================
...
PageLayouts["Unit" ] = function(page)
	...
	for row in GameInfo.Unit_BuildingPrereqs() do
		-- ================================================================================
        -- DL specific logic: ignore if it's Poland dummy building.
        -- ================================================================================
		if(row.Unit == unitType) and (row.PrereqBuilding ~= "BUILDING_DUMMY_POLAND") then
		-- ================================================================================
