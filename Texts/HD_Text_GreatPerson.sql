...
values
    ...
    ("LOC_GREAT_PERSON_HD_BOOST_OR_GRANT_PRINTING",                       "Triggers the [ICON_TechBoosted] Eureka moment for Printing."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_GREAT_PERSON_HD_BOOST_OR_GRANT_PRINTING",                       "为印刷术启动 [ICON_TechBoosted] 尤里卡时刻。"),
...
values
    ...
    ("LOC_JNR_GREATPERSON_DAM_UNLOCK_MATHEMATICS",                  "Can build Dam districts with Mathematics researched. +25% construction speed towards the Dam districts. Lets city which has Dam District build one more district than the [ICON_CITIZEN] Population limit allows."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_JNR_GREATPERSON_DAM_UNLOCK_MATHEMATICS",                       "解锁科技“数学”即可建造堤坝。建造堤坝时加速25%。有堤坝的城市可无视 [ICON_CITIZEN] 人口数量限制再建造一个区域。"),
