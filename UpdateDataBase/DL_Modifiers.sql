...
insert or replace into Types
	(Type,														Kind)
values
	('MODIFIER_PLAYER_CITIES_DISTRICTS_ADJUST_TOURISM_ADJACENCY_YIELD_MOFIFIER','KIND_MODIFIER'),
	('MODIFIER_SINGLE_CIYT_ADJUST_DISTRICT_PRODUCTION',			'KIND_MODIFIER'),
...
values 
	('MODIFIER_PLAYER_CITIES_DISTRICTS_ADJUST_TOURISM_ADJACENCY_YIELD_MOFIFIER','COLLECTION_PLAYER_DISTRICTS','EFFECT_ADJUST_DISTRICT_TOURISM_ADJACENCY_YIELD_MOFIFIER'),
	('MODIFIER_SINGLE_CIYT_ADJUST_DISTRICT_PRODUCTION',			'COLLECTION_OWNER',					'EFFECT_ADJUST_DISTRICT_PRODUCTION'),
