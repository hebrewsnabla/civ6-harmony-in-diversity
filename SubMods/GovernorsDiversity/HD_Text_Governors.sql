...
values
    ...
    ("LOC_GOVERNOR_PROMOTION_MERCHANT_MULTINATIONAL_CORP_DESCRIPTION",            "+50% yields for international [ICON_TradeRoute] Trade Routes from the city when player has the 'Exploration' Civic."),
    -- Victor
...
values
    ...
    ("zh_Hans_CN",  "LOC_GOVERNOR_PROMOTION_MERCHANT_MULTINATIONAL_CORP_DESCRIPTION",            "当玩家研究探索市政后，从此城开始的国际 [ICON_TradeRoute] 贸易路线收益+50%。"),
