...
-- 德川换皮
delete from TraitModifiers where TraitType = 'TRAIT_LEADER_DIVINE_WIND';
insert or replace into TraitModifiers
	(TraitType,						ModifierId)
values
	('TRAIT_LEADER_DIVINE_WIND',	'DIVINE_WIND_INTERNATIONAL'),
	('TRAIT_LEADER_DIVINE_WIND',	'DIVINE_WIND_SCIENCE_ATTACH'),
	('TRAIT_LEADER_DIVINE_WIND',	'DIVINE_WIND_CULTURE_ATTACH'),
	('TRAIT_LEADER_DIVINE_WIND',	'DIVINE_WIND_GOLD_ATTACH');
insert or replace into Modifiers
	(ModifierId, 						ModifierType,														SubjectRequirementSetId)
values
	('DIVINE_WIND_INTERNATIONAL',		'MODIFIER_PLAYER_ADJUST_INTERNATIONAL_TRADE_ROUTE_YIELD_MODIFIER',	null),
	('DIVINE_WIND_SCIENCE_ATTACH',		'MODIFIER_PLAYER_DISTRICTS_ATTACH_MODIFIER',						'DISTRICT_IS_SPECIALTY_DISTRICT_REQUIREMENTS'),
	('DIVINE_WIND_CULTURE_ATTACH',		'MODIFIER_PLAYER_DISTRICTS_ATTACH_MODIFIER',						'DISTRICT_IS_SPECIALTY_DISTRICT_REQUIREMENTS'),
	('DIVINE_WIND_GOLD_ATTACH',			'MODIFIER_PLAYER_DISTRICTS_ATTACH_MODIFIER',						'DISTRICT_IS_SPECIALTY_DISTRICT_REQUIREMENTS'),
	('DIVINE_WIND_SCIENCE',				'MODIFIER_SINGLE_CITY_ADJUST_TRADE_ROUTE_YIELD_TO_OTHERS',			null),
	('DIVINE_WIND_CULTURE',				'MODIFIER_SINGLE_CITY_ADJUST_TRADE_ROUTE_YIELD_TO_OTHERS',			null),
	('DIVINE_WIND_GOLD',				'MODIFIER_SINGLE_CITY_ADJUST_TRADE_ROUTE_YIELD_TO_OTHERS',			null);
insert or replace into ModifierArguments
	(ModifierId,						Name,				Value)
values
	('DIVINE_WIND_INTERNATIONAL',		'YieldType',		'YIELD_PRODUCTION, YIELD_FOOD, YIELD_SCIENCE, YIELD_CULTURE, YIELD_GOLD, YIELD_FAITH'),
	('DIVINE_WIND_INTERNATIONAL',		'Amount',			'-25, -25, -25, -25, -25, -25'),
	('DIVINE_WIND_SCIENCE_ATTACH',		'ModifierId',		'DIVINE_WIND_SCIENCE'),
	('DIVINE_WIND_CULTURE_ATTACH',		'ModifierId',		'DIVINE_WIND_CULTURE'),
	('DIVINE_WIND_GOLD_ATTACH',			'ModifierId',		'DIVINE_WIND_GOLD'),
	('DIVINE_WIND_SCIENCE',				'YieldType',		'YIELD_SCIENCE'),
	('DIVINE_WIND_SCIENCE',				'Amount',			1),
	('DIVINE_WIND_SCIENCE',				'Domestic',			1),
	('DIVINE_WIND_CULTURE',				'YieldType',		'YIELD_CULTURE'),
	('DIVINE_WIND_CULTURE',				'Amount',			1),
	('DIVINE_WIND_CULTURE',				'Domestic',			1),
	('DIVINE_WIND_GOLD',				'YieldType',		'YIELD_GOLD'),
	('DIVINE_WIND_GOLD',				'Amount',			2),
	('DIVINE_WIND_GOLD',				'Domestic',			1);