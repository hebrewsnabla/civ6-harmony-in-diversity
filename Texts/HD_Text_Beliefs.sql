...
values
    ...
    ("LOC_BELIEF_WORK_ETHIC_DL_DESCRIPTION",                  "+2 [ICON_Production] Production for all Speciality Districts if the city has a Holy Site district. Industrial Zone district buildings are 20% cheaper to purchase. May purchase Industrial Zone district buildings with [ICON_Faith] Faith."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_BELIEF_WORK_ETHIC_DL_DESCRIPTION",                  "拥有圣地的城市专业化区域+2 [ICON_Production] 生产力，购买工业区区域内建筑的费用降低20%且可以用 [ICON_Faith] 信仰值购买。"),
