...
insert or replace into LocalizedText
    (Language,      Tag,                                            Text)
values
    ("zh_Hans_CN",  "LOC_UNIT_DL_MEDIEVAL_PIRATE_NAME",             "海盗船"),
    ("zh_Hans_CN",  "LOC_UNIT_DL_MEDIEVAL_PIRATE_DESCRIPTION",      "中世纪海军袭击者，能够进行海岸扫荡。除非与单位相邻，否则只能被其他海军袭击者发现。能使视线范围中的海军袭击者暴露位置。"),
