...
values
    ...
    ("LOC_POLICY_CHARISMATIC_LEADER_DESCRIPTION",                                     "Open Borders with all city-states, and +3 Influence points per turn toward earning city-state [ICON_Envoy] Envoys."),
    ("LOC_POLICY_DIPLOMATIC_LEAGUE_DESCRIPTION",                                      "Open Borders with all city-states, and +6 Influence points per turn toward earning city-state [ICON_Envoy] Envoys."),
    ("LOC_POLICY_GUNBOAT_DIPLOMACY_DESCRIPTION",                                      "Open Borders with all city-states, and +9 Influence points per turn toward earning city-state [ICON_Envoy] Envoys."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_POLICY_CHARISMATIC_LEADER_DESCRIPTION",                                     "开放所有城邦的边境，影响力点数每回合+3，通过影响力点数可获得城邦 [ICON_Envoy] 使者。"),
    ("zh_Hans_CN",  "LOC_POLICY_DIPLOMATIC_LEAGUE_DESCRIPTION",                                      "开放所有城邦的边境，影响力点数每回合+6，通过影响力点数可获得城邦 [ICON_Envoy] 使者。"),
