...
values
	...
	('FREIGHT',				5,			10),--xhh 修编历书
	('FORGING_IRON',		10,			10);--xhh 货运
...
values 
	...
	('BUILDING_CITY_POLICY_FREIGHT',			'CITY_POLICY_FREIGHT_PRODUCTION'),--xhh 货运
	('BUILDING_CITY_POLICY_FORGING_IRON',		'CITY_POLICY_FORGING_IRON_PRODUCTION');--xhh 货运
...
values
	...
	('CITY_POLICY_REVISION_ALMANAC_DECREASE_GOLD',						'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE',			'HD_CITY_HAS_DISTRICT_AQUEDUCT_XHH'),--xhh 修编历书
	('CITY_POLICY_FREIGHT_PRODUCTION',									'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE',			'HD_CITY_HAS_DISTRICT_COMMERCIAL_HUB_XHH'),--xhh 货运
	('CITY_POLICY_FORGING_IRON_PRODUCTION',								'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE',			'HD_CITY_HAS_DISTRICT_INDUSTRIAL_ZONE_XHH');--xhh 锻铁

insert or replace into RequirementSets
	(RequirementSetId,								RequirementSetType)
values
	('HD_PLOT_HAS_FARM_OVER_BONUS_RESOURCES',       'REQUIREMENTSET_TEST_ALL'),--xhh 修编历书
	('HD_PLOT_HAS_FARM_OVER_LUXURY_RESOURCES',      'REQUIREMENTSET_TEST_ALL'),--xhh 修编历书
	('HD_CITY_HAS_DISTRICT_AQUEDUCT_XHH',     		'REQUIREMENTSET_TEST_ALL'),--xhh 修编历书
	('HD_CITY_HAS_DISTRICT_COMMERCIAL_HUB_XHH',     'REQUIREMENTSET_TEST_ALL'),--xhh 货运
	('HD_CITY_HAS_DISTRICT_INDUSTRIAL_ZONE_XHH',    'REQUIREMENTSET_TEST_ALL');--xhh 锻铁

insert or replace into RequirementSetRequirements
	(RequirementSetId,								RequirementId)
values
	('HD_PLOT_HAS_FARM_OVER_BONUS_RESOURCES',       'REQUIRES_PLOT_HAS_BONUS'),--xhh 修编历书
	('HD_PLOT_HAS_FARM_OVER_BONUS_RESOURCES',       'REQUIRES_PLOT_HAS_FARM'),--xhh 修编历书
	('HD_PLOT_HAS_FARM_OVER_BONUS_RESOURCES',       'REQUIRES_CITY_HAS_DISTRICT_AQUEDUCT'),--xhh 修编历书
	('HD_PLOT_HAS_FARM_OVER_LUXURY_RESOURCES',      'REQUIRES_PLOT_HAS_LUXURY'),--xhh 修编历书
	('HD_PLOT_HAS_FARM_OVER_LUXURY_RESOURCES',      'REQUIRES_PLOT_HAS_FARM'),--xhh 修编历书
	('HD_PLOT_HAS_FARM_OVER_LUXURY_RESOURCES',      'REQUIRES_CITY_HAS_DISTRICT_AQUEDUCT'),--xhh 修编历书
	('HD_CITY_HAS_DISTRICT_AQUEDUCT_XHH',     		'REQUIRES_CITY_HAS_DISTRICT_AQUEDUCT'),--xhh 修编历书
	('HD_CITY_HAS_DISTRICT_COMMERCIAL_HUB_XHH',     'REQUIRES_CITY_HAS_DISTRICT_COMMERCIAL_HUB'),--xhh 货运
	('HD_CITY_HAS_DISTRICT_COMMERCIAL_HUB_XHH',     'HD_REQUIRES_PLAYER_HAS_HORSES_XHH'),--xhh 货运
	('HD_CITY_HAS_DISTRICT_INDUSTRIAL_ZONE_XHH',    'REQUIRES_CITY_HAS_DISTRICT_INDUSTRIAL_ZONE'),--xhh 锻铁
	('HD_CITY_HAS_DISTRICT_INDUSTRIAL_ZONE_XHH',    'HD_REQUIRES_PLAYER_HAS_IRON_XHH');--xhh 锻铁
