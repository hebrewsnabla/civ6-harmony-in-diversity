...
values
    ...
    ("zh_Hans_CN",  "LOC_POLICY_EQUESTRIAN_ORDERS_DL_DESCRIPTION",                                   "军营区域每回合产出1 [ICON_RESOURCE_HORSES] 马和1 [ICON_RESOURCE_IRON] 铁，每个军营建筑每回合产出 2 [ICON_RESOURCE_HORSES] 马和 2 [ICON_RESOURCE_IRON] 铁。"),
