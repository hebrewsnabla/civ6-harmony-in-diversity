...
--	('ENTREPRENEURSHIP_DISTRICTGOLD',						'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_MODIFIER',						'DISTRICT_IS_COMMERCIAL_HUB'),
	...
	('DEEPWATERPORT_GOLD',									'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_CHANGE',						'CITY_HAS_HARBOR_THIRD_BUILDING'),
	('DEEPWATERPORT_HOUSING',								'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_HOUSING',							'CITY_HAS_HARBOR_THIRD_BUILDING'), 
...
values
	...
	('CITY_HAS_HARBOR_THIRD_BUILDING',							'REQUIREMENTSET_TEST_ANY'),
	('REQUIRES_CITY_HAS_TIER_2_COMMERCIAL_HUB_BUILDINGS',							'REQUIREMENTSET_TEST_ANY'),

	('REQUIRES_CITY_HAS_TIER_2_HARBOR_BUILDINGS',				'REQUIREMENTSET_TEST_ANY');
...
values
	...
	('HD_OVERSEAS_CITY_HAS_TIER_2_COMMERCIAL_HUB_BUILDINGS', 			'REQUIRES_CITY_HAS_TIER_2_COMMERCIAL_HUB_BUILDINGS_MET'),
	('HD_OVERSEAS_CITY_HAS_TIER_2_COMMERCIAL_HUB_BUILDINGS', 			'REQUIRES_CITY_IS_NOT_OWNER_CAPITAL_CONTINENT'),
	('HD_OVERSEAS_CITY_HAS_TIER_2_HARBOR_BUILDINGS', 					'REQUIRES_CITY_HAS_TIER_2_HARBOR_BUILDINGS_MET'),
	('HD_OVERSEAS_CITY_HAS_TIER_2_HARBOR_BUILDINGS', 					'REQUIRES_CITY_IS_NOT_OWNER_CAPITAL_CONTINENT'),
	('CITY_HAS_HARBOR_THIRD_BUILDING',							'REQUIRES_CITY_HAS_SEAPORT'),
	('REQUIRES_CITY_HAS_TIER_2_HARBOR_BUILDINGS', 				'REQUIRES_CITY_HAS_BUILDING_SHIPYARD'),
	('REQUIRES_CITY_HAS_TIER_2_HARBOR_BUILDINGS', 				'REQUIRES_CITY_HAS_BUILDING_JNR_HAVEN'),
	('REQUIRES_CITY_HAS_TIER_2_HARBOR_BUILDINGS',				'REQUIRES_CITY_HAS_BUILDING_JNR_FREEPORT'),
	('REQUIRES_CITY_HAS_TIER_2_COMMERCIAL_HUB_BUILDINGS', 				'REQUIRES_CITY_HAS_BUILDING_JNR_GUILDHALL'),
	('REQUIRES_CITY_HAS_TIER_2_COMMERCIAL_HUB_BUILDINGS', 				'REQUIRES_CITY_HAS_BUILDING_BANK'),
	('REQUIRES_CITY_HAS_TIER_2_COMMERCIAL_HUB_BUILDINGS', 				'REQUIRES_CITY_HAS_BUILDING_GRAND_BAZAAR'),
	('REQUIRES_CITY_HAS_TIER_2_COMMERCIAL_HUB_BUILDINGS',				'REQUIRES_CITY_HAS_BUILDING_JNR_MERCHANT_QUARTER');
...
update Modifiers set SubjectRequirementSetId = 'REQUIREMENTS_CITY_HAS_TIER_2_HOLY_SITE_BUILDINGS' where ModifierID = 'THEOCRACY_RELIGIOUS_PEOPLE';
insert or ignore into RequirementSets
	(RequirementSetId,											RequirementSetType)
values
	('REQUIREMENTS_CITY_HAS_TIER_2_HOLY_SITE_BUILDINGS',		'REQUIREMENTSET_TEST_ANY');

insert or ignore into RequirementSetRequirements
	(RequirementSetId,											RequirementId)
values
	('REQUIREMENTS_CITY_HAS_TIER_2_HOLY_SITE_BUILDINGS', 		'REQUIRES_CITY_HAS_TEMPLE'),
	('REQUIREMENTS_CITY_HAS_TIER_2_HOLY_SITE_BUILDINGS',		'REQUIRES_CITY_HAS_BUILDING_JNR_MONASTERY'),
	('REQUIREMENTS_CITY_HAS_TIER_2_HOLY_SITE_BUILDINGS',		'REQUIRES_CITY_HAS_BUILDING_STAVE_CHURCH'),
	('REQUIREMENTS_CITY_HAS_TIER_2_HOLY_SITE_BUILDINGS',		'REQUIRES_CITY_HAS_BUILDING_PRASAT');
