...
update Civics set Cost = 130 where CivicType = 'CIVIC_POLITICAL_PHILOSOPHY';
...
-- update Civics set Cost = 70 where CivicType = 'CIVIC_EARLY_EMPIRE'; 
-- update Civics set Cost = 50 where CivicType = 'CIVIC_MYSTICISM'; 
-- update Civics set Cost = 140 where CivicType = 'CIVIC_GAMES_RECREATION'; 
-- update Civics set Cost = 140 where CivicType = 'CIVIC_POLITICAL_PHILOSOPHY'; 
-- update Civics set Cost = 140 where CivicType = 'CIVIC_DRAMA_POETRY'; 
