...
values
    ...
    ("LOC_BUILDING_KAREZ_DESCRIPTION",                            "+1 [ICON_Food] Food and +1 [ICON_Housing] Housing if the City Center is on Hills or is adjacent to Mountains.[NEWLINE][NEWLINE]May not be built in cities that already have an Artizan Plaza or a Boot Camp."),
    ("LOC_BUILDING_OFFICIAL_RUN_HANDCRAFT_NAME",                  "Artisan Plaza"),
    ("LOC_BUILDING_OFFICIAL_RUN_HANDCRAFT_DESCRIPTION",           "+1 [ICON_Production] Production towards Districts, Buildings and Wonders if this city owns Quarries or Mines over Luxury or Bonus resources.[NEWLINE][NEWLINE]May not be built in cities that already have a Karez or Boot Camp."),
    ...
    ("LOC_BUILDING_FAIR_DESCRIPTION",                             "+2 [ICON_Gold] Gold if the City Center is adjacent to at least one Luxury resource.[NEWLINE][NEWLINE]May not be built in cities that already have a Totem."),
    ...
    -- Campus
    ("LOC_BUILDING_LIBRARY_DESCRIPTION",                          "[ICON_Citizen] Citizens in this city provide +0.3 [ICON_SCIENCE] Science."),
...
values
    ...
    -- 军营
    ("zh_Hans_CN",  "LOC_BUILDING_BARRACKS_EXPANSION2_DESCRIPTION",              "该城市中训练的所有近战、抗骑兵、远程和远程骑兵类陆地单位+25%战斗经验值。[NEWLINE][NEWLINE]无法建造在已有马厩的军营区域中。[NEWLINE][NEWLINE]本城的所有已开发的 [ICON_RESOURCE_IRON] 铁资源+2 [ICON_Production] 生产力。为在本城训练的近战、远程、反骑兵单位提供永久+2 [ICON_Strength] 战斗力。"),
