...
values
    ...
    ("LOC_BELIEF_ABBOT_DL_DESCRIPTION",                       "+2 [ICON_Production] Production for Holy Site Districts. Holy Site District and Shrine provide +1 [ICON_Production] Production to all adjacent tiles."),
