...
values
    ...
    ("LOC_GOVERNOR_PROMOTION_MERCHANT_FORESTRY_MANAGEMENT_DESCRIPTION",           "The city receives +6 [ICON_Gold] Gold from each unimproved feature. Tiles adjacent to unimproved features of this city receive +1 Appeal. Tycoon units trained in this city receive an additional charge. "),
    ...
    -- Pingala
    ("LOC_GOVERNOR_PROMOTION_EDUCATOR_LIBRARIAN_DESCRIPTION",                     "15% increase in [ICON_Science] Science and [ICON_Culture] Culture generated by the city."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_GOVERNOR_PROMOTION_MERCHANT_FORESTRY_MANAGEMENT_DESCRIPTION",           "城市中每个未改良地貌+4 [ICON_Gold] 金币，与未改良地貌相邻的单元格可获得+1魅力。本城训练的大亨使用次数+1。"),
    ...
    -- 平伽拉
    ("zh_Hans_CN",  "LOC_GOVERNOR_PROMOTION_EDUCATOR_LIBRARIAN_DESCRIPTION",                     "城市每回合产出的 [ICON_Science] 科技值和 [ICON_Culture] 文化值+15%。"),
