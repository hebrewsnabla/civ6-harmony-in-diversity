...
values
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_RAPA_NUI_DESCRIPTION",             "建造者可以建造摩艾石像改良设施。[NEWLINE][NEWLINE]摩艾石像提供+3 [ICON_Culture] 文化值。每2个相邻的摩艾石像+1 [ICON_Culture] 文化值。在火山土单元格之上或与其相邻时，+2 [ICON_Culture] 文化值。随着市政与科技树的发展，可获得额外的 [ICON_Culture] 文化值。可通过 [ICON_Culture] 文化值获得 [ICON_Tourism] 旅游业绩。只可建在相邻湖泊或近海的平原、平原丘陵、草原、草原丘陵或火山土单元格之上。可以修建在资源上并改良资源。"),
    ("zh_Hans_CN",  "LOC_CIVILIZATION_RAPA_NUI_BONUS",                   "建造者可以建造摩艾石像改良设施。[NEWLINE][NEWLINE]摩艾石像提供+3 [ICON_Culture] 文化值。每2个相邻的摩艾石像+1 [ICON_Culture] 文化值。在火山土单元格之上或与其相邻时，+2 [ICON_Culture] 文化值。随着市政与科技树的发展，可获得额外的 [ICON_Culture] 文化值。可通过 [ICON_Culture] 文化值获得 [ICON_Tourism] 旅游业绩。只可建在相邻湖泊或近海的平原、平原丘陵、草原、草原丘陵或火山土单元格之上。可以修建在资源上并改良资源。"),
    ...
    ("zh_Hans_CN",  "LOC_LEADER_TRAIT_VATICAN_CITY_DESCRIPTION",         "剧院区域的 [ICON_CULTURE] 文化值相邻加成也提供 [ICON_Faith] 信仰。[NEWLINE]每件 [ICON_GreatWork_Sculpture] 雕塑、 [ICON_GreatWork_Portrait] 肖像、 [ICON_GreatWork_Landscape] 风景、 [ICON_GreatWork_Religious] 宗教艺术巨作和 [ICON_GreatWork_RELIC] 遗物+3 [ICON_Culture] 文化值。"), -- 若您已创立宗教，则每个信教城市为您提供+2 [ICON_Faith] 信仰值。
    ("zh_Hans_CN",  "LOC_CIVILIZATION_VATICAN_CITY_BONUS",               "剧院区域的 [ICON_CULTURE] 文化值相邻加成也提供 [ICON_Faith] 信仰。[NEWLINE]每件 [ICON_GreatWork_Sculpture] 雕塑、 [ICON_GreatWork_Portrait] 肖像、 [ICON_GreatWork_Landscape] 风景、 [ICON_GreatWork_Religious] 宗教艺术巨作和 [ICON_GreatWork_RELIC] 遗物+3 [ICON_Culture] 文化值。"),
